...
create table ARF_SEARCH_TOPIC (
	...
	PARENT_TOPIC_ID	integer	default null,
	NAME	varchar(254)	not null,
	NAME_EN	varchar(254)	default null,
	...
	MOST_RECENT	numeric(1)	default 1 not null,
	DELETED	numeric(1)	default 0 not null,
	TOPIC_PATH	varchar(4000)	default null
...
create table ARF_QUERY (
	ID	integer	not null,
	QUERY_TIMESTAMP	timestamp	default null,
	...
	QUERY_TYPE_ID	numeric(3)	not null,
	...
	LAST_SELECTED	numeric(1)	not null,
...
create table ARF_VIEW_CONTENT (
	ID	integer	not null,
	VIEW_TIMESTAMP	timestamp	default null,
	...
	SITE_VISIT_ID	bigint	not null,
	TOPIC_GROUP_ID	integer	not null,
	LAST_VIEWED	numeric(1)	not null,
	SESSION_ID	varchar(128)	default null,
	SITE_ID	smallint	not null
...
create table ARF_SEARCH_SITE_VISIT (
	ID	integer	not null,
	SSV_TIMESTAMP	timestamp	default null,
