...
create table ARF_CAL_DOW (
	...
	SHORT_NAME	nvarchar(3)	null,
	LONG_NAME	nvarchar(9)	null,
...
create table ARF_TIME_YEAR (
	ID	varchar(40)	not null,
	YEAR_TIMESTAMP	datetime	not null,
...
create table ARF_TIME_QTR (
	...
	QTR_TIMESTAMP	datetime	not null,
	QTR_OF_YEAR	tinyint	not null
...
create table ARF_TIME_MONTH (
	...
	MONTH_TIMESTAMP	datetime	not null,
	MONTH_OF_YEAR	tinyint	not null
...
create table ARF_TIME_WEEK (
	ID	varchar(40)	not null,
	YEAR_ID	varchar(40)	not null,
	WEEK_TIMESTAMP	datetime	not null,
...
create table ARF_TIME_TOD (
	ID	integer	not null,
	HOUR_OF_DAY	tinyint	not null,
	MIN_OF_HOUR	tinyint	not null,
	MIN_OF_DAY	smallint	not null,
	HALFDAY_OF_DAY	tinyint	not null,
	HOUR_OF_HALFDAY	tinyint	not null
...
create table ARF_TIME_INTERVAL (
	...
	ABBREVIATION_EN	varchar(8)	null,
...
create table ARF_CURRENCY (
	...
	CURRENCY_NAME	nvarchar(254)	not null,
	CURRENCY_NAME_EN	varchar(254)	null,
	ISO4217_ALPHA3	char(3)	not null,
	ISO4217_NUM3	smallint	null,
...
create table ARF_LANGUAGE (
	ID	smallint	not null,
	LANG_NAME	nvarchar(254)	not null,
	LANG_NAME_EN	varchar(254)	null,
...
create table ARF_GEO_COUNTRY (
	ID	smallint	not null,
	COUNTRY_NAME	nvarchar(254)	not null,
	COUNTRY_NAME_EN	varchar(254)	null,
	ISO3166_1_ALPHA2	char(2)	null,
	ISO3166_1_ALPHA3	char(3)	null,
	ISO3166_1_NUM3	smallint	null,
...
create table ARF_GEO_REGION (
	...
	REGION_NAME	nvarchar(254)	not null,
	REGION_NAME_EN	varchar(254)	null,
	ISO3166_2_CODE	varchar(6)	null,
...
create table ARF_GENDER (
	ID	tinyint	not null,
	GENDER_NAME	nvarchar(40)	not null,
	GENDER_NAME_EN	varchar(40)	null
...
create table ARF_MARITAL_STATUS (
	ID	tinyint	not null,
	MARITAL_STATUS_NAME	nvarchar(40)	not null,
	MARITAL_STATUS_NAME_EN	varchar(40)	null
...
create table ARF_AGE_GROUP (
	ID	tinyint	not null,
	AGE_GROUP_NAME	nvarchar(40)	not null,
	AGE_GROUP_NAME_EN	varchar(40)	null,
...
create table ARF_USER (
	...
	GENDER_ID	tinyint	default 0 not null,
	MARITAL_STATUS_ID	tinyint	default 0 not null,
...
create table ARF_SEGMENT (
	...
	SEGMENT_NAME	nvarchar(254)	not null,
	SEGMENT_DESC	nvarchar(254)	null,
	RECORD_LAST_UPDATE	datetime	null,
	RECORD_START_DATE	datetime	null,
	RECORD_END_DATE	datetime	null,
	MOST_RECENT	tinyint	default 1 not null,
...
create table ARF_SEGCLSTR_MBRS (
	...
	MEMBER	tinyint	default 1 not null
...
create table ARF_STIMULUS (
	...
	STIMULUS_NAME	nvarchar(254)	not null,
	STIMULUS_DESC	nvarchar(254)	null,
	STIMULUS_TYPE	nvarchar(254)	null,
	RECORD_LAST_UPDATE	datetime	null,
	RECORD_START_DATE	datetime	null,
	RECORD_END_DATE	datetime	null,
	MOST_RECENT	tinyint	default 1 not null,
...
create table ARF_SITE (
	...
	HOME_PAGE	varchar(254)	null,
	LAUNCH_DATE	datetime	null,
	CLOSE_DATE	datetime	null,
	ENABLED	tinyint	not null,
	CURRENCY_NAME	nvarchar(254)	null,
	CURRENCY_ALPHA3	char(3)	null,
	LANGUAGE_NAME	nvarchar(254)	null,
	LANGUAGE_ALPHA2	char(2)	null,
	LANGUAGE_ALPHA3	char(3)	null,
	DEFAULT_CATALOG_NAME	varchar(254)	null,
	RECORD_LAST_UPDATE	datetime	null,
	RECORD_START_DATE	datetime	null,
	RECORD_END_DATE	datetime	null,
	MOST_RECENT	tinyint	default 1 not null,
...
create table ARF_USER_AGENT (
	...
	AGENT_DESCRIPTION	varchar(254)	null,
	...
	COMPATIBLE_FLAG	tinyint	not null,
	GECKO_FLAG	tinyint	not null,
	IS_ROBOT	tinyint	not null,
	IS_BROWSER	tinyint	not null,
	RECORD_LAST_UPDATE	datetime	null,
	RECORD_START_DATE	datetime	null,
	RECORD_END_DATE	datetime	null
...
create table ARF_REFERRER (
	...
	REFERRER_SITE_DESCRIPTION	varchar(254)	null,
	...
	IS_SEARCH_ENGINE	tinyint	not null,
	RECORD_LAST_UPDATE	datetime	null,
	RECORD_START_DATE	datetime	null,
	RECORD_END_DATE	datetime	null
...
create table ARF_SITE_VISIT (
	...
	START_VISIT_TIMESTAMP	datetime	null,
...
create table ARF_IU_ORG (
	...
	NAME_EN	nvarchar(254)	not null,
	DESCRIPTION_EN	nvarchar(254)	null,
...
create table ARF_QUESTION (
	ID	integer	not null,
	NORMAL_QUESTION	nvarchar(900)	not null,
