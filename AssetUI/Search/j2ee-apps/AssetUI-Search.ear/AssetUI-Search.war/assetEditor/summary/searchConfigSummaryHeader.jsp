<%--
  ...
  @version $Id: //product/AssetUI/version/10.0.3/Search/src/web-apps/AssetUI-Search/assetEditor/summary/searchConfigSummaryHeader.jsp#2 $$Change: 651448 $
...
<dspel:page>
  ...
  <th class="atg_smerch_summaryTitle">
    <asset-ui:getResourceValue formatter="${formatter}" key="searchConfigSummaryHeader.headerText"/>
  </th>
</dspel:page>
<%-- @version $Id: //product/AssetUI/version/10.0.3/Search/src/web-apps/AssetUI-Search/assetEditor/summary/searchConfigSummaryHeader.jsp#2 $$Change: 651448 $--%>
