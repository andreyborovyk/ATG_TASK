...
:homedone
  ...
  call bin\startSQLRepository.bat -m BIZUI -repository /atg/web/viewmapping/ViewMappingRepository -import "%DYNAMO_HOME%\..\AssetUI\install\data\viewmapping.xml"

  echo.
  echo Importing AssetUI/install/data/assetManagerViews.xml into /atg/web/viewmapping/ViewMappingRepository

  call bin\startSQLRepository.bat -m BIZUI -repository /atg/web/viewmapping/ViewMappingRepository -import "%DYNAMO_HOME%\..\AssetUI\install\data\assetManagerViews.xml"
