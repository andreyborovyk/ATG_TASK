 ...
 *
 * @version $Id: //product/AssetUI/version/10.0.3/src/web-apps/AssetManager/scripts/gridCollectionEditor.js#2 $$Change: 651448 $
...
dojo.declare("atg.assetmanager.GridEditor", null, {
    ...
    if (this.containsRepItems) {
      ...
      if (this.showAddExisting) {
        ...
        this.pickAsset = function(pAllowMultiSelect) {
          pickerObj.allowMultiSelect = (pAllowMultiSelect ? "true" : "false");
          pickerObj.invoke();
        };
      }
    }
  ...
  createPickerObject: function() {
    ...
    pickerLauncher.onSelectFunction        = "GridEditor_onPick";
