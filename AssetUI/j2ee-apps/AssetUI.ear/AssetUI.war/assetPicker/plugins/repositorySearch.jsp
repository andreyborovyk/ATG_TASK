<%--
  Default CA repository search Asset Picker plugin page
  ...
  @version $Id: //product/AssetUI/version/10.0.3/src/web-apps/AssetUI/assetPicker/plugins/repositorySearch.jsp#2 $$Change: 651448 $
...
<c:catch var="ex">
  ...
  <c:choose>
    ...
    <c:otherwise>
      <dspel:include page="${ REPOSITORY_SEARCH_RESULTS_PAGE }"/>
    </c:otherwise>
  </c:choose>
...
<%
  ...
  if ( tt != null ) {
    System.out.println("Caught exception in repositorySearch.jsp:");
    tt.printStackTrace();
  }
%>
