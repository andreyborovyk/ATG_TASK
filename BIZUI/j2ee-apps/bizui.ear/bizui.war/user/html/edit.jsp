...
<dsp:setvalue bean="InternalProfileFormHandler.extractDefaultValuesFromProfile" value="true"/>
...
<%--
           ...
           window 
--%>
          <dsp:input bean="InternalProfileFormHandler.updateRepositoryId" beanvalue="InternalProfileFormHandler.repositoryId" type="hidden"/>
            <tr>
              ...
              <td><dsp:input id="firstName" type="text" size="30" maxsize="35" bean="InternalProfileFormHandler.value.firstName"/></td>
            </tr>
            <tr>
              <td valign="middle" align="right"><label for="lastName"><fmt:message key="edit-label-lastName" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="lastName" type="text" size="30" maxsize="30" bean="InternalProfileFormHandler.value.lastName"/></td>
            </tr>
            <tr>
              <td valign="middle" align="right"><label for="email"><fmt:message key="edit-label-email" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="email" type="text" size="30" maxsize="30" bean="InternalProfileFormHandler.value.email"/></td>
            </tr>
            <tr>
              <td valign="middle" align="right"><label for="address1"><fmt:message key="edit-label-address1" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="address1" type="text" size="30" maxsize="30" bean="InternalProfileFormHandler.value.homeAddress.address1"/></td>
            </tr>
            <tr>
              <td valign="middle" align="right"><label for="address2"><fmt:message key="edit-label-address2" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="address2" type="text" size="30" maxsize="30" bean="InternalProfileFormHandler.value.homeAddress.address2"/></td>
            </tr>
            <tr>
              <td valign="middle" align="right"><label for="city"><fmt:message key="edit-label-city" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="city" type="text" size="30" maxsize="30" bean="InternalProfileFormHandler.value.homeAddress.city"/></td>
            </tr>
            <tr>
              <td valign="middle" align="right"><label for="state"><fmt:message key="edit-label-state" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="state" type="text" size="30" maxsize="30" bean="InternalProfileFormHandler.value.homeAddress.state"/></td>
            </tr>
            <tr>
              ...
              <td><dsp:input id="postalCode" type="text" size="10" maxsize="12" bean="InternalProfileFormHandler.value.homeAddress.postalCode"/></td>
            </tr>
            <tr>
              <td valign="middle" align="right"><label for="country"><fmt:message key="edit-label-country" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="country" type="text" size="30" maxsize="30" bean="InternalProfileFormHandler.value.homeAddress.country"/></td>
            </tr>
            <tr>
              ...
              <td><dsp:input id="phoneNumber" type="text" size="20" maxsize="30" bean="InternalProfileFormHandler.value.homeAddress.phoneNumber"/></td>
            </tr>
            <tr>
              ...
              <td><dsp:input id="dateOfBirth" type="text" size="10" maxsize="10" date="M/dd/yyyy" bean="InternalProfileFormHandler.value.dateOfBirth"/></td>
            </tr>
            <fmt:message var="editbutton" key="edit-button-submit" bundle="${userprofilingbundle}"/>
            <tr>
              <td valign="middle" align="right"></td>
              <td><dsp:input type="submit" value="${editbutton}" bean="InternalProfileFormHandler.update"/></td>
            </tr>
          </table>   
        </dsp:form>
...
<%-- @version $Id: //product/BIZUI/version/10.0.3/web-apps/bizui/user/html/edit.jsp#2 $$Change: 651448 $--%>
