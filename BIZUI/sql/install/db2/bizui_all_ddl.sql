...
create table vmap_im (
	...
	is_readonly	numeric(1)	default null,
	form_handler	varchar(40)	default null,
...
create table vmap_fh (
	...
	component_path	varchar(1024)	default null
...
create table vmap_mode (
	...
	description	varchar(1024)	default null,
	fallback_id	varchar(40)	default null);
...
create table vmap_iv (
	...
	view_component	varchar(255)	default null,
...
create table vmap_pv (
	...
	app_name	varchar(255)	default null,
	mode_id	varchar(40)	not null,
	container_family	varchar(128)	default null,
	is_default	numeric(1)	default null,
	is_readonly	numeric(1)	default null,
	is_component	numeric(1)	default null
...
create table vmap_pvm (
	id	varchar(40)	not null,
	description	varchar(1024)	default null,
	pview_id	varchar(40)	default null,
	cpview_id	varchar(40)	default null
...
create table vmap_attrval (
	id	varchar(40)	not null,
	attr_value	varchar(2048)	default null
