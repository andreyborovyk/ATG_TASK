...
:firststart
  ...
  "%JAVA_VM%" %JAVA_ARGS% %DYN_EXTRA_ARGS% atg.applauncher.dynamo.DynamoServerLauncher LM LM;%PRODUCT_LICENSE_MODULES% %CONFIGPATH% "%USERNAME%" "%PASSWORD%"
