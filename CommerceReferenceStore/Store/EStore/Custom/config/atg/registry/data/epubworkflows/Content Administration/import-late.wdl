...
<process author="admin" creation-time="1156534371510" enabled="true" last-modified-by="admin" modification-time="1156535198593">
  <segment migrate-from="1156534371510" migrate-subjects="true">
    ...
    <event id="1">
      ...
      <filter operator="eq">
        ...
        <constant>/Content Administration/import-late.wdl</constant>
      </filter>
      <filter operator="eq">
        <event-property>
    ...
    <fork exclusive="true" id="4">
      <branch id="4.1">
        ...
        <fork id="4.1.5" synchronized="true">
          <branch id="4.1.5.1">
            <!--================================-->
            ...
            <fork exclusive="true" id="4.1.5.1.2">
              <branch id="4.1.5.1.2.1">
                <!--================================-->
                <!--== Wait for deployment to complete on target Production  -->
                <!--================================-->
                <event id="4.1.5.1.2.1.1">
                ...
                <fork id="4.1.5.1.2.1.2">
                  <branch id="4.1.5.1.2.1.2.1">
                    <!--================================-->
                    <!--== Deployment completed event status is success on target Production  -->
                    <!--================================-->
                    <condition id="4.1.5.1.2.1.2.1.1">
                  ...
                  <branch id="4.1.5.1.2.1.2.2">
                    ...
                    <fork exclusive="true" id="4.1.5.1.2.1.2.2.3">
                      <branch id="4.1.5.1.2.1.2.2.3.1">
                        <!--================================-->
                        <!--== revertStaging  -->
                        <!--================================-->
                        <event id="4.1.5.1.2.1.2.2.3.1.1">
                          <event-name>atg.workflow.TaskOutcome</event-name>
                          <filter operator="eq">
                            <event-property>
                              <property-name>processName</property-name>
                          ...
                          <filter operator="eq">
                            ...
                            <constant>4.1.5.1.2.1.2.2.3.1.1</constant>
                          </filter>
                          <attributes>
                            <attribute name="atg.workflow.elementType">
                              <constant>outcome</constant>
                        ...
                        <!--================================-->
                        <action id="4.1.5.1.2.1.2.2.3.1.2">
                        ...
                        <!--================================-->
                        <label id="4.1.5.1.2.1.2.2.3.1.3">
                          <attributes>
                            <attribute name="atg.workflow.assignable">
                              <constant type="java.lang.Boolean">false</constant>
                            </attribute>
                        ...
                        <fork exclusive="true" id="4.1.5.1.2.1.2.2.3.1.4">
                          <branch id="4.1.5.1.2.1.2.2.3.1.4.1">
                            <!--================================-->
                            <!--== Wait for deployment to complete on target Production  -->
                            <!--================================-->
                            <event id="4.1.5.1.2.1.2.2.3.1.4.1.1">
                              <event-name>atg.deployment.DeploymentStatus</event-name>
                              <filter operator="eq">
                                <event-property>
                                  <property-name>targetId</property-name>
                            ...
                            <fork id="4.1.5.1.2.1.2.2.3.1.4.1.2">
                              <branch id="4.1.5.1.2.1.2.2.3.1.4.1.2.1">
                                <!--================================-->
                                <!--== Deployment completed event status is success on target Production  -->
                                <!--================================-->
                                <condition id="4.1.5.1.2.1.2.2.3.1.4.1.2.1.1">
                                  <filter operator="deploymentCompleted">
                                    <constant>1</constant>
                                    <constant></constant>
                                  </filter>
                                ...
                                <!--== Reopen project  -->
                                <!--================================-->
                                <action id="4.1.5.1.2.1.2.2.3.1.4.1.2.1.2">
                                  <action-name>reopenProject</action-name>
                                </action>
                                <jump id="4.1.5.1.2.1.2.2.3.1.4.1.2.1.3" target="3"/>
                              </branch>
                              <branch id="4.1.5.1.2.1.2.2.3.1.4.1.2.2">
                                <!--================================-->
                                <!--== Deployment completed event status is failure on target Production  -->
                                <!--================================-->
                                <condition id="4.1.5.1.2.1.2.2.3.1.4.1.2.2.1">
                                  <filter operator="deploymentCompleted">
                                    <constant>0</constant>
                                    <constant></constant>
                                  </filter>
                                </condition>
                                <jump id="4.1.5.1.2.1.2.2.3.1.4.1.2.2.2" target="4.1.5.1.2.1.2.2.2"/>
                              </branch>
                            </fork>
                          </branch>
                          <branch id="4.1.5.1.2.1.2.2.3.1.4.2">
                            <!--================================-->
                            <!--== returnToPreviousTask  -->
                            <!--================================-->
                            <event id="4.1.5.1.2.1.2.2.3.1.4.2.1">
                              <event-name>atg.workflow.TaskOutcome</event-name>
                              <filter operator="eq">
                                <event-property>
                                  <property-name>processName</property-name>
                              ...
                              <filter operator="eq">
                                ...
                                <constant>4.1.5.1.2.1.2.2.3.1.4.2.1</constant>
                              </filter>
                              <attributes>
                                <attribute name="atg.workflow.elementType">
                                  <constant>outcome</constant>
                            ...
                            <jump id="4.1.5.1.2.1.2.2.3.1.4.2.2" target="4.1.5.1.2.1.2.2.2"/>
                          </branch>
                        </fork>
                      </branch>
                      <branch id="4.1.5.1.2.1.2.2.3.2">
                        <!--================================-->
                        <!--== retryStagingDeployment  -->
                        <!--================================-->
                        <event id="4.1.5.1.2.1.2.2.3.2.1">
                          <event-name>atg.workflow.TaskOutcome</event-name>
                          <filter operator="eq">
                            <event-property>
                              <property-name>processName</property-name>
                          ...
                          <filter operator="eq">
                            ...
                            <constant>4.1.5.1.2.1.2.2.3.2.1</constant>
                          </filter>
                          <attributes>
                            <attribute name="atg.workflow.elementType">
                              <constant>outcome</constant>
                        ...
                        <!--================================-->
                        <action id="4.1.5.1.2.1.2.2.3.2.2">
                          <action-name>approveAndDeployProject</action-name>
                          <action-param name="target">
                            <constant></constant>
                          </action-param>
                        </action>
                        <jump id="4.1.5.1.2.1.2.2.3.2.3" target="4.1.5.1.1"/>
                      </branch>
                    </fork>
                  </branch>
                </fork>
              </branch>
              <branch id="4.1.5.1.2.2">
                <!--================================-->
                <!--== returnToImportTask  -->
                <!--================================-->
                <event id="4.1.5.1.2.2.1">
                  <event-name>atg.workflow.TaskOutcome</event-name>
                  <filter operator="eq">
                    <event-property>
                      <property-name>processName</property-name>
                  ...
                  <filter operator="eq">
                    ...
                    <constant>4.1.5.1.2.2.1</constant>
                  </filter>
                  <attributes>
                    <attribute name="atg.workflow.elementType">
                      <constant>outcome</constant>
                ...
                <jump id="4.1.5.1.2.2.2" target="3"/>
              </branch>
            </fork>
          </branch>
          <branch id="4.1.5.2">
            ...
            <fork exclusive="true" id="4.1.5.2.2">
              <branch id="4.1.5.2.2.1">
                <!--================================-->
                <!--== Wait for deployment to complete on target Production  -->
                <!--================================-->
                <event id="4.1.5.2.2.1.1">
                  <event-name>atg.deployment.DeploymentStatus</event-name>
                  <filter operator="eq">
                    <event-property>
                      <property-name>targetId</property-name>
                ...
                <fork id="4.1.5.2.2.1.2">
                  <branch id="4.1.5.2.2.1.2.1">
                    <!--================================-->
                    <!--== Deployment completed event status is success on target Production  -->
                    <!--================================-->
                    <condition id="4.1.5.2.2.1.2.1.1">
                      <filter operator="deploymentCompleted">
                        <constant>1</constant>
                        <constant></constant>
                      </filter>
                  ...
                  <branch id="4.1.5.2.2.1.2.2">
                    <!--================================-->
                    <!--== Deployment completed event status is failure on target Production  -->
                    <!--================================-->
                    <condition id="4.1.5.2.2.1.2.2.1">
                      <filter operator="deploymentCompleted">
                        <constant>0</constant>
                        <constant></constant>
                      </filter>
                    ...
                    <fork exclusive="true" id="4.1.5.2.2.1.2.2.3">
                      <branch id="4.1.5.2.2.1.2.2.3.1">
                        <!--================================-->
                        <!--== revertProduction  -->
                        <!--================================-->
                        <event id="4.1.5.2.2.1.2.2.3.1.1">
                          <event-name>atg.workflow.TaskOutcome</event-name>
                          <filter operator="eq">
                            <event-property>
                              <property-name>processName</property-name>
                          ...
                          <filter operator="eq">
                            ...
                            <constant>4.1.5.2.2.1.2.2.3.1.1</constant>
                          </filter>
                          <attributes>
                            <attribute name="atg.workflow.elementType">
                              <constant>outcome</constant>
                        ...
                        <!--== Revert assets immediately on target Production  -->
                        <!--================================-->
                        <action id="4.1.5.2.2.1.2.2.3.1.2">
                          <action-name>revertAssetsOnTargetNow</action-name>
                          <action-param name="target">
                            <constant></constant>
                          </action-param>
                        ...
                        <!--================================-->
                        <label id="4.1.5.2.2.1.2.2.3.1.3">
                          <attributes>
                            <attribute name="atg.workflow.assignable">
                              <constant type="java.lang.Boolean">false</constant>
                            </attribute>
                        ...
                        <fork exclusive="true" id="4.1.5.2.2.1.2.2.3.1.4">
                          <branch id="4.1.5.2.2.1.2.2.3.1.4.1">
                            <!--================================-->
                            <!--== Wait for deployment to complete on target Production  -->
                            <!--================================-->
                            <event id="4.1.5.2.2.1.2.2.3.1.4.1.1">
                              <event-name>atg.deployment.DeploymentStatus</event-name>
                              <filter operator="eq">
                                <event-property>
                                  <property-name>targetId</property-name>
                            ...
                            <fork id="4.1.5.2.2.1.2.2.3.1.4.1.2">
                              <branch id="4.1.5.2.2.1.2.2.3.1.4.1.2.1">
                                <!--================================-->
                                <!--== Deployment completed event status is success on target Production  -->
                                <!--================================-->
                                <condition id="4.1.5.2.2.1.2.2.3.1.4.1.2.1.1">
                                  <filter operator="deploymentCompleted">
                                    <constant>1</constant>
                                    <constant></constant>
                                  </filter>
                                ...
                                <!--== Reopen project  -->
                                <!--================================-->
                                <action id="4.1.5.2.2.1.2.2.3.1.4.1.2.1.2">
                                  <action-name>reopenProject</action-name>
                                </action>
                                <jump id="4.1.5.2.2.1.2.2.3.1.4.1.2.1.3" target="3"/>
                              </branch>
                              <branch id="4.1.5.2.2.1.2.2.3.1.4.1.2.2">
                                <!--================================-->
                                <!--== Deployment completed event status is failure on target Production  -->
                                <!--================================-->
                                <condition id="4.1.5.2.2.1.2.2.3.1.4.1.2.2.1">
                                  <filter operator="deploymentCompleted">
                                    <constant>0</constant>
                                    <constant></constant>
                                  </filter>
                                </condition>
                                <jump id="4.1.5.2.2.1.2.2.3.1.4.1.2.2.2" target="4.1.5.2.2.1.2.2.2"/>
                              </branch>
                            </fork>
                          </branch>
                          <branch id="4.1.5.2.2.1.2.2.3.1.4.2">
                            <!--================================-->
                            <!--== returnToPreviousTask  -->
                            <!--================================-->
                            <event id="4.1.5.2.2.1.2.2.3.1.4.2.1">
                              <event-name>atg.workflow.TaskOutcome</event-name>
                              <filter operator="eq">
                                <event-property>
                                  <property-name>processName</property-name>
                              ...
                              <filter operator="eq">
                                ...
                                <constant>4.1.5.2.2.1.2.2.3.1.4.2.1</constant>
                              </filter>
                              <attributes>
                                <attribute name="atg.workflow.elementType">
                                  <constant>outcome</constant>
                            ...
                            <jump id="4.1.5.2.2.1.2.2.3.1.4.2.2" target="4.1.5.2.2.1.2.2.2"/>
                          </branch>
                        </fork>
                      </branch>
                      <branch id="4.1.5.2.2.1.2.2.3.2">
                        <!--================================-->
                        <!--== retryProductionDeployment  -->
                        <!--================================-->
                        <event id="4.1.5.2.2.1.2.2.3.2.1">
                          <event-name>atg.workflow.TaskOutcome</event-name>
                          <filter operator="eq">
                            <event-property>
                              <property-name>processName</property-name>
                          ...
                          <filter operator="eq">
                            ...
                            <constant>4.1.5.2.2.1.2.2.3.2.1</constant>
                          </filter>
                          <attributes>
                            <attribute name="atg.workflow.elementType">
                              <constant>outcome</constant>
                        ...
                        <!--== Approve and deploy project to target Production  -->
                        <!--================================-->
                        <action id="4.1.5.2.2.1.2.2.3.2.2">
                          <action-name>approveAndDeployProject</action-name>
                          <action-param name="target">
                            <constant></constant>
                          </action-param>
                        </action>
                        <jump id="4.1.5.2.2.1.2.2.3.2.3" target="4.1.5.2.1"/>
                      </branch>
                    </fork>
                  </branch>
                </fork>
              </branch>
              <branch id="4.1.5.2.2.2">
                <!--================================-->
                <!--== returnToImportTask  -->
                <!--================================-->
                <event id="4.1.5.2.2.2.1">
                  <event-name>atg.workflow.TaskOutcome</event-name>
                  <filter operator="eq">
                    <event-property>
                      <property-name>processName</property-name>
                  ...
                  <filter operator="eq">
                    ...
                    <constant>4.1.5.2.2.2.1</constant>
                  </filter>
                  <attributes>
                    <attribute name="atg.workflow.elementType">
                      <constant>outcome</constant>
                ...
                <jump id="4.1.5.2.2.2.2" target="3"/>
              </branch>
            </fork>
          </branch>
        </fork>
