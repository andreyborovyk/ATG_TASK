...
<process author="admin" creation-time="1156534371510" enabled="true" last-modified-by="admin" modification-time="1228862740812">
  <segment migrate-from="1228494629562,1228495994375,1228762457812" migrate-subjects="true">
    ...
    <event id="1">
      ...
      <filter operator="eq">
        ...
        <constant>/Content Administration/import-staging.wdl</constant>
      </filter>
      <filter operator="eq">
        <event-property>
                  ...
                  <branch id="4.1.6.1.2.2.3.1">
                    ...
                    <event id="4.1.6.1.2.2.3.1.1">
                      ...
                      <attributes>
                        ...
                        <attribute name="atg.workflow.name">
                          <constant>retryStagingDeploymentNow</constant>
                        </attribute>
                        <attribute name="atg.workflow.displayName">
                          <constant>Retry Staging Deployment Now</constant>
                        </attribute>
                      </attributes>
                    </event>
                    <!--================================-->
                  ...
                  <branch id="4.1.6.1.2.2.3.2">
                    ...
                    <event id="4.1.6.1.2.2.3.2.1">
                      ...
                      <attributes>
                        ...
                        <attribute name="atg.workflow.name">
                          <constant>retryStagingDeploymentLater</constant>
                        </attribute>
                        <attribute name="atg.workflow.displayName">
                          <constant>Retry Staging Deployment Later</constant>
                        </attribute>
                      </attributes>
                    </event>
                    <!--================================-->
                  ...
                  <branch id="4.1.6.1.2.2.3.3">
                    ...
                    <event id="4.1.6.1.2.2.3.3.1">
                      ...
                      <attributes>
                        ...
                        <attribute name="atg.workflow.description">
                          <constant>Returns to the Import task.</constant>
                        </attribute>
                        <attribute name="atg.workflow.name">
          ...
          <branch id="4.1.9.1">
            ...
            <fork id="4.1.9.1.2">
              ...
              <branch id="4.1.9.1.2.2">
                ...
                <fork exclusive="true" id="4.1.9.1.2.2.3">
                  <branch id="4.1.9.1.2.2.3.1">
                    <!--================================-->
                    <!--== retryProductionDeploymentNow  -->
                    <!--================================-->
                    <event id="4.1.9.1.2.2.3.1.1">
                      <event-name>atg.workflow.TaskOutcome</event-name>
                      <filter operator="eq">
                        <event-property>
                          <property-name>processName</property-name>
                      ...
                      <filter operator="eq">
                        ...
                        <constant>4.1.9.1.2.2.3.1.1</constant>
                      </filter>
                      <attributes>
                        <attribute name="atg.workflow.elementType">
                          <constant>outcome</constant>
                    ...
                    <!--== Approve and deploy project to target Production  -->
                    <!--================================-->
                    <action id="4.1.9.1.2.2.3.1.2">
                      <action-name>approveAndDeployProject</action-name>
                      <action-param name="target">
                        <constant>Production</constant>
                      </action-param>
                    </action>
                    <jump id="4.1.9.1.2.2.3.1.3" target="4.1.8"/>
                  </branch>
                  <branch id="4.1.9.1.2.2.3.2">
                    <!--================================-->
                    <!--== retryProductionDeploymentLater  -->
                    <!--================================-->
                    <event id="4.1.9.1.2.2.3.2.1">
                      <event-name>atg.workflow.TaskOutcome</event-name>
                      <filter operator="eq">
                        <event-property>
                          <property-name>processName</property-name>
                      ...
                      <filter operator="eq">
                        ...
                        <constant>4.1.9.1.2.2.3.2.1</constant>
                      </filter>
                      <attributes>
                        <attribute name="atg.workflow.elementType">
                          <constant>outcome</constant>
                    ...
                    <!--================================-->
                    <action id="4.1.9.1.2.2.3.2.2">
                      <action-name>approveProject</action-name>
                      <action-param name="target">
                        <constant>Production</constant>
                      </action-param>
                    </action>
                    <jump id="4.1.9.1.2.2.3.2.3" target="4.1.8"/>
                  </branch>
                  <branch id="4.1.9.1.2.2.3.3">
                    <!--================================-->
                    <!--== returnToImportTask  -->
                    <!--================================-->
                    <event id="4.1.9.1.2.2.3.3.1">
                      <event-name>atg.workflow.TaskOutcome</event-name>
                      <filter operator="eq">
                        <event-property>
                          <property-name>processName</property-name>
                      ...
                      <filter operator="eq">
                        ...
                        <constant>4.1.9.1.2.2.3.3.1</constant>
                      </filter>
                      <attributes>
                        <attribute name="atg.workflow.elementType">
                          <constant>outcome</constant>
                        ...
                        <attribute name="atg.workflow.description">
                          <constant>This will return the Staging target to its state prior to these deployments, and return the project to the Import task.</constant>
                        </attribute>
                        <attribute name="atg.workflow.name">
                          <constant>returnToImportTask</constant>
                        </attribute>
                    ...
                    <fork exclusive="true" id="4.1.9.1.2.2.3.3.4">
                      <branch id="4.1.9.1.2.2.3.3.4.1">
                        <!--================================-->
                        <!--== returnToImportTask  -->
                        <!--================================-->
                        <event id="4.1.9.1.2.2.3.3.4.1.1">
                          <event-name>atg.workflow.TaskOutcome</event-name>
                          <filter operator="eq">
                            <event-property>
                              <property-name>processName</property-name>
                          ...
                          <filter operator="eq">
                            ...
                            <constant>4.1.9.1.2.2.3.3.4.1.1</constant>
                          </filter>
                          <attributes>
                            <attribute name="atg.workflow.elementType">
                              <constant>outcome</constant>
                      ...
                      <branch id="4.1.9.1.2.2.3.3.4.2">
                        <!--================================-->
                        <!--== Wait for deployment to complete on target Staging  -->
                        <!--================================-->
                        <event id="4.1.9.1.2.2.3.3.4.2.1">
                          <event-name>atg.deployment.DeploymentStatus</event-name>
                          <filter operator="eq">
                            <event-property>
                              <property-name>targetId</property-name>
                        ...
                        <fork id="4.1.9.1.2.2.3.3.4.2.2">
                          <branch id="4.1.9.1.2.2.3.3.4.2.2.1">
                            <!--================================-->
                            <!--== Deployment completed event status is success on target Staging  -->
                            <!--================================-->
                            <condition id="4.1.9.1.2.2.3.3.4.2.2.1.1">
                              <filter operator="deploymentCompleted">
                                <constant>1</constant>
                                <constant>Staging</constant>
                              </filter>
                          ...
                          <branch id="4.1.9.1.2.2.3.3.4.2.2.2">
                            <!--================================-->
                            <!--== Deployment completed event status is failure on target Staging  -->
                            <!--================================-->
                            <condition id="4.1.9.1.2.2.3.3.4.2.2.2.1">
                              <filter operator="deploymentCompleted">
                                <constant>0</constant>
                                <constant>Staging</constant>
                              </filter>
                    ...
                    <!--== Reopen project  -->
                    <!--================================-->
                    <action id="4.1.9.1.2.2.3.3.5">
                      <action-name>reopenProject</action-name>
                    </action>
                    <jump id="4.1.9.1.2.2.3.3.6" target="3"/>
                  </branch>
                </fork>
              </branch>
            </fork>
