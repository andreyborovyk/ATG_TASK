...
public class StoreSearchFormHandler extends CatalogSearchFormHandler {
   ...
   */
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/EStore/src/atg/projects/store/catalog/StoreSearchFormHandler.java#2 $$Change: 651448 $";
