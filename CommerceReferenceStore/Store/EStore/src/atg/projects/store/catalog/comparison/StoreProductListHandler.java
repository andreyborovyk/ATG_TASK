 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/EStore/src/atg/projects/store/catalog/comparison/StoreProductListHandler.java#2 $
 * @updated $ $$ $
 */
public class StoreProductListHandler extends ProductListHandler
{
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/EStore/src/atg/projects/store/catalog/comparison/StoreProductListHandler.java#2 $$Change: 651448 $";
