 ...
 * to users.
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/EStore/src/atg/projects/store/order/beans/StoreCreditBean.java#2 $
 */
public class StoreCreditBean {

  /** Class version string. */
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/EStore/src/atg/projects/store/order/beans/StoreCreditBean.java#2 $$Change: 651448 $";
