 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/EStore/src/atg/projects/store/pricing/StorePricingModelProperties.java#2 $
 */
public class StorePricingModelProperties extends PricingModelProperties {

  /** Class version string. */
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/EStore/src/atg/projects/store/pricing/StorePricingModelProperties.java#2 $$Change: 651448 $";
