...
public class ItemRepositoryValidator extends GenericService implements CollectionObjectValidator {
   ...
   */
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/EStore/src/atg/projects/store/repository/filter/ItemRepositoryValidator.java#2 $$Change: 651448 $";
