    ...
    <c:choose>
      <c:when test="${empty preFillValues || preFillValues}">
        <dsp:input type="text" bean="${formHandlerComponent}.phoneNumber" iclass="required"
                   ...
                   <dsp:tagAttribute name="targetButton" value="atg_store_editAddressSubmit" />
                 </dsp:input>
      </c:when>
      <c:otherwise>
        <dsp:input type="text" bean="${formHandlerComponent}.phoneNumber" iclass="required"
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/Storefront/j2ee/store.war/global/gadgets/addressAddEdit.jsp#2 $$Change: 651448 $--%>
