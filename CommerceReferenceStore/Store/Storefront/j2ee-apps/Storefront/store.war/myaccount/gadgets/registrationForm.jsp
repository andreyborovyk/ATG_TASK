   ...
   <li class="atg_store_registerLastName">
     <label for="atg_store_registerLastName" class="required">
      ...
      <dsp:input bean="${formHandler}.value.lastName"
                 ...
                 <dsp:tagAttribute name="targetButton" value="atg_store_createMyAccount" />
             </dsp:input>
   </li>
   </ul>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.0.3/Storefront/j2ee/store.war/myaccount/gadgets/registrationForm.jsp#2 $$Change: 651448 $--%>