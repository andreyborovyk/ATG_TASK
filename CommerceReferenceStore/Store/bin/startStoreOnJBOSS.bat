...
:copydatasources
  ...
  if NOT EXIST %ATG_MYSQL_FILE% copy %DYNAMO_HOME%\..\DafEar\Tomcat\copy-to-jboss_home-your_server-deploy-dir\atg-mysql-ds.xml %ATG_MYSQL_FILE%
  if NOT EXIST %ATG_APPS_FILE% copy %DYNAMO_HOME%\..\DafEar\Tomcat\copy-to-jboss_home-your_server-deploy-dir\atg-apps-mysql-ds.xml %ATG_APPS_FILE%
  goto :runassembler
