...
create table srch_config (
	...
	claimed_generation	integer	default null,
	nxt_inc_generation	integer	default null,
	uniq_server_id	varchar(254)	default null,
	last_activity	timestamp	default null,
	last_full_index	timestamp	default null,
	last_incr_index	timestamp	default null
