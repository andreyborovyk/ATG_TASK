...
create table rout_env (
	id	varchar(40)	not null,
	env_name	nvarchar(254)	not null,
...
create table rout_host_inf (
	...
	lnch_svc_name	nvarchar(40)	null,
	lnch_svc_protocol	varchar(40)	null,
	cpu_count	integer	null,
	os_name	nvarchar(254)	null,
	os_arch	nvarchar(254)	null,
	os_version	nvarchar(254)	null
...
create table rout_host (
	...
	index_root_path	nvarchar(254)	null,
...
create table rout_log_part (
	id	varchar(40)	not null,
	lp_name	nvarchar(40)	null,
	lp_description	nvarchar(254)	null,
	parent_index	varchar(40)	null,
	...
	est_start	datetime	null,
	est_end	datetime	null,
	content_label	nvarchar(40)	null,
...
create table rout_swpchk (
	id	varchar(40)	not null,
	appserver_name	nvarchar(254)	null,
