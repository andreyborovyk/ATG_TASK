...
create table srch_refine_elems (
	...
	desired	integer	default null,
	minimum	integer	default null,
	incr	integer	default null,
	sort_type	integer	default null,
	levels	integer	default null,
	parent_refine_elem	varchar(40)	default null,
	priority	integer	default null,
	remove_when_used	numeric(3)	not null,
	display_fragment	varchar(254)	default null,
	max_values	integer	default null,
	round_free_range	integer	default null
...
create table srch_refine_subels (
	...
	refine_element	varchar(40)	default null
...
create table srch_refel_order (
	...
	id	varchar(40)	not null,
	seq	integer	not null,
	order_value	varchar(254)	not null
...
create table srch_refel_range (
	...
	id	varchar(40)	not null,
	seq	integer	not null,
	range_value	varchar(254)	not null
...
create table srch_refel_select (
	...
	id	varchar(40)	not null,
	seq	integer	not null,
	select_value	varchar(254)	not null
...
create table srch_refel_exclude (
	asset_version	numeric(19)	not null,
	id	varchar(40)	not null,
	exclude_value	varchar(254)	not null
...
create table srch_refine_config (
	...
	refine_cfg_name	varchar(80)	default null
...
create table srch_cfg_dimnode (
	...
	dim_name	varchar(254)	not null,
	dim_desc	varchar(254)	default null,
	dim_value	varchar(254)	default null,
	dim_service	varchar(254)	default null
...
create table srch_cfg_dtinfo (
	...
	dti_name	varchar(254)	not null,
	dti_desc	varchar(254)	default null,
	dti_app	integer	not null,
	dti_root_id	varchar(40)	default null
...
create table srch_cfg_fol (
	...
	fol_dim_svc	varchar(40)	default null
...
create table srch_cfg_rule (
	...
	r_display_name	varchar(254)	default null,
	r_enabled	numeric(3)	not null,
	r_rule_type	integer	default null,
	r_rule	long varchar	not null,
	r_action	long varchar	not null,
	r_desc	varchar(254)	default null
...
create table srch_cfg_synset (
	...
	syn_base_term	varchar(254)	not null,
	syn_reciprocal	numeric(3)	not null
...
create table srch_cfg_rprop (
	...
	rp_rng_met	integer	default null
...
create table srch_cfg_cfg (
	...
	cfg_locale	varchar(40)	default null,
	cfg_rm	varchar(40)	default null,
	cfg_base_id	varchar(40)	default null,
	use_base_rankprps	numeric(3)	not null
...
create table srch_cfg_rank (
	...
	rank_value	varchar(254)	not null,
