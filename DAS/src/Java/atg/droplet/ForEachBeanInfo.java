...
/**
 * <p>BeanInfo for the ForEach droplet.
 *
 * @author Natalya Cohen
 * @version $Id: //product/DAS/version/10.0.3/Java/atg/droplet/ForEachBeanInfo.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 **/

public class ForEachBeanInfo extends DropletBeanInfo {
  //-------------------------------------
  // CONSTANTS
  //-------------------------------------
  public static String CLASS_VERSION = 
  "$Id: //product/DAS/version/10.0.3/Java/atg/droplet/ForEachBeanInfo.java#2 $$Change: 651448 $";
  ...
  private final static ParamDescriptor[] sOutputDescriptors = {
    ...
    new ParamDescriptor("count", "loop count (1-based)",
                        Integer.class, false, false),
    new ParamDescriptor("size", "array size",
                        Integer.class, false, false),
    /*
  ...
  createBeanDescriptor(ForEach.class, 
		       "atg.ui.document.wizard.ForEachDropletWizard",
		       "This servlet renders an output for each element in the specified array.",
		       sParamDescriptors);
