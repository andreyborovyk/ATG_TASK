 ...
 * @version $Id: //product/DAS/version/10.0.3/Java/atg/droplet/RangeBeanInfo.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 **/

public class RangeBeanInfo extends DropletBeanInfo {
  //-------------------------------------
  // CONSTANTS
  //-------------------------------------
  public static String CLASS_VERSION = 
  "$Id: //product/DAS/version/10.0.3/Java/atg/droplet/RangeBeanInfo.java#2 $$Change: 651448 $";
  ...
  createBeanDescriptor(Range.class, 
		       "atg.ui.document.wizard.RangeDropletWizard",
		       "This servlet renders an output for a range of elements in the specified array.",
		       sParamDescriptors);
