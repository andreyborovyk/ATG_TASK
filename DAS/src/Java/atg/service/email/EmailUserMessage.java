 ...
 *      <br><code>EmailUserMessage.getString("MSG1", Locale)</code>
 *  <li>to obtain a formatted message from a resource bundle
 *      <br><code>Object[] params = {"one", "two"};</code>
 *      <br><code>EmailUserMessage.format("MSG2", params, Locale)</code>
 * </UL>
 *
 * @author Bob Mason
 * @version $Id: //product/DAS/version/10.0.3/Java/atg/service/email/EmailUserMessage.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */

public 
class EmailUserMessage
{
  //-------------------------------------
  /** Class version string */
  public static String CLASS_VERSION =
  "$Id: //product/DAS/version/10.0.3/Java/atg/service/email/EmailUserMessage.java#2 $$Change: 651448 $";
  ...
  {
    return (ResourceUtils.getBundle(RESOURCE_BUNDLE, pLocale));
  }
