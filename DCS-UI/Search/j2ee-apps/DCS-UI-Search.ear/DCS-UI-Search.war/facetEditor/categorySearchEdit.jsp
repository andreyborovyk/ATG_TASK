<%--
  This is the itemView page for the category "Search" tab. It defines all the 
  faceted search admin functionality available to a category.
  
    @param  imap          A request scoped, MappedItem
    @param  view          A request scoped, MappedItemView
    @param  formHandler   The form handler

  @version $Id: //product/DCS-UI/version/10.0.3/search/src/web-apps/DCS-UI-Search/facetEditor/categorySearchEdit.jsp#2 $$Change: 651448 $
...
<c:set var="categoryId"      value="${formHandler.repositoryId}" scope="request"/>
...
<c:if test="${debug}">
  ...
  <c:if test="${formHandler.shared}">
    ...
    <fieldset>
    <legend><span><fmt:message key="categoryFacets" bundle="${bundle}"/></span></legend>
      ...
      <tr>
        ...
        <td>
          ...
          <dspel:input type="checkbox"
                       ...
                       onchange="javascript:markAssetModified()"
                       onpropertychange="javascript:formFieldModified()"
      ...
      <tr>
        ...
        <td>
          ...
          <dspel:input type="checkbox"
                       ...
                       onchange="javascript:markAssetModified()"
                       onpropertychange="javascript:formFieldModified()"
                       bean="${formHandlerPath}.canInheritFromCategory"/><fmt:message key="inheritCategoryFacets" bundle="${bundle}"/>
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          ...
          <dspel:input type="checkbox"
                       ...
                       onchange="javascript:markAssetModified()"
                       onpropertychange="javascript:formFieldModified()"
                       bean="${formHandlerPath}.canChildrenInherit"/><fmt:message key="allowCategoryInherit" bundle="${bundle}"/>
        </td>
      </tr>
      ...
      <tr>
        ...
        <c:if test="${debug}">
          ...
          <dspel:include page="property/collectionEditor.jsp">
            ...
            <dspel:param name="subPropertyType"      value="commerceRefineElement"/>
