...
create table ARF_CURRENCY_CONV (
	...
	SRC_DST_CONV_RATE	numeric(19,7)	not null,
	DST_SRC_CONV_RATE	numeric(19,7)	not null
...
create table ARF_PRODUCT (
	...
	DESCRIPTION_EN	varchar(254)	null,
	PARENT_CAT_ID	integer	null,
	BRAND	nvarchar(254)	null,
	BRAND_EN	varchar(254)	null,
	RECORD_LAST_UPDATE	datetime	null,
	RECORD_START_DATE	datetime	null,
	RECORD_END_DATE	datetime	null,
	MOST_RECENT	tinyint	default 1 not null,
...
create table ARF_PROMOTION (
	...
	PROMO_NAME	nvarchar(254)	not null,
	PROMO_NAME_EN	varchar(254)	null,
	PROMO_DESC	nvarchar(254)	null,
	PROMO_DESC_EN	varchar(254)	null,
	PROMO_TYPE	nvarchar(254)	null,
	PROMO_ENABLED	tinyint	null,
	PROMO_BEGIN_USABLE	datetime	null,
	PROMO_END_USABLE	datetime	null,
	PROMO_GLOBAL	tinyint	null,
	RECORD_LAST_UPDATE	datetime	null,
	RECORD_START_DATE	datetime	null,
	RECORD_END_DATE	datetime	null,
	MOST_RECENT	tinyint	default 1 not null,
...
create table ARF_LINE_ITEM (
	...
	NCUSTOMER_ID	varchar(40)	null,
	AGENT_ID	varchar(40)	null,
	ORIGIN_SALES_CHANNEL_ID	tinyint	null,
	SUBMIT_SALES_CHANNEL_ID	tinyint	null,
	...
	IS_MARKDOWN	tinyint	default 0 not null,
	LOCAL_UNIT_PRICE	numeric(19,7)	not null,
	LOCAL_GROSS_REVENUE	numeric(19,7)	not null,
	LOCAL_DISCOUNT_AMOUNT	numeric(19,7)	not null,
	LOCAL_MARKDOWN_DISC_AMOUNT	numeric(19,7)	not null,
	LOCAL_ORDER_TAX_ALLOC	numeric(19,7)	not null,
	LOCAL_ORDER_SHIPPING_ALLOC	numeric(19,7)	not null,
	LOCAL_ORDER_DISCOUNT_ALLOC	numeric(19,7)	not null,
	LOCAL_NET_REVENUE	numeric(19,7)	not null,
	LOCAL_ORDER_NET_REVENUE	numeric(19,7)	not null,
	LOCAL_APPSMT_DBT_ALLOC_AMT	numeric(19,7)	null,
	LOCAL_APPSMT_CDT_ALLOC_AMT	numeric(19,7)	null,
	LOCAL_PRICE_OVERRIDE_AMT	numeric(19,7)	null,
	STANDARD_UNIT_PRICE	numeric(19,7)	not null,
	STANDARD_GROSS_REVENUE	numeric(19,7)	not null,
	STANDARD_DISCOUNT_AMOUNT	numeric(19,7)	not null,
	STANDARD_MARKDOWN_DISC_AMOUNT	numeric(19,7)	not null,
	STANDARD_ORDER_TAX_ALLOC	numeric(19,7)	not null,
	STANDARD_ORDER_SHIPPING_ALLOC	numeric(19,7)	not null,
	STANDARD_ORDER_DISCOUNT_ALLOC	numeric(19,7)	not null,
	STANDARD_NET_REVENUE	numeric(19,7)	not null,
	STANDARD_ORDER_NET_REVENUE	numeric(19,7)	not null,
	STANDARD_APPSMT_DBT_ALLOC_AMT	numeric(19,7)	null,
	STANDARD_APPSMT_CDT_ALLOC_AMT	numeric(19,7)	null,
	STANDARD_PRICE_OVERRIDE_AMT	numeric(19,7)	null,
...
create table ARF_RET_REASON_DISPOSITION (
	...
	DESCRIPTION	nvarchar(254)	null,
	DESCRIPTION_EN	varchar(254)	null,
	DISPOSITION	tinyint	default 0 null
...
create table ARF_RETURN_ITEM (
	...
	NEXCHANGE_ORDER_ID	varchar(40)	null,
	RETURN_ITEM_ID	bigint	not null,
	NRETURN_ITEM_ID	varchar(40)	not null,
	QUANTITY	numeric(19)	not null,
	EXCHANGE	tinyint	default 0 not null,
	RETURN_SALES_CHANNEL_ID	tinyint	not null,
	AGENT_ID	varchar(40)	not null,
	RETURN_REASON_ID	integer	not null,
	ITEM_SITE_ID	smallint	not null,
	SUBMITTED_SITE_ID	smallint	not null,
	LOCAL_ITEM_REFUND	numeric(19,7)	not null,
	LOCAL_TOTAL_REFUND	numeric(19,7)	not null,
	LOCAL_TOTAL_ADJ_ALLOC	numeric(19,7)	not null,
	LOCAL_SHIPPING_REFUND_ALLOC	numeric(19,7)	not null,
	LOCAL_TAX_REFUND_ALLOC	numeric(19,7)	not null,
	LOCAL_OTHER_REFUND_ALLOC	numeric(19,7)	not null,
	LOCAL_RETURN_FEE_ALLOC	numeric(19,7)	not null,
	STD_ITEM_REFUND	numeric(19,7)	not null,
	STD_TOTAL_REFUND	numeric(19,7)	not null,
	STD_TOTAL_ADJ_ALLOC	numeric(19,7)	not null,
	STD_SHIPPING_REFUND_ALLOC	numeric(19,7)	not null,
	STD_TAX_REFUND_ALLOC	numeric(19,7)	not null,
	STD_OTHER_REFUND_ALLOC	numeric(19,7)	not null,
	STD_RETURN_FEE_ALLOC	numeric(19,7)	not null
