...
REM @Version $Id: //product/DCS/version/10.0.3/templates/DCS/Versioned/install/importDCSVersioned.bat#2 $$Change: 651448 $
...
:homedone
  ...
  call bin\startSQLRepository.bat -m DPS.Versioned -repository /atg/userprofiling/PersonalizationRepository -import "%DYNAMO_HOME%\..\DCS\install\data\initial-segment-lists.xml" -workspace PersonalizationRepositoryImport1:main -comment InitialCheckin
