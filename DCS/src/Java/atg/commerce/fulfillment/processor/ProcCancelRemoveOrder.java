 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcCancelRemoveOrder.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class ProcCancelRemoveOrder implements PipelineProcessor {
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcCancelRemoveOrder.java#2 $$Change: 651448 $";
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    // the remove shipping group failed, cancel the removal
    if(modification.getModificationStatus() == Modification.STATUS_FAILED) {
    ...
    handleRemoveModification(of,map);    

    return SUCCESS;
  }

  protected void handleRemoveModification(FulfillerSystem of, HashMap pMap) throws Exception {
    Modification modification = (Modification)pMap.get(PipelineConstants.MODIFICATION);
    if (modification instanceof IdTargetModification) {
      IdTargetModification itm = (IdTargetModification) modification;
      if (itm.getTargetType() == Modification.TARGET_SHIPPING_GROUP) {
        PipelineResult result = null;
        result = of.getFulfillmentPipelineManager().runProcess("completeOrder", pMap);
      }
    } 
