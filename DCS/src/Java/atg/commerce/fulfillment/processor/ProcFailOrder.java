 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcFailOrder.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class ProcFailOrder implements PipelineProcessor {
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcFailOrder.java#2 $$Change: 651448 $";
  ...
  //-----------------------------------------------
  /**
   * Fails the order by setting its state to PENDING_MERCHANT_ACTION
   *
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    GenericUpdate pModification = (GenericUpdate) modification;
    OrderStates os = of.getOrderStates();
    OrderFulfillmentTools tools = of.getOrderFulfillmentTools();
    
    // any exceptions could have been thrown in the HandleUpdatedStateValue processor
    ShippingGroup sg = pOrder.getShippingGroup(pModification.getTargetId());
