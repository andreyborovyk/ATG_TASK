 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcHandleRetrievingOrder.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class ProcHandleRetrievingOrder implements PipelineProcessor {
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcHandleRetrievingOrder.java#2 $$Change: 651448 $";
  ...
  private final int RETRIEVE_BY_ORDER = 1;
  private final int RETRIEVE_BY_ORDER_ID = 2;
  
  //-----------------------------------------------
  public ProcHandleRetrievingOrder() {
  }

  //-----------------------------------------------
  /**
   * Returns the valid return codes
   * 1 - The processor to retrieve order by its object
   * 2 - The processor to retrieve order by its id
   * @return an integer array of the valid return codes.
   */
  public int[] getRetCodes()
  {
    int[] ret = {RETRIEVE_BY_ORDER, RETRIEVE_BY_ORDER_ID};
    return ret;
  } 
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    // check the orderId, if it's null, we might be getting
    // the whole order object from the commerce message
    if (orderId == null) {
        boolean orderIdFlag = of.getLookUpOrderIdFromOrder();
        if (orderIdFlag)
            return RETRIEVE_BY_ORDER;
        else {
