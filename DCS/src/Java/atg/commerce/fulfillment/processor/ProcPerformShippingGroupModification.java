 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcPerformShippingGroupModification.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class ProcPerformShippingGroupModification implements PipelineProcessor {
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcPerformShippingGroupModification.java#2 $$Change: 651448 $";
   ...
   *
   * @param pParam a HashMap which must contain an Order, CommerceMessage and OrderFulfiller object
