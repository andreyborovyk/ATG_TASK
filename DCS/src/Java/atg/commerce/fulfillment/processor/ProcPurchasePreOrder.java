 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcPurchasePreOrder.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class ProcPurchasePreOrder implements PipelineProcessor {
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcPurchasePreOrder.java#2 $$Change: 651448 $";
  ...
  //-----------------------------------------------
  /**
   * Allocates a pre ordered item from the inventory
   *
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    try {
      ...
      int allocation = inventory.purchaseOffPreorder(sku, pQuantity);
      switch(allocation) {
