 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcUpdateOrderRepository.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class ProcUpdateOrderRepository implements PipelineProcessor {
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/fulfillment/processor/ProcUpdateOrderRepository.java#2 $$Change: 651448 $";
  ...
  //-----------------------------------------------
  public ProcUpdateOrderRepository() {
  }
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    if(performedModifications.size() > 0) {
        if (of.isLoggingDebug()) {
            of.logDebug("Inside updateOrderRepository");
            of.getOrderFulfillmentTools().printOrder(pOrder);
        }    
        
        of.getOrderManager().updateOrder(pOrder);
    }
