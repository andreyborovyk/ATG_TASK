 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/processor/ProcLoadHandlingInstructionObjects.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class ProcLoadHandlingInstructionObjects extends LoadProperties implements PipelineProcessor {
  
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/processor/ProcLoadHandlingInstructionObjects.java#2 $$Change: 651448 $";
  ...
  //-----------------------------------------------
  public ProcLoadHandlingInstructionObjects() {
  }
  ...
  //-------------------------------------
  // property: handlingInstructionsProperty
  //-------------------------------------
  private String mHandlingInstructionsProperty = "handlingInstructions";

  /**
   * Returns the handlingInstructionsProperty name. This is the handlingInstructions property in the
   * ShippingGroup repository item.
   */
  public String getHandlingInstructionsProperty() {
    return mHandlingInstructionsProperty;
  }

  /**
   * Sets the handlingInstructionsProperty name. This is the handlingInstructions property in the
   * ShippingGroup repository item.
   */
  public void setHandlingInstructionsProperty(String pHandlingInstructionsProperty) {
    mHandlingInstructionsProperty = pHandlingInstructionsProperty;
  }

  //-------------------------------------
  // property: LoggingIdentifier
  String mLoggingIdentifier = "ProcLoadHandlingInstructionObjects";
  ...
  /**
   * This method loads the HandlingInstruction objects from the OrderRepository into a ShippingGroup
   * in the Order object. It does this by constructing a new HandlingInstruction instance based on the
   * class mapped to the repository item type of the HandlingInstruction. It then iterates through the
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    ShippingGroup sg;
    List shippingGroups, handlingInstructions;
    ...
    while (iter.hasNext()) {
      ...
      sg = order.getShippingGroup(sgMutItem.getRepositoryId());

      handlingInstructions = (List) sgMutItem.getPropertyValue(getHandlingInstructionsProperty());
      innerIter = handlingInstructions.iterator();
      while (innerIter.hasNext()) {
        mutItem = (MutableRepositoryItem) innerIter.next();
