 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/processor/ProcRemoveEmptyShippingGroups.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class ProcRemoveEmptyShippingGroups extends ApplicationLoggingImpl implements PipelineProcessor {  
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/processor/ProcRemoveEmptyShippingGroups.java#2 $$Change: 651448 $";
  ...
  String mLoggingIdentifier = "ProcRemoveEmptyShippingGroups";
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    orderManager.removeEmptyShippingGroups(order);
