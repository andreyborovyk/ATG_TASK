 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/processor/ProcSaveShippingGroupObjects.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 * @see atg.commerce.order.ShippingGroup
 */
public class ProcSaveShippingGroupObjects extends SavedProperties implements PipelineProcessor {
  
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/processor/ProcSaveShippingGroupObjects.java#2 $$Change: 651448 $";
  ...
  //-----------------------------------------------
  public ProcSaveShippingGroupObjects() {
  }
  ...
  String mLoggingIdentifier = "ProcSaveShippingGroupObjects";
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    for (ShippingGroup group = null; iter.hasNext(); ) {
      ...
      if ((! order.isTransient()) && mutItem.isTransient()) {
        if (isLoggingDebug())
          logDebug("Adding ShippingGroup to Repository: " + mutItem.getItemDescriptor().getItemDescriptorName());
    ...
    if (changed) {
      ...
      if (isLoggingDebug())
        logDebug("Set changed flag to true in ProcSaveShippingGroupObjects");
    }
