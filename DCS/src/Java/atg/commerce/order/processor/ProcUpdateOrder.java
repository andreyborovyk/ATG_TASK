...
/**
 * This processor calls updateOrder() on the supplied Order
 *
 * @author Manny Parasirakis
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/processor/ProcUpdateOrder.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 * @see atg.commerce.order.OrderManager#updateOrder(Order)
 */
public class ProcUpdateOrder extends ApplicationLoggingImpl implements PipelineProcessor {
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/processor/ProcUpdateOrder.java#2 $$Change: 651448 $";
  ...
  String mLoggingIdentifier = "ProcUpdateOrder";
  ...
  //-----------------------------------------------
  /**
   * This method calls updateOrder() on the supplied Order
   *
  ...
  public int runProcess(Object pParam, PipelineResult pResult) throws Exception
  {
    ...
    if (isLoggingDebug())
      logDebug("Updating order: " + order.getId());
