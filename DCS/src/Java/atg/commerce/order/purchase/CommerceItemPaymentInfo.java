 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/purchase/CommerceItemPaymentInfo.java#2 $$Change: 651448 $
...
public class CommerceItemPaymentInfo extends CommerceIdentifierPaymentInfo
{
  ...
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/purchase/CommerceItemPaymentInfo.java#2 $$Change: 651448 $";
    
  //--------------------------------------------------
  // Constants
  //--------------------------------------------------

  public static final String AMOUNT_TYPE = RelationshipTypes.PAYMENTAMOUNT_STR;
  public static final String AMOUNTREMAINING_TYPE = RelationshipTypes.PAYMENTAMOUNTREMAINING_STR;
  ...
  /**
   * Creates a new <code>CommerceItemPaymentInfo</code> instance.
   *
   */
