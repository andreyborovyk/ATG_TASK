 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/purchase/ShippingGroupPaymentInfo.java#2 $$Change: 651448 $
...
public class ShippingGroupPaymentInfo extends CommerceIdentifierPaymentInfo
{
  ...
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/purchase/ShippingGroupPaymentInfo.java#2 $$Change: 651448 $";
    
  //--------------------------------------------------
  // Constants
  //--------------------------------------------------

  public static final String AMOUNT_TYPE = RelationshipTypes.SHIPPINGAMOUNT_STR;
  public static final String AMOUNTREMAINING_TYPE = RelationshipTypes.SHIPPINGAMOUNTREMAINING_STR;
  ...
  /**
   * Creates a new <code>ShippingGroupPaymentInfo</code> instance.
   *
   */
