 ...
 * @version $Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/purchase/TaxPaymentInfo.java#2 $$Change: 651448 $
...
public class TaxPaymentInfo extends CommerceIdentifierPaymentInfo
{
  ...
  public static String CLASS_VERSION = "$Id: //product/DCS/version/10.0.3/Java/atg/commerce/order/purchase/TaxPaymentInfo.java#2 $$Change: 651448 $";
    
  //--------------------------------------------------
  // Constants
  //--------------------------------------------------

  public static final String AMOUNT_TYPE = RelationshipTypes.TAXAMOUNT_STR;
  public static final String AMOUNTREMAINING_TYPE = RelationshipTypes.TAXAMOUNTREMAINING_STR;
  ...
  /**
   * Creates a new <code>TaxPaymentInfo</code> instance.
   *
   */
