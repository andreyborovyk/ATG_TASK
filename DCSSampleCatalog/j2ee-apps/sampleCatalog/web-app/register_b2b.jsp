...
user profile like the default B2B user profile, which provides for
multiple billing and shipping addresses per user, plus properties
that store the default billing address and default shipping address.

This version of the registration page stores the addresses provided
by the user in the defaultBillingAddress and defaultShippingAddress
properties of the user profile.  

The B2C version of the registration page works exactly the same way,
but assumes a B2C user profile with only one billing address and
only one shipping address, so it stores the addresses provided here 
in the billingAddress and shippingAddress properties.  Except for 
this detail, the two pages are identical.  
--%>
...
<tr>
<td>Address:</td>
<td><dsp:input bean="ProfileFormHandler.value.defaultBillingAddress.address1" maxsize="30" size="30" type="TEXT"/></td>
</tr>

<tr>
<td>City:</td>
<td><dsp:input bean="ProfileFormHandler.value.defaultBillingAddress.city" maxsize="30" size="30" type="TEXT"/></td>
</tr>

<tr>
<td>State:</td>
<td>
<dsp:select bean="ProfileFormHandler.value.defaultBillingAddress.state">
...
<tr>
<td>Zipcode:</td>
<td><dsp:input bean="ProfileFormHandler.value.defaultBillingAddress.postalCode" maxsize="10" size="10" type="TEXT"/></td>
</tr>

<tr>
<td>Country:</td>
<td><dsp:input bean="ProfileFormHandler.value.defaultBillingAddress.country" maxsize="10" size="10" type="TEXT"/></td>
</tr>
</table>
</td>
...
<tr>
<td>Address:</td>
<td><dsp:input bean="ProfileFormHandler.value.defaultShippingAddress.address1" maxsize="30" size="30" type="TEXT"/></td>
</tr>

<tr>
<td>City:</td>
<td><dsp:input bean="ProfileFormHandler.value.defaultShippingAddress.city" maxsize="30" size="30" type="TEXT"/></td>
</tr>

<tr>
<td>State:</td>
<td>
<dsp:select bean="ProfileFormHandler.value.defaultShippingAddress.state">
<dsp:option value="AL"/>Alabama
<dsp:option value="AK"/>Alaska
<dsp:option value="AZ"/>Arizona
<dsp:option value="AR"/>Arkansas
...
<tr>
<td>Zipcode:</td>
<td><dsp:input bean="ProfileFormHandler.value.defaultShippingAddress.postalCode" maxsize="10" size="10" type="TEXT"/></td>
</tr>
<tr>
<td>Country:</td>
<td><dsp:input bean="ProfileFormHandler.value.defaultShippingAddress.country" maxsize="10" size="10" type="TEXT"/></td>
</tr>
...
<%-- @version $Id: //product/DCS/version/10.0.3/release/DCSSampleCatalog/j2ee-apps/sampleCatalog/web-app/register_b2b.jsp#2 $$Change: 651448 $--%>
