...
Your session has expired. Go to <dsp:a href="index.jsp">Catalog Home</dsp:a> to resume.<BR>
...
<%-- @version $Id: //product/DCS/version/10.0.3/release/DCSSampleCatalog/j2ee-apps/sampleCatalog/web-app/session_expired.jsp#2 $$Change: 651448 $--%>
