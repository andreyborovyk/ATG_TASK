<%--
  Tab for browsing general info about content group assets.
...
<dspel:page>
  ...
  <c:set var="tabName" value="contentGroupGeneral"/>
...
<%-- @version $Id: //product/DPS-UI/version/10.0.3/src/web-apps/DPS-UI/assetEditor/tab/targeting/browseContentGroupGeneral.jsp#2 $$Change: 651448 $--%>
