<%--
  Tab for browsing general info about segments.
...
<%-- @version $Id: //product/DPS-UI/version/10.0.3/src/web-apps/DPS-UI/assetEditor/tab/targeting/browseSegmentGeneral.jsp#2 $$Change: 651448 $--%>
