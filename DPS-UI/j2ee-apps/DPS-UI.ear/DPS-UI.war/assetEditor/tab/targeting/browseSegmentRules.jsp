<%--
  Tab for browsing segment rules.
...
<%-- @version $Id: //product/DPS-UI/version/10.0.3/src/web-apps/DPS-UI/assetEditor/tab/targeting/browseSegmentRules.jsp#2 $$Change: 651448 $--%>
