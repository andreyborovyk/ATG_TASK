...
REM @Version $Id: //product/DPS/version/10.0.3/templates/DPS/InternalUsers/Search/Base/install/importDPS.bat#2 $$Change: 651448 $
...
:homedone
  ...
  call bin\startSQLRepository.bat -m DPS -repository /atg/userprofiling/PersonalizationRepository -import "%DYNAMO_HOME%\..\DPS\InternalUsers\Search\Base\install\data\initial-segment-lists.xml"
