...
REM @Version $Id: //product/DPS/version/10.0.3/templates/DPS/InternalUsers/Search/Base/install/importDPSVersioned.bat#2 $$Change: 651448 $
...
:homedone
  ...
  echo.
  echo Importing DPS/InternalUsers/Search/Base/install/data/initial-segment-lists.xml into /atg/userprofiling/PersonalizationRepository

  call bin\startSQLRepository.bat -m DPS.Versioned -repository /atg/userprofiling/PersonalizationRepository -import "%DYNAMO_HOME%\..\DPS\InternalUsers\Search\Base\install\data\initial-segment-lists.xml" -workspace PersonalizationRepositoryInternalUsersSearchImport:main -comment InitialCheckin
