      ...
      <tr valign=top>
        ...
        <table border=0 width=500 cellpadding=4 cellspacing=0>
          <tr>
            ...
            <td><!-- switch the title on the user's language/locale -->
            ...
            <dsp:droplet name="/atg/targeting/TargetingForEach">
              ...
              <dsp:oparam name="empty">
                Aucune fonctionnalité aujourd'hui !
              </dsp:oparam>
...
<%/* @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/featurelist.jsp#2 $$Change: 651448 $ */%> </dsp:page>
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/featurelist.jsp#2 $$Change: 651448 $--%>
