...
<dsp:droplet name="Switch">
  ...
  <dsp:oparam name="default">
    <table border=0 cellpadding=4>
      ...
      <tr>
        <td>すでに登録されています。
        <dsp:a href="index.jsp">続行する</dsp:a>か、<dsp:a href="logout.jsp">ログアウト</dsp:a>してください。</td>
      </tr>
    </table>  
  </dsp:oparam>
  ...
  <dsp:oparam name="guest">
    ...
    <table border=0 cellpadding=4>
      ...
      <tr>
        <td colspan=2><font size=+2>登録</font><p> </td>
     </tr>
     <dsp:droplet name="Switch">
     ...
     <tr>
       ...
       <table border=0 cellpadding=4>
         <tr>
           <td colspan=2><font size=+1><b>ログイン情報</b></font></td>
         </tr>
         <tr>
         ...
         <tr>
           <td></td>
           <td><dsp:input bean="ProfileFormHandler.create" type="submit" value=" 続行 "/></td>
         </tr>
       </table></td>
     </tr>
