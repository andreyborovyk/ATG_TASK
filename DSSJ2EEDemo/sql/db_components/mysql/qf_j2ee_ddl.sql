...
create table dss_qf_ftr (
	...
	file_content	nvarchar(254)	null,
	length	integer	null
...
create table dss_qf_ftr_cont (
	id	varchar(254)	not null,
	file_content	nvarchar(8000)	null
...
create table dss_qf_fund (
	id	varchar(254)	not null,
	fundName	nvarchar(254)	null,
	aggressiveIndex	integer	null,
	symbol	nvarchar(254)	null,
	category	nvarchar(254)	null,
	price	numeric(25,6)	null,
	parentFolder	varchar(254)	null,
	objective	nvarchar(1024)	null,
	...
	intro	nvarchar(1024)	null,
	compFundName	nvarchar(254)	null,
...
create table dss_qf_fund_cont (
	id	varchar(254)	not null,
	file_content	nvarchar(8000)	not null
...
create table dss_qf_news (
	...
	relativePath	varchar(254)	null,
	parentFolder	varchar(254)	null,
	contentName	nvarchar(254)	null,
	language	varchar(12)	null,
	file_content	varchar(254)	null,
	news_content	nvarchar(8000)	null
...
create table dss_qf_email (
	...
	ModContent	nvarchar(1024)	null,
	ConsContent	nvarchar(1024)	null,
	BrokerSignature	nvarchar(254)	null,
	language	varchar(12)	null,
	file_content	nvarchar(254)	null
