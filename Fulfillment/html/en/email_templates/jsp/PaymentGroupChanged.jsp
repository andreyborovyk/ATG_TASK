...
<dsp:droplet name="ForEach">
  ...
  <dsp:oparam name="output">
	...
	<dsp:valueof converter="creditcard" groupingsize="4" param="paymentGroup.creditCardNumber">no number</dsp:valueof> :
      </dsp:oparam>
    ...
    <dsp:droplet name="Switch">
      <dsp:param name="value" param="message.subType"/>
      <dsp:oparam name="PaymentGroupCredited">
	    Amount Credited = <dsp:valueof converter="currency" param="paymentGroup.amountCredited"/><br>	
      </dsp:oparam>
      <dsp:oparam name="PaymentGroupDebited">
	    Amount = <dsp:valueof converter="currency" param="paymentGroup.amountDebited"/><br>	
      </dsp:oparam>
      <dsp:oparam name="PaymentGroupDebitFailed">
	    Amount = <dsp:valueof converter="currency" param="paymentGroup.amount"/><br>	
      </dsp:oparam>
      <dsp:oparam name="default">
	    New Amount = <dsp:valueof converter="currency" param="paymentGroup.amount"/><br>	
      </dsp:oparam>
    </dsp:droplet>
  </dsp:oparam>
...
<%-- @version $Id: //product/DCS/version/10.0.3/release/Fulfillment/html/en/email_templates/jsp/PaymentGroupChanged.jsp#2 $$Change: 651448 $--%>
