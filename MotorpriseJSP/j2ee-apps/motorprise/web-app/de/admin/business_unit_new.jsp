...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    <td colspan=2 height=18> &nbsp; <span class=small>
     Unternehmensverwaltung</span></td>
  </tr>
  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        <td><span class=big>Unternehmensverwaltung</span><br>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;Neuen Geschäftsbereich erstellen</td></tr></table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border=0 cellpadding=4 cellspacing=0>
          ...
          <tr valign=top>
            <td align=right><span class=smallb>Muttergesellschaft</td>
            <td>
	    ...
	    <dsp:getvalueof id="parentId" idtype="java.lang.String" bean="Profile.parentOrganization.repositoryId">
            <dsp:option selected="<%=true%>" value="<%=parentId%>"/>Muttergesellschaft wählen
	    </dsp:getvalueof>
	    <dsp:droplet name="TargetPrincipals">
          ...
          <tr valign=top>
            ...
            <td><br>
                ...
                <dsp:input bean="CreateOrganizationFormHandler.createOrganization" type="submit" value=" Speichern "/> &nbsp;
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/business_unit_new.jsp#2 $$Change: 651448 $--%>
