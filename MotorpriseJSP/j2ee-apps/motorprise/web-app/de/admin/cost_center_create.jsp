...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Kostenstelle erstellen"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="cost_centers.jsp">Kostenstellen</dsp:a> &gt; Kostenstelle hinzufügen
    </span> </td>
  </tr>
          ...
          <tr> 
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Kostenstelle hinzufügen</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td valign="top" colspan=2 height="92"> 
              <table width="100%" border="0">
                <tr>
                  <td></td><td><span class=smallb>Kennungsnr.</span></td>
                ...
                <tr><td>&nbsp;</td></tr>
                <tr><td></td><td colspan="3" align="left"><dsp:input bean="B2BRepositoryFormHandler.create" type="submit" value="Speichern"/></td></tr>
              </table>
        </dsp:form>
            </td>
          </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/cost_center_create.jsp#2 $$Change: 651448 $--%>
