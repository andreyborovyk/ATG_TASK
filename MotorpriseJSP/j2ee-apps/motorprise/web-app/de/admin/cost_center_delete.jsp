...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="cost_centers.jsp">Kostenstellen</dsp:a> &gt Kostenstelle löschen
    </span> </td>
  </tr>
    ...
    <dsp:oparam name="output">
      ...
      <dsp:input bean="B2BRepositoryFormHandler.deleteErrorURL" paramvalue="deleteErrorURL" type="hidden"/>
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Kostenstelle löschen</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <dsp:input bean="B2BRepositoryFormHandler.delete" type="submit" value="Löschen"/> &nbsp;<dsp:input bean="B2BRepositoryFormHandler.cancel" type="submit" value="Abbrechen"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/cost_center_delete.jsp#2 $$Change: 651448 $--%>
