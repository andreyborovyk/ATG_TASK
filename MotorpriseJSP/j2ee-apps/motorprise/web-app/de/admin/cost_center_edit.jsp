...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Kostenstelle bearbeiten"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="cost_centers.jsp">Kostenstellen</dsp:a> &gt Kostenstelle bearbeiten
    </span> </td>
  </tr>
  <tr valign="top"> 
     ...
     <dsp:oparam name="output">
      ...
      <dsp:input bean="B2BRepositoryFormHandler.updateErrorURL" paramvalue="updateErrorURL" type="hidden"/>
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Kostenstelle bearbeiten</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td valign="top" colspan=2 height="92"> 
              <table width="100%" cellpadding=0 cellspacing=0 border="0">
                <tr>
                  <td><span class=smallb>Kennungsnr.</span></td>
          ...
          <td colspan="3" align="left"><dsp:input bean="B2BRepositoryFormHandler.update" type="submit" value="Speichern"/> &nbsp;<dsp:input bean="B2BRepositoryFormHandler.cancel" type="submit" value="Abbrechen"/></td>
                </tr>
              </table>
            </td>
          </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/cost_center_edit.jsp#2 $$Change: 651448 $--%>
