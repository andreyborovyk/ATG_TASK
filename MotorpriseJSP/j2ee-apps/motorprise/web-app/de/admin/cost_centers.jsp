...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Kostenstellen"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="company_admin.jsp"><dsp:valueof bean="Profile.currentOrganization.name"/></dsp:a> &gt;Kostenstellen
    </span> </td>
  </tr>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Kostenstellen</td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td valign="top" colspan=2 height="92"> 
             ...
             <dsp:oparam name="output">
                <tr>
                  ...
                  <span class=small><dsp:a href="cost_center_edit.jsp">Bearbeiten
                ...
                <tr><td>Diesem Geschöftsbereich sind derzeit keine Kostenstellen zugeordnet.</td></tr>
                </dsp:oparam>
                </dsp:droplet>
                
                <tr><td>&nbsp;</td></tr>
                <tr>
                  <td><span class=smallb><dsp:a href="cost_center_create.jsp">Neue Kostenstelle hinzufügen</dsp:a></span></td>
                </tr>
                <tr><td><br></td></tr>
              </table>
            </dsp:form>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/cost_centers.jsp#2 $$Change: 651448 $--%>
