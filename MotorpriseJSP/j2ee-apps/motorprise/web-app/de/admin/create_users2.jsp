...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    Mehrere Benutzer erstellen</span></td>
  </tr>
    ...
    <td valign="top" width=745>  
     ...
     <dsp:include page="../common/FormError.jsp"></dsp:include> 
      ...
      <table border=0 cellpadding=4 width=100%>
        ...
        <tr valign=top>
          <td colspan=2><span class=big>Unternehmensverwaltung</span><br><span class=little></span></td>
        </tr>
        <tr><td><dsp:img src="../images/d.gif" vspace="0"/></td></tr>
        ...
        <tr valign=top>
          ...
          <table width=100% cellpadding=3 cellspacing=0 border=0>
            <tr><td class=box-top>&nbsp;Neue Benutzer erstellen</td></tr></table>
          </td>
        </tr>
        <tr><td><dsp:img src="../images/d.gif" vspace="0"/></td></tr>
         ...
         <dsp:droplet name="/atg/dynamo/droplet/For">
          <dsp:param bean="MultiUserAddFormHandler.count" name="howMany"/>
           <dsp:oparam name="output">
             ...
             <tr>
               <td align=right><span class=smallb>Bestätigen</span></td>
               <td>
               ...
               <td>
                    ...
                    <dsp:oparam name="true">
                       ...
                       <dsp:oparam name="output">
                          ...
                          <dsp:input bean="MultiUserAddFormHandler.users[param:index].roleIds" paramvalue="role.repositoryId" type="checkbox" />  <dsp:valueof param="role.name">Kein Name</dsp:valueof>
                       </BR>
                       </dsp:oparam>
                       </dsp:droplet>
                   </dsp:oparam>
                   ...
                   <dsp:oparam name="false">
                       ...
                       <dsp:oparam name="output">
                          ...
                          <dsp:oparam name="true">
                            <dsp:input bean="MultiUserAddFormHandler.users[param:index].roleIds" paramvalue="role.repositoryId" type="checkbox" checked="<%=true%>"/>  <dsp:valueof param="role.name">Kein Name</dsp:valueof>
                          </dsp:oparam>
                          <dsp:oparam name="false">
                  	        <dsp:input bean="MultiUserAddFormHandler.users[param:index].roleIds" paramvalue="role.repositoryId" type="checkbox" />  <dsp:valueof param="role.name">Kein Name</dsp:valueof>
                          </dsp:oparam>
         ...
         <tr>
           <td></td>
           <td><b><dsp:input bean="MultiUserAddFormHandler.create" type="submit" value=" Speichern "/> &nbsp;
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/create_users2.jsp#2 $$Change: 651448 $--%>
