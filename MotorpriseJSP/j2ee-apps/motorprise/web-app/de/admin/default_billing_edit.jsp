...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="company_admin.jsp"><dsp:valueof bean="Profile.currentOrganization.name"/></dsp:a> &gt;
         Standard-Rechnungsanschrift auswählen
    </span> </td>
  </tr>
   ...
   <dsp:form action="company_admin.jsp" method="post">
    ...
    <dsp:input bean="B2BRepositoryFormHandler.value.defaultBillingAddress.updateMode" type="hidden" value="replace"/>
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Standard-Rechnungsanschrift auswählen</td>
                </tr>
              </table> 
            </td>
          </tr>
          ...
          <tr><td>&nbsp;</td></tr>
          <tr>
            <td colspan="3" align="left"><dsp:input bean="B2BRepositoryFormHandler.update" type="submit" value=" Speichern "/>
            <input type="submit" name="cancel" value="Abbrechen"></td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/default_billing_edit.jsp#2 $$Change: 651448 $--%>
