...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Versandanschrift auswählen"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
   ...
   Standard-Versandanschrift auswählen
    </span> </td>
  </tr>
  ...
  <tr valign=top> 
   ...
   <dsp:form action="company_admin.jsp" method="post">
    ...
    <dsp:input bean="B2BRepositoryFormHandler.value.defaultShippingAddress.updateMode" type="hidden" value="replace"/>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Standard-Versandanschrift auswählen</td>
                </tr>
              </table> 
            </td>
          </tr>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td colspan="3" align="left"><dsp:input bean="B2BRepositoryFormHandler.update" type="submit" value=" Speichern "/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/default_shipping_edit.jsp#2 $$Change: 651448 $--%>
