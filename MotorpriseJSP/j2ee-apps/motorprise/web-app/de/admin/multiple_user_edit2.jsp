...
<dsp:droplet name="IsEmpty">
  ...
  <dsp:oparam name="true">
    <core:createUrl id="errorPage" url="multiple_user_edit.jsp">
      <core:urlParam param="errorMessage" value="Es wurden keine Benutzer ausgewählt"/>
   ...
   <td width=55><dsp:img src="../images/d.gif" hspace="27"/></td>
	...
	<dsp:form formid="users" action="<%=formTarget%>" method="post"> 
      ...
      <dsp:setvalue bean="Profile.currentUser" paramvalue="user"/>
          ...
          <br>
          <span class=smallb><dsp:a href="multiple_user_edit.jsp">Ausgewählte Benutzerliste bearbeiten</dsp:a></span>
        </blockquote>
        </dsp:form>
	</dsp:getvalueof>
        
        <br>
        <b>Wählen Sie die Attribute aus, die bearbeitet werden sollen</b>
        <blockquote>
          <dsp:form formid="attrs" action="multiple_user_edit3.jsp" method="post">
          <input type="checkbox" name="roles" value="true"> Rollen<br>
          <input type="checkbox" name="shippingAddrs" value="true"> Versandanschriften<br>
           <input type="checkbox" name="paymentMethods" value="true"> Kreditkarten<br>
          <input type="checkbox" name="costCenters" value="true"> Kostenstellen<br>
          <input type="checkbox" name="purchaseLimit" value="true"> Einkaufslimit<br>
          <br> 
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/multiple_user_edit2.jsp#2 $$Change: 651448 $--%>
