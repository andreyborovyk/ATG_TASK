...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="payment_edit.jsp">Kreditkarten</dsp:a> &gt; Kreditkarte bearbeiten</span> </td>
  </tr>
      ...
      <dsp:input bean="B2BRepositoryFormHandler.updateErrorURL" paramvalue="message" type="hidden"/>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Kreditkarte bearbeiten</td>
                </tr>
              </table>
            </td>
          </tr>
        ...
        <dsp:droplet name="IsEmpty">
          ...
          <dsp:oparam name="false">
            <td>
            <dsp:a href="payment_address_edit2.jsp"><span class=smallb>Rechnungsanschrift ändern</span>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/payment_details_edit2.jsp#2 $$Change: 651448 $--%>
