...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Zahlungsweisen"/></dsp:include>
      ...
      <table border=0 cellpadding=4 width=80%>
        ...
        <tr> 
          ...
          <table width=100% cellpadding=3 cellspacing=0 border=0>
            <tr> 
              <td class=box-top>&nbsp;Kreditkarten</td>
            </tr>
          </table>
          </td>
        </tr>
          <tr>
            ...
            <dsp:droplet name="IsEmpty">
              ...
              <dsp:oparam name="true">
                ...
                <dsp:oparam name="true">
                   <span class=small>Es gibt keine Kreditkarten für dieses Unternehmen.</span>
                </dsp:oparam>
                </dsp:droplet>
              </dsp:oparam>  
            </dsp:droplet>
                ...
                <dsp:droplet name="IsEmpty">
                  ...
                  <dsp:oparam name="false">
                    ...
                    <table cellpadding=3 border="0">
                      <tr>
                       <td align=right valign=top><span class=smallb>Kurzname</td>
                       <td><dsp:valueof param="key"/></td>
                      </tr>
                      <tr>
                       <td align=right><span class=smallb>Kartentyp</td>
                       <td><dsp:valueof param="paymentType.creditCardType"/></td>
                      </tr>

                      <tr> 
                        <td align=right><span class=smallb><nobr>Kartennummer</nobr></td>
                        <td valign=top><dsp:valueof param="paymentType.creditCardNumber"/></td>
                      </tr>
                      <tr> 
                        <td align=right><span class=smallb>Ablaufdatum</td>
                        <td valign=top><dsp:valueof param="paymentType.expirationMonth"/>/<dsp:valueof param="paymentType.expirationYear"/></td>
                      </tr>
                      <tr> 
                        <td align=right valign=top><span class=smallb>Rechnungsanschrift</td>
                        <td>
                      ...
                      <tr><td></td>
                        <td>
                       <span><dsp:a href="payment_details_edit2.jsp"><span class=smallb>Bearbeiten</span>
        ...
        <tr>
          <td colspan="3"><dsp:a href="payment_method_create.jsp"><span class=smallb>Neue Kreditkarte erstellen</span></dsp:a></td>
        </tr>
      </table>
    </td>
    </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/payment_edit.jsp#2 $$Change: 651448 $--%>
