  ...
  <tr valign=top> 
   ...
   <dsp:form action="payment_address_edit.jsp" method="post">
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Kreditkarte hinzufügen</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr> 
            <td align=right><span class=smallb>Kreditkartentyp</span></td>
            <td width=75% colspan="2">
          ...
          <tr> 
            <td align=right height="39"><span class=smallb> Name des Karteninhabers</span></td>
          ...
          <tr>
            <td align=right><span class=smallb>Kartennummer</span></td>
            <td colspan="2"> 
              <input type=text size=30 name="creditCardNumber" value="">
            </td>
          </tr>
          <tr>
            <td align=right><span class=smallb>Ablaufdatum</span></td>
            <td colspan="2"> 
              ...
              <br><span class=help>(mm/jjjj)</span>
        
            </td>
          </tr>      
          <tr>
        <td><dsp:img src="../images/d.gif"/></td>
        <td><br><input type="submit" value="Rechnungsanschrift auswählen"></td>
      </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/payment_method_create.jsp#2 $$Change: 651448 $--%>
