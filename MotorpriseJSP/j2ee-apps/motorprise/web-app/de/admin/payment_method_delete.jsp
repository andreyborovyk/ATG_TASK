...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="company_admin.jsp"><dsp:valueof bean="Profile.currentOrganization.name"/></dsp:a> &gt; <dsp:a href="payment_edit.jsp">Kreditkarten</dsp:a> &gt;
     Kreditkarte löschen
    </span></td>
  </tr>
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
        ...
        <table width=100% cellpadding=3 cellspacing=0 border=0>
          <tr> 
            <td class=box-top>&nbsp;Zahlungsweise löschen</td>
          </tr>
        </table>
        </td>
      </tr>
      <tr>
        <td>Diese Kreditkarte löschen</td>
      </tr>
...
<table width="100%" border="0">
              ...
              <td>
              <p>
               <dsp:input bean="B2BRepositoryFormHandler.delete" type="submit" value="Standard-Zahlungsweise löschen"/> &nbsp;
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/payment_method_delete.jsp#2 $$Change: 651448 $--%>
