...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Einkaufslimit"/></dsp:include>
          ...
          <tr> 
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Bewilligungen</td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td valign="top" colspan=2 height="92"> 
              <table border="0" cellpadding=4 width=100%>
                <tr>
                  ...
                  <p>Ein Einkaufslimit kommt nur zur Geltung, falls Bewilligungen verlangt werden. Falls Bewilligungen verlangt werden und das Einkaufslimit auf 0 festgesetzt wurde, ist für alle Bestellungen eine Bewilligung erforderlich.
                  </span></td>
                </tr>
                ...
                <tr>
                  <td width=25% align="right"><span class=smallb>Bewilligungen erforderlich</span></td>
                  <td>
                  <%--  check if inherited --%>
                ...
                <tr>
                  <td width=25% align="right"><span class=smallb>Einkaufslimit</span></td>
                  <td>
                  <% /*  check if inherited */ %>
                  <dsp:droplet name="IsEmpty">
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/purchase_limit_edit.jsp#2 $$Change: 651448 $--%>
