...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Versandanschriften"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="company_admin.jsp"><dsp:valueof bean="Profile.currentOrganization.name"/></dsp:a> &gt;Versandanschriften</span>      </td>
  </tr>
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
        ...
        <table width=100% cellpadding=3 cellspacing=0 border=0>
          <tr> 
            <td class=box-top>&nbsp;Versandanschriften</td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr> 
        ...
        <%-- table to frame content --%>
                  ...
                  <dsp:droplet name="IsEmpty">
                    ...
                    <dsp:oparam name="false">
                      ...
                      <table width="100%" border="0">
                        ...
                        <tr>
                          <td><span class=smallb><dsp:a href="shipping_details_edit.jsp">Bearbeiten
           ...
           <tr><td><br></td></tr>
           <tr>
             <td colspan="3"><dsp:a href="shipping_address_create.jsp"><span class=smallb>Neue Versandanschrift erstellen</span></dsp:a></td>
           </tr>
         </table>
         </td>
       </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/shipping_edit.jsp#2 $$Change: 651448 $--%>
