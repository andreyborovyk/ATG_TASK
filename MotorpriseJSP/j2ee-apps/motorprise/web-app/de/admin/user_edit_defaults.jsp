...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Benutzer-Standardvorgaben bearbeiten"/></dsp:include>
<table border=0 cellpadding=0 cellspacing=0 width=800>
  <tr>
   ...
   <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="user.jsp">Benutzerkonto</dsp:a> &gt; Benutzer-Standardvorgaben bearbeiten
    </span></td>
  </tr>
    ...
    <table border=0 cellpadding=4 width=80%>
     ...
     <dsp:include page="../common/FormError.jsp"></dsp:include></td>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;Benutzer-Standardvorgaben bearbeiten</td></tr></table>
        </td>
      </tr>
      ...
      <tr><td colspan=2><dsp:img src="../images/d.gif" vspace="0"/></td></tr>
      <tr>
        <td colspan=2><span class=small>Standardvorgaben für diesen Benutzer wählen.</span></td>
      </tr>
      <tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/user_edit_defaults.jsp#2 $$Change: 651448 $--%>
