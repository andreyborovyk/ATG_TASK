...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Benutzer"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr valign=top> 
           ...
           <dsp:oparam name="outputEnd">
            <dsp:droplet name="IsEmpty">
             ...
             <dsp:oparam name="false"><BR>
               <dsp:a href="users.jsp">  Nächste 10<dsp:param name="startIndex" param="nextStart"/></dsp:a> 
             </dsp:oparam>
            </dsp:droplet>
          </dsp:oparam>        
         </dsp:droplet>
    ...
    <dsp:oparam name="empty">
      Es gibt keine Benutzer für dieses Unternehmen
    </dsp:oparam>
	</dsp:droplet>
      </td>      
      </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/admin/users.jsp#2 $$Change: 651448 $--%>
