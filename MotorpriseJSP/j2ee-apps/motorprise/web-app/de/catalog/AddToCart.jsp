  ...
  <dsp:droplet name="/atg/dynamo/droplet/ForEach">
    ...
    <dsp:oparam name="output">
	 <table border=0 cellpadding=3 width=100%>
      ...
      <dsp:input bean="CartModifierFormHandler.quantity" size="4" type="text" value="1"/>&nbsp;&nbsp;<br>
      <dsp:input bean="CartModifierFormHandler.addItemToOrder" type="submit" value="Zur Bestellung hinzufügen"/>
      <br>
	  </td>
	  </tr>
	</table>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/catalog/AddToCart.jsp#2 $$Change: 651448 $--%>
