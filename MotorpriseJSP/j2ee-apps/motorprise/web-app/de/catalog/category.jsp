      ...
      <table border=0 cellpadding=4 width=100%>
        ...
        <tr>
          <td colspan=2>&nbsp;<span class="categoryhead">
            <dsp:valueof param="element.itemDisplayName">Kein Name</dsp:valueof></span></td>
        </tr>
        <tr>
      <td>
		...
		<dsp:a page="<%=urlStr%>">
          ...
          <dsp:oparam name="empty">
            <tr>
              <td width=3></td>
              <td>Keine Unterkategorien gefunden.</td>
            </tr>
          </dsp:oparam>
        </dsp:droplet> 
            </table>         
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/catalog/category.jsp#2 $$Change: 651448 $--%>
