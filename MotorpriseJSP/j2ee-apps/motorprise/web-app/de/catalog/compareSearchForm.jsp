...
<dsp:droplet name="IsEmpty">
  ...
  <dsp:oparam name="true"><b>Produkte für den Vergleich suchen</b></dsp:oparam>
  <dsp:oparam name="false"><b>Weitere Produkte für den Vergleich suchen</b></dsp:oparam>
</dsp:droplet>
...
<table border=0 cellpadding=8 cellspacing=0>
  <tr>
    <td align=right>Suche in Kategorie</td>
    <td>
  ...
  <tr>
    <td></td>
    <td><dsp:input bean="SearchCompare.search" type="submit" value="Suche"/></td>
  </tr>

</table>
</dsp:form>
</dsp:page>
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/catalog/compareSearchForm.jsp#2 $$Change: 651448 $--%>
