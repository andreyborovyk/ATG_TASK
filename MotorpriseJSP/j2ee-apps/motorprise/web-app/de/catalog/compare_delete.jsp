...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB"> 
    ...
    <dsp:a href="compare.jsp"><span class="small">Produktvergleiche</dsp:a> &gt;</span> 
    <span class="small">Vergleichsliste bearbeiten</span></td>
  </tr>
  ...
  <tr valign=top>
	...
	<dsp:oparam name="outputStart">
	  <b>Positionen aus der Vergleichsliste entfernen</b>
	  <blockquote>
	</dsp:oparam>
	...
	<dsp:oparam name="outputEnd">
	  ...
	  <dsp:input bean="ProductListHandler.clearList" type="submit" value="Alle entfernen"/> &nbsp;
	  <dsp:input bean="ProductListHandler.removeProductSuccessURL" type="hidden" value="compare.jsp"/>
	  <dsp:input bean="ProductListHandler.removeEntries" type="submit" value="Ausgewählte Positionen entfernen"/>
	</dsp:oparam>
      </dsp:droplet>
      </dsp:form></td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/catalog/compare_delete.jsp#2 $$Change: 651448 $--%>
