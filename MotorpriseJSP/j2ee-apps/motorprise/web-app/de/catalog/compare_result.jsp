...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB"> 
    ...
    <span class="small">&nbsp; Produktkatalog</dsp:a> &gt;</span>
  ...
  <tr valign=top>
    ...
    <table border=0 cellpadding=4 width=100%>
	  ...
	  <dsp:oparam name="empty">
	    Ihre Vergleichsliste enthält keine Positionen.
	  </dsp:oparam>
	  ...
	  */%>
	  ...
	  <dsp:oparam name="outputStart">
	    <table border=0 cellpadding=4 cellspacing=1 width=100%>
            <tr> 
              <td colspan=4><span class=help>Sie können die Ergebnisse sortieren, indem Sie auf die Spaltenköpfe klicken.
              </span></td>
            </tr>
	    <tr bgcolor="#66666">      
	      ...
	      */%>
		  ...
		  <dsp:oparam name="output">
		    <dsp:droplet name="Switch">
		      ...
		      <dsp:oparam name="price"><dsp:valueof symbol="&euro;" converter="euro" locale="Profile.priceList.locale" param="propertyValue"/><nobr></dsp:oparam>
		      <dsp:oparam name="default"><dsp:valueof valueishtml="<%=true%>" param="propertyValue"/></dsp:oparam>
		    </dsp:droplet>
		  </dsp:oparam>
		</dsp:droplet></td>
	      </dsp:oparam>
	  ...
	  <dsp:oparam name="outputEnd">
	    ...
	    <br>
	    <dsp:a href="compare_delete.jsp"><span class="smallb">Vergleichsliste bearbeiten</span></dsp:a>
	  </dsp:oparam>
	</dsp:droplet></td>
      </tr>
    </table>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/catalog/compare_result.jsp#2 $$Change: 651448 $--%>
