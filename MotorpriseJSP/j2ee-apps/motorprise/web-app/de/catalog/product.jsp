...
<dsp:droplet name="IsEmpty">
  ...
  <dsp:oparam name="true">
    <span class=error>
      Zum Anzeigen dieser Seite ist eine gültige Produktkennung erforderlich.
      <p>
      <dsp:a href="../home.jsp">Produktkatalog </dsp:a>
    </span>
  </dsp:oparam>
</dsp:droplet>
      ...
      <dsp:param name="pagetitle" value="<%=page_title%>"/>
          ...
          <td valign="top" colspan=2>                  
            ...
            <tr>
              <td valign="top" width=45%>
                ...
                <tr>
                  <td>
                    ...
                    <dsp:valueof param="element.displayName">Kein Name</dsp:valueof></span>
                    <br>
		        ...
		        <dsp:getvalueof id="imageURL" param="element.largeImage.url" idtype="java.lang.String">
                        <dsp:img hspace="70" alt="Produktabbildung" src="<%=imageURL%>"/>
			</dsp:getvalueof>
                      </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <br>                             
                    <span class=smallb>Produktbeschreibung</span><br>
                    <span class=small><dsp:valueof param="element.longDescription">Keine Beschreibung</dsp:valueof>
                   </span>
                  </td>
                </tr>
                </table>
              ...
              <!-- display order information -->
                ...
                <tr>
                  <td bgcolor="#999999">
                    ...
                    <tr><td><span class=smallbw>&nbsp;Zur Bestellung hinzufügen</span></td></tr>
                    </table>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td bgcolor="#999999">
                    <table border=0 cellpadding=1 width=100%>
                      <tr><td><span class=smallbw>&nbsp;Einkaufslisten</span></td></tr>
                    </table>
                  </td>
                </tr>
                <dsp:droplet name="IsEmpty">
              ...
              <dsp:param name="noCrumbs" value="false"/>Neue Einkaufsliste erstellen</dsp:a></span>
                      </td>
                    </tr>
                ...
                <tr>
                  <td bgcolor="#999999">
                    <table border=0 cellpadding=1 width=100%>
                    <tr><td><span class=smallbw>&nbsp;Produktvergleiche</span></td></tr>
                    </table>
                  </td>
                </tr>
                <tr><td><dsp:img src="../images/d.gif" vspace="1"/></td></tr>
                      ...
                      <tr>
                        ...
                        <dsp:droplet name="ProductListContains">
                          ...
                          <dsp:oparam name="true">
                            ...
                            <dsp:input bean="ProductListHandler.removeProduct" type="submit" value="Aus der Liste entfernen"/>
                          </dsp:oparam>
                          <dsp:oparam name="false">
                            <dsp:input bean="ProductListHandler.productID" paramvalue="productID" type="hidden"/>
                            <dsp:input bean="ProductListHandler.addProduct" type="submit" value="Zur Vergleichsliste hinzufügen"/>
                           </dsp:oparam>
                         </dsp:droplet> 
                      </td>
                    </tr>            
<!--check to see if there are items in comparison list-->
                    <dsp:droplet name="IsEmpty">
                      ...
                      <dsp:oparam name="false">
                    <tr>
                      <td><span class=smallb><dsp:a href="compare.jsp">Vergleichsliste anzeigen</dsp:a></td>
                    </tr>
                      </dsp:oparam>
                      </dsp:droplet>
                      </dsp:form>
                ...
                <dsp:droplet name="/atg/commerce/catalog/ForEachItemInCatalog">
                  ...
                  <dsp:oparam name="outputStart">
                    <tr>
                      <td bgcolor="#999999">
                      <table border=0 cellpadding=1 width=100%>
                        <tr><td><span class=smallbw>&nbsp;Verwandte Positionen</span></td></tr>
                      </table>
                      </td>
                    </tr>
                    <tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/catalog/product.jsp#2 $$Change: 651448 $--%>
