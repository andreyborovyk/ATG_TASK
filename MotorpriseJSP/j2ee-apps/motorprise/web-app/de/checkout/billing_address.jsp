...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=3 height=18><span class=small>
     ...
     <dsp:a href="billing.jsp">Rechnung</dsp:a> &gt; Rechnungsanschrift &nbsp;</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <table border=0 cellpadding=4 width=90%>
      ...
      <tr>
        <td colspan=2><span class="big">Rechnungsanschrift</span></td>
      </tr>
      <tr>
      <tr><td><dsp:img src="../images/d.gif"/></td></tr>
    
      <tr valign="top">
        <td align="right" width=25%><span class=smallb>Rechnungsanschrift auswählen</span></td>
        <td>
          ...
          <dsp:oparam name="output">
            <dsp:droplet name="Switch">
              ...
              <dsp:droplet name="IsEmpty">
                ...
                <td><dsp:input bean="PaymentAddressFormHandler.addressId" paramvalue="key" type="radio" checked="<%=false%>"/></td>
              </dsp:oparam>
              </dsp:droplet>
              </dsp:oparam>
            </dsp:droplet>
            <td><dsp:getvalueof id="pval0" param="element"><dsp:include page="../common/DisplayAddress.jsp"><dsp:param name="address" value="<%=pval0%>"/></dsp:include></dsp:getvalueof>
            </td>
          </dsp:oparam>
        </dsp:droplet>
      ...
      <tr>
        ...
        <dsp:input bean="PaymentAddressFormHandler.setAddress" type="submit" value="Weiter"/>
       </td>
     </tr>
   </table>
   </dsp:form>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/checkout/billing_address.jsp#2 $$Change: 651448 $--%>
