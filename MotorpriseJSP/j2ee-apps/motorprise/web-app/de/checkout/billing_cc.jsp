              ...
              <dsp:droplet name="Switch">
                ...
                <dsp:oparam name="2">
                  <tr valign=top>
                    ...
                    <dsp:a href="payment_methods.jsp?link=split_payment_order.jsp">Bestellung nach Euro-Betrag teilen</dsp:a><br>
                    <dsp:a href="payment_methods.jsp?link=split_payment.jsp">Bestellung nach Einzelposten teilen</dsp:a><br>
                    </span>
                    </td>
                  </tr>
                </dsp:oparam>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/checkout/billing_cc.jsp#2 $$Change: 651448 $--%>
