  ...
  <tr valign=top>
    ...
    <td valign="top" width=545>
      ...
      <table border=0 cellpadding=4 width=90%>
        ...
        <tr>
            <td><span class="big">Aktuelle Bestellung</span>
        ...
        <dsp:droplet name="Switch">
          ...
          <dsp:oparam name="0">
            Ihre aktuelle Bestellung enthält keine Positionen.
          </dsp:oparam>
          <dsp:oparam name="default">
            <dsp:form action="../user/save_order.jsp" method="post">
              <table border=0 cellpadding=4 cellspacing=1 width=100%>
                <tr bgcolor="#666666">
                  ...
                  <td colspan=1><span class=smallbw>Menge</span></td>
                  <td align=center colspan=1><span class=smallbw>Summe</span></td>
                  <td align=center><b><span class=smallbw>Entfernen</span><b></td>
                </tr>
		      ...
		      <%-- Display "remove" checkbox column --%>
                ...
                <dsp:droplet name="Compare">
                  ...
                  <dsp:oparam name="equal">
                   <tr>
                      <td colspan=5>&nbsp;</td>
                      <td valign=top>Zwischensumme: </td>
                      <td align=right>
                       <b>
              ...
              <%-- Update Order button: --%>
              <dsp:input bean="CartModifierFormHandler.setOrderByCommerceId" type="submit" value="Aktualisieren"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/checkout/cart.jsp#2 $$Change: 651448 $--%>
