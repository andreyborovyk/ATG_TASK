...
<tr valign=top>
  ...
  <table width=100% cellpadding=3 cellspacing=0 border=0>
    <tr>
      <td class=box-top>&nbsp;Versandinfo</td>
    </tr>
</table>
</td>
</tr>
    ...
    <dsp:droplet name="Switch">
      ...
      <dsp:oparam name="default">
        ...
        <tr valign=top>
          <td align=right><span class=smallb>Versandart</b></td>
        ...
        <tr valign=top>
              ...
              <table border=0 cellpadding=0 cellspacing=5 width=100%>
                <tr valign=bottom>
                  ...
                  <td align=right><span class=smallb>Summe</span></td>
                </tr>
                <tr>
...
<dsp:getvalueof id="pval0" param="CiRel.amountByAverage"><dsp:include page="../common/DisplayCurrencyType.jsp"><dsp:param name="currency" value="<%=pval0%>"/></dsp:include></dsp:getvalueof>
          ...
          <tr valign=top>
            <td colspan=3 align=right>Zwischensumme</td>
            <td align=right>
          ...
          <tr valign=top>
            <td colspan=3 align=right>Versand</td>
            <td align=right>
          ...
          <tr valign=top>
            <td colspan=3 align=right>Umsatzsteuer</td>
            <td align=right>
            <dsp:getvalueof id="pval0" param="order.priceInfo.tax"><dsp:include page="../common/DisplayCurrencyType.jsp"><dsp:param name="currency" value="<%=pval0%>"/></dsp:include></dsp:getvalueof>
              ...
              <dsp:droplet name="Compare">
                ...
                <dsp:oparam name="default">
                  <tr valign=top>
                    <td colspan=3 align=right>Skonto</td>
                    <td align=right>
          ...
          <tr valign=top>
            <td colspan=3 align=right><span class=smallb>Summe</span></td>
            <td align=right>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/checkout/displaySingleShipping.jsp#2 $$Change: 651448 $--%>
