...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=3 height=18><span class=small>
       &nbsp; <dsp:a href="cart.jsp">Aktuelle Bestellung</dsp:a> &gt; Versand &nbsp;</span>
    </td>
  </tr>
  <tr>
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        <td colspan=2><span class=big>Versand </span>
        <dsp:include page="../common/FormError.jsp"></dsp:include></td>
      </tr>
      <tr><td><dsp:img src="../images/d.gif"/></td></tr>
      <tr valign=top>
        <td align=right width=25%><span class=smallb>Versandanschrift</span></td>
        <td>
        ...
        <dsp:oparam name="false">
          <p><span class=smallb><dsp:a href="shipping_address.jsp">Zusätzliche Versandanschrift</dsp:a></span>
      ...
      <tr>
        ...
        <td>
          <dsp:droplet name="IsEmpty">
            <dsp:param bean="Profile.shippingAddrs" name="value"/>
            <dsp:oparam name="false">
              <span class=smallb><dsp:a href="ship_to_multiple.jsp?init=true">Versand an mehrere Adressen</dsp:a></span>
            </dsp:oparam>
          </dsp:droplet>
        </td>
      </tr>
      ...
      <tr>
        ...
        <dsp:droplet name="IsNull">
          ...
          <dsp:oparam name="false">
            <td align=right><span class=smallb>Versandart</span></td>
      ...
      <tr>
        ...
        <dsp:input bean="ShippingGroupFormHandler.applyShippingGroups" type="submit" value="Weiter"/></td>
    </tr>
    </table>
    </dsp:form>
    </td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/checkout/shipping.jsp#2 $$Change: 651448 $--%>
