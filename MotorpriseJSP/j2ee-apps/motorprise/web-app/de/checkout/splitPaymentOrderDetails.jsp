      ...
      <dsp:oparam name="output">
		...
		<dsp:include page="../common/DisplayCurrencyType.jsp">
		  <dsp:param name="currency" param="order.priceInfo.total"/>
                ...
                <span class=small>Geben Sie den Betrag ein, den Sie einer anderen Zahlungsweise zuordnen möchten und wählen Sie die neue Methode. Für den verbleibenden Betrag gilt weiterhin die Standard-Zahlungsweise. <P>Sie müssen die Änderungen speichern, bevor Sie auf "Weiter" klicken.</span></td>
              </tr>
              <tr valign=top>
                <td>
                <table border=0 cellpadding=4 cellspacing=1>
                  ...
                  <tr valign=bottom bgcolor="#666666">
                    ...
                    <td colspan=3><span class=smallbw>Änderungen speichern</span></td>
