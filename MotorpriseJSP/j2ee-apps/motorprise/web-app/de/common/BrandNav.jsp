                ...
                <table border="0" cellpadding="3" cellspacing="0" width="100%" height="25">
                  <tr>
                    <td bgcolor="#FF9933" align="center">
                      ...
                      <dsp:valueof bean="Profile.lastName"/> ist angemeldet</b> |
                      <b>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" height="74">
              <tr>
                ...
                <table border="0" cellpadding="7" cellspacing="0" width="100%" height="36">
                  <tr>
                    ...
                    <b><font color="#000000">Im Motorprise-Katalog blättern</font></b></dsp:a></td>
                  </tr>
                </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <table border="0" cellpadding="7" cellspacing="0" width="100%" height="37">
                  <tr>
                    <td bgcolor="#FF9900" align="center"><dsp:a href="../../"><b><font color="#FFFFFF">Kundenanmeldung</font></b></dsp:a></td>
                  </tr>
                </table>
                </td>
              </tr>
                  ...
                  <dsp:oparam name="false">
                      ...
                      <dsp:oparam name="true">
                        <dsp:droplet name="Switch">
                          ...
                          <dsp:oparam name="admin">
                            ...
                            <b><font color="#FDD30E" size=-1>Unternehmensverwaltung</font></b></dsp:a></td>
                          </dsp:oparam>
                          <dsp:oparam name="default">
                            <td align="center"><dsp:a href="../admin/business_units.jsp">
                            <b><font color="#FFFFFF" size=-1>Unternehmensverwaltung</font></b></dsp:a></td>
                          </dsp:oparam>
                        </dsp:droplet>
                      </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <dsp:droplet name="Switch">
                      ...
                      <dsp:oparam name="product_catalog">
                        <td align="center"><dsp:a href="../home.jsp"><b><font color="#FDD30E" size=-1>Produktkatalog</font></b></dsp:a></td>
                      </dsp:oparam>
                      <dsp:oparam name="default">
                        <td align="center"><dsp:a href="../home.jsp">
                        <b><font color="#FFFFFF" size=-1>Produktkatalog</font></b></dsp:a></td>
                      </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <dsp:droplet name="Switch">
                      ...
                      <dsp:oparam name="my_account">
                        ...
                        <b><font color="#FDD30E" size=-1>Mein Konto</font></b></dsp:a></td>
                      </dsp:oparam>
                      <dsp:oparam name="default">
                        <td align="center"><dsp:a href="../user/my_account.jsp">
                        <b><font color="#FFFFFF" size=-1>Mein Konto</font></b></dsp:a></td>
                      </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <dsp:droplet name="Switch">
                      ...
                      <dsp:oparam name="current_order">
                        ...
                        <b><font color="#FDD30E" size=-1>Aktuelle Bestellung</font></b></dsp:a></td>
                      </dsp:oparam>
                      <dsp:oparam name="default">
                        <td align="center"><dsp:a href="../checkout/cart.jsp">
                        <b><font color="#FFFFFF" size=-1>Aktuelle Bestellung</font></b></dsp:a></td>
                      </dsp:oparam>
                    </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/common/BrandNav.jsp#2 $$Change: 651448 $--%>
