...
<table border=0 cellspacing=0 cellpadding=0 width="100%">
  ...
  <tr>
    ...
    <dsp:droplet name="/atg/dynamo/droplet/ForEach">
      ...
      <dsp:oparam name="empty">
        <p>Keine Stammkategorien gefunden
      </dsp:oparam>
    </dsp:droplet>
    </td>
  </tr>
  ...
  <tr bgcolor="#F7D774">
    <td colspan=2><dsp:img src="../images/d.gif" vspace="1"/><br>&nbsp;
        &nbsp;<dsp:a href="../catalog/compare.jsp"><b><font size=-1 color="#555555">Produktvergleiche</font></b></dsp:a><br>
        <dsp:img src="../images/d.gif" vspace="1"/><br></td>
  </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/common/CatalogNav.jsp#2 $$Change: 651448 $--%>
