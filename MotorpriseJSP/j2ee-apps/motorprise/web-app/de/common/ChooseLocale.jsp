...
<dsp:form action="<%=thisPage%>" method="POST">
  ...
  <dsp:input bean="ProfileFormHandler.update" type="submit" value="Sprache ändern"/>
</dsp:form>
</dsp:getvalueof>
</dsp:page>
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/common/ChooseLocale.jsp#2 $$Change: 651448 $--%>
