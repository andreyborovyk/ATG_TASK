      ...
      <dsp:droplet name="ErrorMessageForEach">
        ...
        <dsp:droplet name="Switch">
          ...
          <dsp:oparam name="PONumber">
            Bitte geben Sie eine Auftrags- oder Anforderungsnummer ein und fahren Sie fort.
          </dsp:oparam>
...
<dsp:droplet name="/atg/dynamo/droplet/ForEach">
  ...
  <dsp:oparam name="output">
	...
	<dsp:droplet name="Switch">
	  ...
	  <dsp:oparam name="default">
	    Benutzer <dsp:valueof param="count"/> 
...
<dsp:droplet name="Switch">
  ...
  <dsp:oparam name="true">
    ...
    <dsp:droplet name="Switch">
      <dsp:param name="value" bean="MultiUserAddFormHandler.count"/>
      <dsp:oparam name="1"></dsp:oparam>
      <dsp:oparam name="default">Häufige Fehler:</dsp:oparam>
    </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/common/FormError.jsp#2 $$Change: 651448 $--%>
