          ...
          <dsp:oparam name="false">                      
		    ...
		    <dsp:getvalueof id="urlStr" idtype="java.lang.String" param="crumb.template.url">
                    <dsp:a page="<%=urlStr%>">
                      ...
                      <dsp:valueof param="crumb.displayName">Kein Name</dsp:valueof>
		    </dsp:a>                    
		    </dsp:getvalueof>
                  </dsp:oparam>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/common/breadcrumbs.jsp#2 $$Change: 651448 $--%>
