    ...
    <dsp:oparam name="empty">
      <dsp:droplet name="Switch">
        ...
        <dsp:oparam name="true">
          <b>Es wurden keine Produkte gefunden, die Ihre Suchkriterien erfüllen</b>
        </dsp:oparam>
      </dsp:droplet>
    </dsp:oparam>
</dsp:droplet>
</dsp:page>
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/search/AdvSearchResults.jsp#2 $$Change: 651448 $--%>
