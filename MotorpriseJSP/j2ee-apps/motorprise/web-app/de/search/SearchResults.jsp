      ...
      <dsp:oparam name="category">
          ...
          <dsp:oparam name="default">
            ...
            <dsp:droplet name="ForEach">
              ...
              <dsp:oparam name="outputStart">
                <b>Die folgenden Kategorien erfüllen Ihre Suchkriterien</b>
                <p>
              </dsp:oparam>
              <dsp:oparam name="output">
		...
		<dsp:getvalueof id="urlStr" idtype="java.lang.String" param="Category.template.url">
                <dsp:a page="<%=urlStr%>">
                  ...
                  <dsp:valueof param="Category.displayName">Kein Name</dsp:valueof>
		</dsp:a>
		</dsp:getvalueof>
                <br>
              </dsp:oparam>
              <dsp:oparam name="empty">
                <b>Es gibt keine Kategorien, auf die Ihre Suchabfrage zutrifft</b>
                <p>
              </dsp:oparam>
            </dsp:droplet>          
          </dsp:oparam>
          ...
          <dsp:oparam name="unset">
            Es wurden keine Kategorien gefunden, die Ihrer Suchabfrage entsprechen
          </dsp:oparam>
      ...
      <dsp:oparam name="product">
		...
		<dsp:getvalueof id="urlStr" idtype="java.lang.String" param="Product.template.url">
                <dsp:a page="<%=urlStr%>">
                  ...
                  <dsp:valueof param="Product.displayName">Kein Name</dsp:valueof>&nbsp;-&nbsp;<dsp:valueof param="Product.description"/>
		</dsp:a> 
		</dsp:getvalueof>
                <br>
              </dsp:oparam>
          ...
          <dsp:oparam name="unset">
            Es wurden keine Produkte gefunden, die Ihrer Suchabfrage entsprechen<p>
          </dsp:oparam>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/search/SearchResults.jsp#2 $$Change: 651448 $--%>
