  ...
  <tr valign=top> 
    ...
    <td valign="top" width=745> 
      <table border=0 cellpadding=4 width=80%>
        ...
        <tr valign=top>
          <td colspan=2><span class=big>Suche</span></td>
        </tr>
                     ...
                     <dsp:droplet name="Switch">
                       ...
                       <dsp:getvalueof id="countParam" idtype="Integer" param="count">
                         <dsp:oparam name="<%=countParam.toString()%>">
                           <dsp:a href="advanced_search.jsp" bean="AdvProductSearch.currentResultPageNum" paramvalue="index">&lt;&lt; Vorherige</dsp:a> &nbsp;
                         </dsp:oparam>
                       </dsp:getvalueof>
                     </dsp:droplet>
                   </dsp:oparam>
                     ...
                     <dsp:droplet name="Switch">
                       ...
                       <dsp:getvalueof id="indexParam" idtype="Integer" param="index">
                         <dsp:oparam name="<%=indexParam.toString()%>">
                           ...
                           <dsp:a href="advanced_search.jsp" bean="AdvProductSearch.currentResultPageNum" paramvalue="count">Nächste &gt;&gt;</dsp:a>
                         </dsp:oparam>
                       </dsp:getvalueof>
                     </dsp:droplet>
                   </dsp:oparam>
          ...
          <table width=100% bgcolor="#FFCC66" border=0 cellpadding=0 cellspacing=0>
            <tr bgcolor="#666666">
              ...
              <table cellpadding=3 cellspacing=0 border=0>
                <tr><td class=box-top>&nbsp;Erweiterte Produktsuche</td></tr>
              </table>
              </td>
            </tr>
                ...
                <tr valign=top>
                  <td width=50%>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="4" bgcolor="#FFCC66">
                      ...
                      <tr>
                        <td align="right"><span class=smallb>Kategorie</span></td>
                        <td>        
                        <dsp:select bean="AdvProductSearch.hierarchicalCategoryId">
                          <dsp:option value=""/>-- Alle Kategorien --
                      ...
                      <tr>
                        <td align="right">&nbsp;<span class=smallb>Hersteller</span></td>
                        <td>
                        <dsp:select bean="AdvProductSearch.propertyValues.manufacturer">
                          <dsp:option value=""/>-- Beliebig --
                          <dsp:droplet name="RepositoryValues">
...
<%--                                    <dsp:option value="<%=(String) elem.getPropertyValue("displayName")%>"/> --%>
                      ...
                      <tr>
                        ...
                        <dsp:input bean="AdvProductSearch.search" type="submit" value="Suche"/>
                        </td>
                      </tr>
                      <tr>
                        <td colspan=2>&nbsp;</td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/search/advanced_search.jsp#2 $$Change: 651448 $--%>
