...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Erweiterte Suche"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
 ...
 <dsp:droplet name="Switch">
        ...
        <dsp:oparam name="true"><dsp:a href="../home.jsp">Produktkatalog</dsp:a> &gt; Erweiterte Suche</dsp:oparam>
  ...
  <tr valign=top> 
    ...
    <td valign="top" width=745> 
      <table border=0 cellpadding=4 width=80%>
        ...
        <tr valign=top>
          <td colspan=2><span class=big>Suche</span>
        ...
        <tr> 
          ...
          <dsp:droplet name="Compare">
            ...
            <dsp:oparam name="greaterthan">
              ...
              <b><dsp:valueof bean="PartNumberSearchFormHandler.startCount"/> - 
              <dsp:valueof bean="PartNumberSearchFormHandler.endIndex"/></b>
              von
                     ...
                     <dsp:droplet name="Switch">
                       ...
                       <dsp:getvalueof id="countParam" idtype="Integer" param="count">
                         <dsp:oparam name="<%=countParam.toString()%>">
                           <dsp:a href="part_number_search.jsp" bean="PartNumberSearchFormHandler.currentResultPageNum" paramvalue="index">&lt;&lt; Vorherige</dsp:a> &nbsp;
                         </dsp:oparam>
                       </dsp:getvalueof>
                     </dsp:droplet>
                   </dsp:oparam>
                     ...
                     <dsp:droplet name="Switch">
                       ...
                       <dsp:getvalueof id="indexParam" idtype="Integer" param="index">
                         <dsp:oparam name="<%=indexParam.toString()%>">
                           <dsp:a href="part_number_search.jsp" bean="PartNumberSearchFormHandler.currentResultPageNum" paramvalue="count">Nächste &gt;&gt;</dsp:a>
                         </dsp:oparam>
                       </dsp:getvalueof>
                     </dsp:droplet>
                   </dsp:oparam>
          ...
          <table width=100% bgcolor="#FFCC66" border=0 cellpadding=0 cellspacing=0>
            <tr bgcolor="#666666">
              ...
              <table cellpadding=3 cellspacing=0 border=0>
                <tr><td class=box-top>&nbsp;Suche nach Produktnummer</td></tr>
              </table>
              </td>
            </tr>
            <tr bgcolor="#666666">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="4" bgcolor="#FFCC66">
                  ...
                  <tr valign="top">
                     <td width="15%" align="right">
                      <span class="smallb">Produktnr.</span>
                     </td>
                     <td>
                       <dsp:input bean="PartNumberSearchFormHandler.searchInput" size="25" type="text"/>&nbsp;
                        <br> <span class="small">Mit dem Platzhalter <b>*</b> können Sie nach Bestandteilen von Produktnummern suchen.</span>
                      </td>
                   </tr>
                   <tr>
                     <td>&nbsp;</td>
                     <td>
                        ...
                        <dsp:input bean="PartNumberSearchFormHandler.search" type="submit" value="Suche"/>
                       </dsp:form></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td><span class=smallb><dsp:a href="simple_search.jsp">
                               ...
                               Einfache Suche verwenden</dsp:a></span>
                      </td>
                     </tr> 
                     <tr>
                      <td>&nbsp;</td>
                      <td><span class=smallb><dsp:a href="advanced_search.jsp">
                               <dsp:param name="noCrumbs" param="noCrumbs"/>
                               Erweiterte Suche verwenden</dsp:a></span>
                       </td>
                    <tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/search/part_number_search.jsp#2 $$Change: 651448 $--%>
