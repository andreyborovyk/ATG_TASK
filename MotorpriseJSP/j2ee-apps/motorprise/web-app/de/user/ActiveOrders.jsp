...
<b>Kürzlich erfolgte Bestellungen</b> 
...
<table border=0 cellspacing=0>
  ...
  <tr valign=top> 
    <td> &nbsp; <dsp:a href="orders_filled.jsp">Ausgeführte Bestellungen</dsp:a></td>
    <td> &nbsp; &nbsp; </td>
    <td>
      <dsp:droplet name="OrderLookup">
        <dsp:param bean="Profile.id" name="userId"/>
  ...
  <dsp:droplet name="Switch">
    ...
    <dsp:oparam name="true">
      <dsp:droplet name="HasFunction">
        ...
        <dsp:oparam name="true">
          <tr valign=top> 
            <td> &nbsp; <dsp:a href="orders_rejected.jsp">nicht bewilligte Bestellungen</dsp:a></td>
            <td> &nbsp; &nbsp; </td>
            <td>
            <dsp:droplet name="OrderLookup">
              <dsp:param bean="Profile.id" name="userId"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/user/ActiveOrders.jsp#2 $$Change: 651448 $--%>
