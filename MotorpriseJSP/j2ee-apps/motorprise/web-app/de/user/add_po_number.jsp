  ...
  <tr>
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;Auftragsnummern hinzufügen</td></tr></table>
        </td>
        ...
        <dsp:droplet name="OrderLookup">
          ...
          <dsp:oparam name="output">
            ...
            <tr> <td colspan=2><span class=categoryhead>Bestellnr. <dsp:valueof param="orderId"/></span></td>
            </tr>
            <tr> <td>
                ...
                <dsp:droplet name="Switch">
                  ...
                  <dsp:oparam name="default">
                    <dsp:form formid="paymentGroup" action="add_po_number.jsp">
                      ...
                      <tr valign=top>
                      <td align=right><span class=smallb>Auftragsnr. eingeben</span></td>
                      <td width=75%>
			...
			<core:createUrl id="this_page" url="add_po_number.jsp">
			  ...
			  <dsp:input type="hidden" bean="B2BOrderRepositoryFormHandler.updateErrorURL"   value="<%=this_page.getNewUrl()%>"/>
                        ...
                        <dsp:input bean="B2BOrderRepositoryFormHandler.update" type="submit" value="Speichern"/>
                      </td>
                      </tr>
                    </dsp:form>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/user/add_po_number.jsp#2 $$Change: 651448 $--%>
