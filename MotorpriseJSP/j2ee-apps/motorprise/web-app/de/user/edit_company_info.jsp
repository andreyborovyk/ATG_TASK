...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="my_account.jsp">Mein Konto</dsp:a> &gt; <dsp:a href="my_profile.jsp">Mein Profil</dsp:a> &gt; Firmeninfo bearbeiten</td>
  </tr>
  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=90%>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;Standard-Konteninformation bearbeiten</td></tr></table>
        </td>
      </tr>
      ...
      <tr>
        <td colspan=2><span class=small>Standardangaben aus Ihrer Firmeninfo wählen.
                      </span></td>
      </tr>
      ...
      <tr>
        ...
        <td>
            ...
            <dsp:input bean="B2BRepositoryFormHandler.update" type="submit" value="Gewählte Standardangaben speichern"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/user/edit_company_info.jsp#2 $$Change: 651448 $--%>
