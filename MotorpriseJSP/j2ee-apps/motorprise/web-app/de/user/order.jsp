    ...
    <table border=0 cellpadding=0 cellspacing=0 width=800>
      ...
      <dsp:droplet name="Switch">
        ...
        <dsp:oparam name="closed">
          <tr bgcolor="#DBDBDB" > 
            ...
            <dsp:a href="orders_filled.jsp">Ausgeführte Bestellungen</dsp:a> &gt;
            Bestellnr.<dsp:valueof  param="orderId"/></td>
          </tr>
        </dsp:oparam>
        <dsp:oparam name="default">
          <tr bgcolor="#DBDBDB" > 
            <td colspan=2 height=18> &nbsp; <span class=small>
            <dsp:a href="my_account.jsp">Mein Konto</dsp:a> &gt;
            <dsp:a href="orders_open.jsp">Offene Bestellungen</dsp:a> &gt;
            Bestellnr.<dsp:valueof  param="orderId"/></td>
          </tr>
        </dsp:oparam>
      </dsp:droplet>
      ...
      <tr>
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <tr valign=top>
            <td colspan=3><b>Bestellnr. <dsp:valueof param="order.id"/></b></td>
          </tr>
          ...
          <tr valign=top>
            ...
            <tr><td class=box-top>&nbsp;Bestellstatus</td></tr></table>
            </td>
          </tr>
          ...
          <tr>
            <td colspan=2>
            <!-- general order info -->
            Bestellung aufgegeben <dsp:valueof date="d MMMMM, yyyy" param="order.submittedDate"/><br>
            <dsp:droplet name="Switch">
              <dsp:param name="value" param="order.stateAsUserResource"/>
              <dsp:oparam name="NO_PENDING_ACTION">
                Bestellstatus: VERSANDT
              </dsp:oparam>
              <dsp:oparam name="FAILED_APPROVAL">
                Bestellstatus: <dsp:valueof param="order.stateAsUserResource"/>
              </dsp:oparam>
              <dsp:oparam name="default">
                Bestellstatus: <dsp:valueof param="order.stateAsUserResource"/><p>
                <p>
                <dsp:a href="cancel_order.jsp"><dsp:param name="orderId" param="orderId"/>Bestellung stornieren</dsp:a></td>
              </dsp:oparam>
            </dsp:droplet>
              ...
              <dsp:droplet name="ForEach">
                ...
                <tr>
                  ...
                  <dsp:droplet name="PersonLookup">
                    ...
                    <dsp:oparam name="output">
                      Bestellungsprüfer: <dsp:valueof param="Person.firstName">Kein Vorname</dsp:valueof>
                      <dsp:valueof param="Person.lastName">Kein Nachname</dsp:valueof><br>
                    </dsp:oparam>
                  </dsp:droplet>          
                    Prüfermeldung 
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/user/order.jsp#2 $$Change: 651448 $--%>
