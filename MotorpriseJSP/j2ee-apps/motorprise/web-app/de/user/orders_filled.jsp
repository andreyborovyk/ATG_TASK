...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Ausgeführte Bestellungen"/></dsp:include>
  ...
  <tr valign="top"> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
        ...
        <tr><td class=box-top>&nbsp;Ausgeführte Bestellungen</td></tr></table></td>
      </tr>
      <tr><td colspan=2><img src="../images/d.gif" vspace=0></td></tr>
       <tr>
        <td>
          ...
          <dsp:droplet name="OrderLookup">
            ...
            <dsp:oparam name="empty">
              ...
              Sie haben keine ausgeführten Bestellungen.
            </dsp:oparam>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/user/orders_filled.jsp#2 $$Change: 651448 $--%>
