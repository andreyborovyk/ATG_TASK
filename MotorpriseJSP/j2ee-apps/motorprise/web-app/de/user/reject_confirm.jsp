  ...
  <tr valign=top> 
    ...
    <tr valign=top>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;Ablehnungsbestätigung</td></tr></table>
        </td>
      </tr>
     ...
     <tr>
      ...
      <tr>
       <td colspan=2>Die Bestellung wurde nicht bewilligt.</td>
       </tr>
        <dsp:droplet name="OrderLookup">
          ...
          <dsp:oparam name="output">
            ...
            <p><dsp:a href="approvals.jsp">Zurück zu Bewilligungen</dsp:a>
            </td>
            </tr>
          </dsp:oparam>
        </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/user/reject_confirm.jsp#2 $$Change: 651448 $--%>
