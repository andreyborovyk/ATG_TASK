...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Bestellung speichern"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    <td colspan=2 height=18> &nbsp; <span class=small>
     <dsp:a href="../checkout/cart.jsp">Aktuelle Bestellung</dsp:a> &gt;
     Bestellung speichern </span>
    </td>
  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
        <td><span class="big">Aktuelle Bestellung</span></td>
      </tr>
      <tr><td><img src="../images/d.gif"></td></tr>
      <tr>
        <td colspan=2><table width=100% cellpadding=3 cellspacing=0 border=0>
        <tr><td class=box-top>&nbsp;Aktuelle Bestellung speichern</td></tr></table></td>
      </tr>
    <tr>
      <td><b>Bestellnr.<dsp:valueof bean="ShoppingCart.current.id"/></b>
                  <dsp:form action="saved_orders.jsp">
                  Geben Sie einen Namen zur Identifikation der Bestellung ein:<p> 
                  <dsp:input bean="SaveOrderFormHandler.description" type="text"/> 
                  <dsp:input bean="SaveOrderFormHandler.saveOrder" type="submit" value="Bestellung speichern"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/user/save_order.jsp#2 $$Change: 651448 $--%>
