    ...
    <tr valign=top>
      ...
      <tr>
       <td>
        ...
        <tr><td class=box-top>&nbsp;Regelm‰ﬂige Bestellungen</td></tr></table>
        </td>
      </tr>
      ...
      <tr valign=top>
        ...
        <dsp:droplet name="RQLQueryForEach">
         ...
         <dsp:oparam name="empty">
          Sie haben keine regelm‰ﬂigen Bestellungen.
         </dsp:oparam>
        </dsp:droplet>
            ...
            <dsp:a href="scheduled_order_new.jsp" bean="ScheduledOrderFormHandler.repositoryId" beanvalue="/Constants.null">
              ...
              <span class=smallb>Neue regelm‰ﬂige Bestellung anlegen</span>
            </dsp:a>
        </td>
      </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/de/user/scheduled_orders.jsp#2 $$Change: 651448 $--%>
