...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Billing Addresses"/></dsp:include>
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
        ...
        <table width=100% cellpadding=3 cellspacing=0 border=0>
          <tr> 
            <td class=box-top>&nbsp;Billing Addresses</td>
          </tr>
        </table>
        </td>
      </tr>
            ...
            <dsp:droplet name="IsEmpty">
              ...
              <dsp:oparam name="false">
                ...
                <table width="100%" border="0">
                 ...
                 <tr>
                   <td><dsp:valueof param="key"/> 

                   <dsp:droplet name="/atg/dynamo/droplet/Compare">
                     <dsp:param name="obj1" param="billingAddress.repositoryId"/>
                     <dsp:param name="obj2" bean="Profile.currentOrganization.defaultBillingAddress.repositoryId"/>
                 ...
                 <tr>
                   <td><span class=smallb><dsp:a href="billing_address_edit.jsp">Edit
                   ...
                   <dsp:droplet name="/atg/dynamo/droplet/Compare">
                     ...
                     <dsp:oparam name="default">
                       | <span class=smallb>
                       <dsp:a href="billing_addr_delete.jsp">
                       <dsp:param name="billingId" param="billingAddress.id"/>
      ...
      <tr><td><br></td></tr>
      <tr>
        <td colspan="3"><dsp:a href="billing_create.jsp"><span class=smallb>Create new billing address</span></dsp:a></td>
        </tr>
     </table>
     </td>
   </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/billing_addresses.jsp#2 $$Change: 651448 $--%>
