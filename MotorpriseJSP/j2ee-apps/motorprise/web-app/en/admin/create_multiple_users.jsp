  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;Create Multiple Users</td></tr></table>
        </td>
      </tr>
      ...
      <tr>
        <td>Create <dsp:input bean="MultiUserAddFormHandler.count" maxlength="1" size="1" type="text" value=""/> users. 
        <p>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/create_multiple_users.jsp#2 $$Change: 651448 $--%>
