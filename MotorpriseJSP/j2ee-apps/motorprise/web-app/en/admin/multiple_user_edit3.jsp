...
<dsp:oparam name="true">
  ...
  <dsp:oparam name="true">
	...
	<core:createUrl id="errorPage" url="multiple_user_edit2.jsp">
	  <core:urlParam param="errorMessage" value="No attributes were selected"/>
      ...
      <tr>
	    ...
	    <%-- Assume all users are in the same organization and use the first user to find it. --%>
			...
			<dsp:valueof param="role.name">unnamed role</dsp:valueof><br>
              ...
              <dsp:droplet name="IsEmpty">
                ...
                <dsp:oparam name="false">
                  ...
                  <tr valign=right>
                    <td align=right valign=top><span class=smallb>Shipping Addresses</span></td>
                    <td>
                      ...
                      <dsp:droplet name="ForEach">
                        ...
                        <dsp:oparam name="output">
                             ...
                             <dsp:oparam name="output">
			                             ...
			                             <dsp:input bean="MultiUserUpdateFormHandler.value.paymentTypes.keysAndRepositoryIds" paramvalue="message" name="userPaymentTypes" type="checkbox"/>  <dsp:valueof param="key">unnamed payment method</dsp:valueof><br>
                             </dsp:oparam>
                             </dsp:droplet>
			  ...
			  <dsp:valueof param="costCenter.description"> unnamed cost center </dsp:valueof><br>
                        </dsp:oparam>
                        <dsp:oparam name="empty">
            ...
            <tr>
              ...
              <td><dsp:input bean="MultiUserUpdateFormHandler.update" type="submit" value="Change for selected users"/></td>
            </tr>
          </table>          
        </dsp:oparam>
      </dsp:droplet>    
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/multiple_user_edit3.jsp#2 $$Change: 651448 $--%>
