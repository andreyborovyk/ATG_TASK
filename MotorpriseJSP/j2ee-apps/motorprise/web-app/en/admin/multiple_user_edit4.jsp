...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr valign=top> 
    ...
    <dsp:oparam name="output">
      ...
      <tr>
        <td><b>The following attributes were set to the values listed</b>
        <blockquote>
        ...
        <dsp:oparam name="false">
         <tr valign=top>
        <td align=right><span class=smallb>Shipping address(es)</span></td>
        <td>          
        ...
        <dsp:oparam name="false">
        <tr valign=top>
        <td align=right><span class=smallb>Shipping method(s)</span></td>
        <td>
        ...
        <dsp:oparam name="false">  
        <tr valign=top>
        <td align=right><span class=smallb>Credit Card(s)</span></td>
        <td>
        <dsp:droplet name="ForEach">
      ...
      <tr valign=top>
        <td align=right>
          <span class=smallb>Purchase limit</span></td>
        <td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/multiple_user_edit4.jsp#2 $$Change: 651448 $--%>
