...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="company_admin.jsp">Company Admin</dsp:a> &gt; <dsp:a href="payment_edit.jsp">Payment Methods</dsp:a> &gt; <dsp:a href="payment_method_create.jsp">Create Payment</dsp:a> &gt; Select Billing Address
    </span> </td>
  </tr>
   ...
   <input name="nickName" type="hidden" value="<dsp:valueof param="nickName"/>">
     <input name="creditCardType" type="hidden" value="<dsp:valueof param="creditCardType"/>">
       <input name="firstName" type="hidden" value="<dsp:valueof param="firstName"/>">
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Select Billing Address</td>
                </tr>
              </table>
            </td>
          </tr>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td colspan="3" align="left"><input type="submit" name="submit1" value="Select"></td></tr>
              </table>
            </td>
          </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/payment_address_edit.jsp#2 $$Change: 651448 $--%>
