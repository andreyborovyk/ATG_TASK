...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="payment_method_create.jsp">Create Payment</dsp:a> &gt; Select Billing Address
    </span> </td>
  </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/payment_address_edit2.jsp#2 $$Change: 651448 $--%>
