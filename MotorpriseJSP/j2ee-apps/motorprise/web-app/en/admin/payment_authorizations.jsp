...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Authorize Payment Methods"/></dsp:include>
          ...
          <tr> 
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;Payment Authorizations</td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
            <td valign="top" colspan=2 height="92"> 
              <table border="0" cellpadding=4 width=100%>
                ...
                <tr>
                  <td width=25% align="right"><span class=smallb>Invoice authorization</span></td>
                  <td>
                  <% /*  check if inherited */ %>
                ...
                <tr>
                  <td width=25% align="right"><span class=smallb>Credit card Authorization</span></td>
                  <td>
                  <% /*  check if inherited */ %>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/payment_authorizations.jsp#2 $$Change: 651448 $--%>
