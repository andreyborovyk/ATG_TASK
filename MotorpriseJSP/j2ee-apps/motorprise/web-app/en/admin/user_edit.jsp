...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  Edit User Account"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        <td colspan=2><span class=big>Company Administration</span><br>
     ...
     <% /*<dsp:include page="../common/FormError.jsp" flush="true"></dsp:include> */ %></td>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;Edit Contact Information</td></tr></table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
              ...
              <dsp:oparam name="en_US">
                ...
                <dsp:option selected="<%=true%>" value="en_US"/> English
              ...
              <dsp:oparam name="de_DE">
                ...
                <dsp:option selected="<%=true%>" value="de_DE"/> German
                <dsp:option value="ja_JP"/> Japanese
              </dsp:oparam>

              <dsp:oparam name="ja_JP">
                <dsp:option value="ja_JP"/> English
                <dsp:option value="de_DE"/> German
                <dsp:option selected="<%=true%>" value="ja_JP"/> Japanese
              </dsp:oparam>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/user_edit.jsp#2 $$Change: 651448 $--%>
