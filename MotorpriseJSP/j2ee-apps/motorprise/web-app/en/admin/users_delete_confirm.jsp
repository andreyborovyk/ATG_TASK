...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr> 
        <td><b>Delete the following users?</b></td>
      </tr>
	  <tr>
        <td>
		...
		<dsp:oparam name="output">
            ...
            <br>
            <dsp:input bean="DeleteProfileFormHandler.delete" type="submit" value="Delete"/> &nbsp;
            <dsp:input bean="DeleteProfileFormHandler.cancel" type="submit" value="Cancel"/>
            </dsp:form>
         </td>      
      </tr>
    </table>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/admin/users_delete_confirm.jsp#2 $$Change: 651448 $--%>
