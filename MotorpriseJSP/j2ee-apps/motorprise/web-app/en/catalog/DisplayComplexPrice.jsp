...
<dsp:droplet name="Switch">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <dsp:droplet name="CurrencyConversionFormatter">
                          ...
                          <dsp:oparam name="output">
                            &nbsp;&nbsp;<span class=small><dsp:valueof valueishtml="<%=true%>" param="formattedCurrency">no price</dsp:valueof></span>
                          </dsp:oparam>
                        </dsp:droplet>
    ...
    <dsp:oparam name="tieredPrice">
       <tr>
        <td>&nbsp;</td>
        <td valign=top><span class=smallb>Tiered Price:</span></td>
        <td>&nbsp;</td>
        <td>
          <table border=0 cellspacing=0 cellpadding=0 width=100%>
            <dsp:droplet name="ComplexPriceDroplet">
                ...
                <dsp:droplet name="For">
                  ...
                  <dsp:oparam name="output">
                    <tr>
                      ...
                      <td><span class=small>
                          <dsp:valueof param="levelMaximums[param:index]">or more</dsp:valueof>
                      </span></td>
                      <td>
                        &nbsp;&nbsp;
                        <dsp:droplet name="CurrencyConversionFormatter">
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/catalog/DisplayComplexPrice.jsp#2 $$Change: 651448 $--%>
