  ...
  <dsp:oparam name="output">
    <table cellspacing="0" cellpadding="0" border="0">
      <tr>
        ...
        <td>&nbsp;</td>
        <td><span class=small><dsp:valueof param="element.manufacturer_part_number">No id</dsp:valueof></span>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td>&nbsp;</td>
        <td><span class=small><dsp:valueof param="product.manufacturer.displayName">Unknown</dsp:valueof>
  <td>&nbsp;</td>
      </tr>
        ...
        <dsp:oparam name="false">
          <tr>
            ...
            <dsp:droplet name="/atg/commerce/inventory/InventoryLookup">
              ...
              <dsp:oparam name="output">
                <td><span class=small><dsp:valueof param="inventoryInfo.availabilityStatusMsg">Unknown</dsp:valueof></span>
              </dsp:oparam>
            </dsp:droplet>
            <td>&nbsp;</td>
          </tr>
             ...
             <dsp:oparam name="Enterprise">
               <tr>
                 ...
                 <dsp:droplet name="/atg/commerce/inventory/InventoryLookup">
                   <dsp:param name="itemId" param="element.repositoryId"/>
                   <dsp:oparam name="output">
                     <td><span class=small><dsp:valueof param="inventoryInfo.stockLevel">Unknown</dsp:valueof></span>
                   </dsp:oparam>
                 </dsp:droplet>
                 <td>&nbsp;</td>
               </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/catalog/SKUProperties.jsp#2 $$Change: 651448 $--%>
