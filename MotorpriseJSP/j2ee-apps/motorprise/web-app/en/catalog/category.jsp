      ...
      <table border=0 cellpadding=4 width=100%>
        ...
        <tr>
          <td colspan=2>&nbsp;<span class="categoryhead">
            <dsp:valueof param="element.itemDisplayName">No name</dsp:valueof></span></td>
        </tr>
        <tr>
      <td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/catalog/category.jsp#2 $$Change: 651448 $--%>
