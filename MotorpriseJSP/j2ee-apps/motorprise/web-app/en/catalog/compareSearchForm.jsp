...
<dsp:droplet name="IsEmpty">
  ...
  <dsp:oparam name="true"><b>Search for products to compare</b></dsp:oparam>
  <dsp:oparam name="false"><b>Search for more products to compare</b></dsp:oparam>
</dsp:droplet>
...
<table border=0 cellpadding=8 cellspacing=0>
  ...
  <tr>
    <td></td>
    <td><dsp:input bean="SearchCompare.search" type="submit" value="Search"/></td>
  </tr>

</table>
</dsp:form>
</dsp:page>
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/catalog/compareSearchForm.jsp#2 $$Change: 651448 $--%>
