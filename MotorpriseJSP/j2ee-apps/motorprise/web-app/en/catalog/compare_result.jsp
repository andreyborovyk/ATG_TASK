...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB"> 
    ...
    <span class="small">&nbsp; Product Catalog</dsp:a> &gt;</span>
    <span class="small">Product Comparisons</span> </td>
  </tr>
	  ...
	  */%>
	  ...
	  <dsp:oparam name="outputStart">
	    <table border=0 cellpadding=4 cellspacing=1 width=100%>
            <tr> 
              <td colspan=4><span class=help>You can sort the results by clicking on the column headings.
              </span></td>
            </tr>
	    <tr bgcolor="#66666">      
	      ...
	      */%>
		  ...
		  <dsp:oparam name="output">
		    <dsp:droplet name="Switch">
		      ...
		      <dsp:oparam name="price"><dsp:valueof converter="currency" locale="Profile.priceList.locale" param="propertyValue"/></dsp:oparam>
	  ...
	  <dsp:oparam name="outputEnd">
	    ...
	    <br>
	    <dsp:a href="compare_delete.jsp"><span class="smallb">Edit Comparison List</span></dsp:a>
	  </dsp:oparam>
	</dsp:droplet></td>
      </tr>
    </table>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/catalog/compare_result.jsp#2 $$Change: 651448 $--%>
