...
<dsp:droplet name="/atg/commerce/catalog/CategoryLookup">  
  <dsp:oparam name="output">          
    ...
    <tr>
          ...
          <dsp:valueof param="element.itemDisplayName">No name</dsp:valueof></span>
              ...
              <dsp:droplet name="/atg/dynamo/droplet/ForEach">
                ...
                <dsp:oparam name="outputStart">
                  <tr valign="bottom">
                    ...
                    <td bgcolor="#666666" colspan=2><span class="smallbw">Part #</span></td>
                    <td bgcolor="#666666" colspan=2><span class="smallbw">Product</span></td>
                    <td bgcolor="#666666" colspan=2><span class="smallbw">Description</span></td>
          <td bgcolor="#666666" colspan=2><span class="smallbw">Mfr</span></td>
                  </tr>
                </dsp:oparam>
                <dsp:oparam name="output">
                  <tr valign="top">
		    ...
		    <dsp:a page="<%=urlStr%>">
		      ...
		      <dsp:valueof param="element.displayName">No name</dsp:valueof>
                    ...
                    <td>&nbsp;</td>
                    <td><dsp:valueof param="element.description">No description</dsp:valueof></td>
                    
                    <td>&nbsp;</td>
                    <td><dsp:valueof param="element.manufacturer.displayName">Unknown</dsp:valueof></td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/catalog/sub_category.jsp#2 $$Change: 651448 $--%>
