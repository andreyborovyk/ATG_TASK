              ...
              <dsp:droplet name="Switch">
                ...
                <dsp:oparam name="2">
                  <tr valign=top>
                    ...
                    <dsp:a href="payment_methods.jsp?link=split_payment_order.jsp">Split order by dollar amount</dsp:a><br>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/billing_cc.jsp#2 $$Change: 651448 $--%>
