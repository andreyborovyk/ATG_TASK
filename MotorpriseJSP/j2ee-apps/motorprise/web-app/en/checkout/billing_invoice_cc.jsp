        ...
        <table border=0 cellpadding=4 width=80%>
         ...
         <tr><td><dsp:img src="../images/d.gif"/></td></tr>
          ...
          <tr valign=top>
            ...
            <span class=help>Either a requisition number or a PO number is required for invoices.</span></td>
          </tr>
          ...
          <tr valign=top>
            ...
            <dsp:a href="payment_methods.jsp?link=split_payment.jsp&init=true">Split order by line items</dsp:a><br>
            </span>
            </td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/billing_invoice_cc.jsp#2 $$Change: 651448 $--%>
