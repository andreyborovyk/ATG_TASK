...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    <td colspan=2 height=18><span class=small>
       &nbsp; <dsp:a href="cart.jsp">Cart</dsp:a> &gt; Checkout &nbsp;</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <table border=0 cellpadding=4 cellspacing=0 width=80%>
      ...
      <tr>
            ...
            <tr valign=top>
              <td colspan=2>
                <table width=100% cellpadding=3 cellspacing=0 border=0>
                  <tr><td class=box-top>&nbsp;Cost Center Details</td></tr></table>
              </td>
            </tr>
            ...
            <tr>
              <td></td>
              <td><span class=smallb><dsp:a href="cost_centers_line_item.jsp?init=false">Edit cost center info</dsp:a></span><br> 
              <span class=smallb><dsp:a href="confirmation.jsp">Back to order confirmation</dsp:a></span><br>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/confirm_cc_details.jsp#2 $$Change: 651448 $--%>
