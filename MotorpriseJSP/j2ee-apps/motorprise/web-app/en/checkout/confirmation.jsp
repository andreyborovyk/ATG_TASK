    ...
    <dsp:oparam name="true">
      ...
      <tr bgcolor="#DBDBDB">
        <td colspan=3 height=18><span class=small>
          ...
          <dsp:a href="billing.jsp"> Billing</dsp:a> &gt; Confirmation &nbsp;</span>
        </td>
      </tr>
    </dsp:oparam>
    <dsp:oparam name="false">
     <tr bgcolor="#DBDBDB">
      ...
      <td colspan=3 height=18><span class=small>
        ...
        <dsp:a href="cost_centers.jsp">Cost Centers</dsp:a> &gt; Confirmation &nbsp;</span>
      </td>
    </tr>
  </dsp:oparam>
  </dsp:droplet>
    ...
    <table border=0 cellpadding=4 width=80%>
      <tr>
        ...
        <table border=0 cellpadding=4 width=100%>
          ...
          <tr>
            <td colspan=3><span class="big">Order Confirmation</span></td>
          </tr>
          <tr><td><dsp:img src="../images/d.gif" vspace="0"/></td></tr>
          ...
          <dsp:droplet name="/atg/projects/b2bstore/order/ItemsSplitbyType">
            ...
            <dsp:oparam name="true">
              <tr valign=top>
                <td></td>
                <td><span class=smallb><dsp:a href="confirm_cc_details.jsp">View cost center line item detail </dsp:a></span></td>
              </tr>
            </dsp:oparam>
          </dsp:droplet>
            ...
            <dsp:oparam name="outputStart">
              <dsp:droplet name="Switch">
                ...
                <dsp:oparam name="1">
                  <tr>
                    <td></td>
                    <td><span class=smallb><dsp:a href="shipping.jsp">Edit Shipping </dsp:a></span></td>
                  </tr>       
                </dsp:oparam>
                <dsp:oparam name="default">
                  <tr>
                    <td></td>
                    <td><span class=smallb><dsp:a href="ship_to_multiple.jsp">Edit Shipping </dsp:a></span></td>
                  </tr>       
                </dsp:oparam>
              </dsp:droplet>
            </dsp:oparam>
          ...
          <tr>
            ...
            <dsp:input bean="CommitOrderFormHandler.commitOrder" type="submit" value="Place order now"/>
            ...
            <dsp:input bean="CancelOrderFormHandler.cancelCurrentOrder" type="submit" value="Cancel order"/>
            ...
            <dsp:input submitvalue="" bean="ScheduledOrderFormHandler.repositoryId" type="submit" value="Create scheduled order"/> 
            </td>
          </tr>
          <tr>
            <td></td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/confirmation.jsp#2 $$Change: 651448 $--%>
