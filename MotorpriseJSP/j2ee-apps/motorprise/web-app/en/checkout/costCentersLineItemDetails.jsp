...
<table border=0 cellpadding=0 cellspacing=0>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <dsp:a href="cost_centers.jsp">Cost Centers</dsp:a> &gt; Split Cost Centers &nbsp;</span>
    </td>
  </tr>
  <tr bgcolor="#CCCCCC">
    ...
    <table border=0 cellpadding=6 cellspacing=0 width=800>
      ...
      <tr valign=top>
        ...
        <table border=0 cellpadding=4 cellspacing=1 width=80%>
          <tr>
            <td colspan=12><span class=small>Assign each line item to a cost center. You can also divide a line item between cost centers by entering the number of items to assign to the new cost center.
            </span></td>
          </tr>
          ...
          <tr valign=bottom bgcolor="#666666">
            ...
            <td colspan=1><span class=smallbw>Cost center</span></td>
                    ...
                    <dsp:oparam name="output">
                      ...
                      <tr valign=top>
                        ...
                        <td align=center>
                          ...
                          <dsp:input bean="CostCenterFormHandler.splitCostCenters" type="submit" value="Save"/>
                        </td>
                      </tr>
                      </dsp:form>
                      <%-- end line item --%>
          ...
          <dsp:droplet name="ForEach">
            ...
            <dsp:oparam name="output">
              ...
              <dsp:droplet name="Switch">
                ...
                <dsp:oparam name="default">
                  Shipping Group - <dsp:valueof param="count"/>
                </dsp:oparam>
              </dsp:droplet></td>
              <dsp:droplet name="ForEach">
                <dsp:param bean="CostCenterFormHandler.currentList" name="array"/>
...
<%--                                <dsp:oparam name="param:...element.costCenterName"> --%>
    ...
    <tr>
      <td></td>
      <td><span class=help>You must save changes individually before continuing.</span><p>
          ...
          <dsp:input bean="CostCenterFormHandler.applyCostCenters" type="submit" value="Continue"/>
        </dsp:form>
     </td>
   </tr>
 </table>
...
<%-- Version: $Change: 651448 $$DateTime: 2011/06/07 13:55:45 $--%>
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/costCentersLineItemDetails.jsp#2 $$Change: 651448 $--%>
