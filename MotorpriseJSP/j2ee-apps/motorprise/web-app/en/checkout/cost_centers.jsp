...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=3 height=18><span class=small>
        ...
        <dsp:a href="billing.jsp">Billing</dsp:a> &gt; Cost Centers &nbsp;</span>
    </td>
  </tr>
  <tr>
    ...
    <table border=0 cellpadding=6 cellspacing=0>
      <tr>
        ...
        <td colspan=3><span class="big">Cost Center</span><p>
        <span class=small>You can select a cost center for the entire order
        or for each line item.</span>
     ...
     <tr>
      ...
      <tr>
        ...
        <dsp:a href="cost_centers_line_item.jsp">Select multiple cost centers</dsp:a></span></td>
      </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/cost_centers.jsp#2 $$Change: 651448 $--%>
