...
<tr valign=top>
  ...
  <table width=100% cellpadding=3 cellspacing=0 border=0>
    <tr>
      <td class=box-top>&nbsp;Billing Info</td>
    </tr>
  </table>
  </td>
</tr>
  ...
  <dsp:oparam name="output">
    <dsp:droplet name="Switch">
      ...
      <tr valign=top>
          <td align=right><span class=smallb>Payment method
          <dsp:valueof param="count"/></span></td>
          <td width=75%>Invoice&nbsp;<dsp:valueof param="pGroup.PONumber"/>&nbsp;<dsp:valueof param="pGroup.requisitionNumber"/>
          </td>
      </tr>
      <tr valign=top>
        <td align=right><span class=smallb>Amount</span></td>
...
<dsp:droplet name="/atg/projects/b2bstore/order/ItemsSplitbyType">
  ...
  <dsp:oparam name="true">
    <tr valign=top>
      <td></td>
      <td><span class=smallb><dsp:a href="split_payment.jsp?init=false">Edit Payment info</dsp:a></span></td>
    </tr>
  </dsp:oparam>
...
<dsp:droplet name="/atg/projects/b2bstore/order/ItemsSplitbyType">
  ...
  <dsp:oparam name="true">
    <tr valign=top>
      <td></td>
      <td><span class=smallb><dsp:a href="confirm_cc_details.jsp">Edit CostCenter info</dsp:a></span></td>
    </tr>
  </dsp:oparam>
...
<tr>
  <td></td>
  <td><span class=smallb><dsp:a href="billing.jsp">Edit Billing </dsp:a></span></td>
</tr>       
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/displayOrder.jsp#2 $$Change: 651448 $--%>
