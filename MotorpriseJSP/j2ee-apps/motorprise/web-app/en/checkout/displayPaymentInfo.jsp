      ...
      <tr valign=top>
          ...
          <dsp:droplet name="IsEmpty">
            ...
            <dsp:oparam name="false">
              <td width=75%>PO Number &nbsp;<dsp:valueof param="pGroup.PONumber"/>&nbsp;</td>
            </dsp:oparam>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/displayPaymentInfo.jsp#2 $$Change: 651448 $--%>
