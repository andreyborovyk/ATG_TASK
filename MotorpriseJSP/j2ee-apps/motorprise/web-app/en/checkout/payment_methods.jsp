...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=3 height=18><span class=small>
     ...
     <dsp:a href="billing.jsp">Billing</dsp:a> &gt; Payment Methods &nbsp;</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
        <td colspan=2><span class="big">Payment Methods</span>
            ...
            <dsp:droplet name="Switch">
              ...
              <dsp:oparam name="true">
                <dsp:droplet name="Switch">
                  ...
                  <dsp:oparam name="true">
                    <span class=small>Enter the purchase order or requisition numbers you wish to use for this order. </span>
                  </dsp:oparam>
                  <dsp:oparam name="false">
                     <span class=small>Your authorized credit cards are listed below. 
                    </span>
                  </dsp:oparam>
                </dsp:droplet>
              </dsp:oparam>
      ...
      <dsp:droplet name="ForEach">
        ...
        <dsp:oparam name="output">
          ...
          <tr valign=top>
            ...
            <span class=smallb>Payment method <dsp:valueof param="count"/></span></td>
...
<%--                        <span class=smallb><dsp:a bean="PaymentAddressFormHandler.paymentGroupKey" href="billing_address.jsp" paramvalue="key"><dsp:param name="source" value="payment_methods.jsp?link=`request.getParameter(" link")`"/>Change billing address</dsp:a></span> --%>
                        <span class=smallb>
                          <dsp:a bean="PaymentAddressFormHandler.paymentGroupKey" href="billing_address.jsp" paramvalue="key">
                            <dsp:param name="source" param="successStr"/>Change billing address</dsp:a>
                        </span>
                      </dsp:oparam>
                    </dsp:droplet>
                  </dsp:oparam>
      ...
      <dsp:droplet name="AuthorizedPaymentTypesDroplet">
        ...
        <dsp:oparam name="output">
          <dsp:droplet name="Switch">
            ...
            <dsp:oparam name="true">
              <tr valign=top>
                <td align=right><span class=smallb>New PO number</span></td>
                <td><dsp:input bean="CreateInvoiceRequestFormHandler.invoiceRequest.PONumber" type="text" value="" maxlength="40"/>
                    <dsp:input bean="CreateInvoiceRequestFormHandler.newInvoiceRequest" type="submit" value=" Add "/></td>
              </tr>
              <tr valign=top>
                <td align=right><span class=smallb>New requisition number</span></td>
      ...
      <dsp:droplet name="ForEach">
        ...
        <dsp:oparam name="outputStart">
          <dsp:droplet name="Switch">
            ...
            <dsp:oparam name="1">
              <tr valign=top>
                <td align=right><span class="smallb">Default payment method</span></td>
                <td><span class=help>The full order amount begins on the default payment method. When you split the order the amount split will be moved from this payment method to the selected payment method. Any amount not split to another method will remain on this payment method.
            </span><p>
            </dsp:oparam>
            <dsp:oparam name="default">
              <tr valign=top>
              ...
              <tr valign=top>
                <td></td>
                <td><br><dsp:input bean="PaymentGroupFormHandler.specifyDefaultPaymentGroup" type="submit" value="Continue"/></td>
              </tr>
            </dsp:oparam>
          </dsp:droplet>
        </dsp:oparam>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/payment_methods.jsp#2 $$Change: 651448 $--%>
