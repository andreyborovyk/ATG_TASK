      ...
      <tr> 
        ...
        <table border=0 cellpadding=3 cellspacing=0 width=100%>
          <tr>
            ...
            <span class=smallbw>Related Items</span></td>
          </tr>
        </table></td>
      </tr>
      <tr>
     ...
     <table border=0 cellpadding=0 cellspacing=0 width=100% bgcolor="#E5E5E5">
	  ...
	  <dsp:getvalueof id="urlStr" idtype="java.lang.String" param="element.template.url">
          <dsp:a page="<%=urlStr%>">
            ...
            <span class=small><dsp:valueof param="element.description">no des.</dsp:valueof>.<br>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/relatedItemSlot.jsp#2 $$Change: 651448 $--%>
