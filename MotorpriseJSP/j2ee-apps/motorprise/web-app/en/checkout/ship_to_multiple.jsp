...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=3 height=18><span class=small>
     ...
     <dsp:a href="shipping.jsp">Shipping</dsp:a> &gt; Ship to Multiple Addresses &nbsp;</span>
    </td>
  </tr>
  ...
  <table border=0 cellpadding=4 width=80%>
    ...
    <tr>
      <td colspan=2><span class="big">Ship to multiple addresses</span>
    ...
    <tr valign=top>
        ...
        <table border=0 cellpadding=4 cellspacing=1 width=100%>
          <tr> 
            <td colspan=12><span class=small>To ship a line item to another address select the address and click the "Save" button. To ship only some of the items to another address change the quanity and select the address. You must save changes individually before continuing.
            </span></td>
          </tr>
          <tr><td><dsp:img src="../images/d.gif"/></td></tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/ship_to_multiple.jsp#2 $$Change: 651448 $--%>
