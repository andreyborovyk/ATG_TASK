...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=3 height=18><span class=small>
       &nbsp; <dsp:a href="cart.jsp">Current Order</dsp:a> &gt; Shipping &nbsp;</span>
    </td>
  </tr>
  <tr>
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        <td colspan=2><span class=big>Shipping </span>
        <dsp:include page="../common/FormError.jsp"></dsp:include></td>
      </tr>
      <tr><td><dsp:img src="../images/d.gif"/></td></tr>
      <tr valign=top>
        <td align=right width=25%><span class=smallb>Shipping address</span></td>
        <td>
        ...
        <dsp:oparam name="false">
          <p><span class=smallb><dsp:a href="shipping_address.jsp">Ship to another address</dsp:a></span>
      ...
      <tr>
        ...
        <td>
          <dsp:droplet name="IsEmpty">
            <dsp:param bean="Profile.shippingAddrs" name="value"/>
            <dsp:oparam name="false">
              <span class=smallb><dsp:a href="ship_to_multiple.jsp?init=true">Ship to multiple addresses</dsp:a></span>
            </dsp:oparam>
          </dsp:droplet>
        </td>
      </tr>
      ...
      <tr>
        ...
        <dsp:input bean="ShippingGroupFormHandler.applyShippingGroups" type="submit" value="Continue"/></td>
    </tr>
    </table>
    </dsp:form>
    </td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/checkout/shipping.jsp#2 $$Change: 651448 $--%>
