  ...
  <tr>
    <td>
      ...
      <dsp:droplet name="PlaceLookup">
        <dsp:param name="placeList" bean="/atg/commerce/util/CountryList"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/common/DisplayAddress.jsp#2 $$Change: 651448 $--%>
