...
<dsp:droplet name="Switch">
  ...
  <dsp:oparam name="true">
    ...
    <dsp:droplet name="Switch">
      <dsp:param name="value" bean="MultiUserAddFormHandler.count"/>
      <dsp:oparam name="1"></dsp:oparam>
      <dsp:oparam name="default">Common Errors:</dsp:oparam>
    </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/common/FormError.jsp#2 $$Change: 651448 $--%>
