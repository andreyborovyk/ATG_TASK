...
<dsp:setvalue value="Welcome to Motorprise" param="messageSubject"/>
<%-- 
...
<dsp:droplet name="PersonLookup">
  ...
  <dsp:oparam name="output">
    ...
    <p>Dear <dsp:valueof param="Person.firstName">Valued Customer</dsp:valueof>
    <dsp:valueof param="Person.lastName"/>,

    <p>Welcome to Motorprise. As an employee of <dsp:valueof param="Person.parentOrganization.name"/>, you have been registered on the Motorprise web site with the following user information: 

    <p>Login: <dsp:valueof param="Person.login"/><br> 

    Contact your manager to find out your password.
    ...
    <dsp:droplet name="Format">
      ...
      <dsp:oparam name="output">
        <p><a href="<dsp:valueof param='message'/>">Visit Motorprise here</a>.
      </dsp:oparam>
    </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/email/NewUserRegistered.jsp#2 $$Change: 651448 $--%>
