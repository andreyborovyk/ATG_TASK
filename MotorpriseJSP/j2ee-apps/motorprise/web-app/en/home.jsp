...
<dsp:include page="common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Product Catalog"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <!-- breadcrumbs -->
  <tr bgcolor="#DBDBDB"> 
    <td colspan=2 height=18><span class="small">&nbsp; Product Catalog &nbsp;</span> </td>
  </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/home.jsp#2 $$Change: 651448 $--%>
