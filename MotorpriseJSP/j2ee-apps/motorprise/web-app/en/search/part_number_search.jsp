  ...
  <tr valign=top> 
    ...
    <td valign="top" width=745> 
      <table border=0 cellpadding=4 width=80%>
        ...
        <tr valign=top>
          <td colspan=2><span class=big>Search</span>
                     ...
                     <dsp:droplet name="Switch">
                       ...
                       <dsp:getvalueof id="countParam" idtype="Integer" param="count">
                         <dsp:oparam name="<%=countParam.toString()%>">
                           <dsp:a href="part_number_search.jsp" bean="PartNumberSearchFormHandler.currentResultPageNum" paramvalue="index">&lt;&lt; Previous</dsp:a> &nbsp;
                         </dsp:oparam>
                       </dsp:getvalueof>
                     </dsp:droplet>
                   </dsp:oparam>
                     ...
                     <dsp:droplet name="Switch">
                       ...
                       <dsp:getvalueof id="indexParam" idtype="Integer" param="index">
                         <dsp:oparam name="<%=indexParam.toString()%>">
                           <dsp:a href="part_number_search.jsp" bean="PartNumberSearchFormHandler.currentResultPageNum" paramvalue="count">Next &gt;&gt;</dsp:a>
                         </dsp:oparam>
                       </dsp:getvalueof>
                     </dsp:droplet>
                   </dsp:oparam>
          ...
          <table width=100% bgcolor="#FFCC66" border=0 cellpadding=0 cellspacing=0>
            <tr bgcolor="#666666">
              ...
              <table cellpadding=3 cellspacing=0 border=0>
                <tr><td class=box-top>&nbsp;Part Number Search</td></tr>
              </table>
              </td>
            </tr>
            <tr bgcolor="#666666">
                  ...
                  <tr valign="top">
                     ...
                     <td>
                       <dsp:input bean="PartNumberSearchFormHandler.searchInput" size="25" type="text"/>&nbsp;
                        <br> <span class="small">Use <b>*</b> for partial part number search.</span>
                      </td>
                   </tr>
                   <tr>
                     <td>&nbsp;</td>
                     <td>
                        ...
                        <dsp:input bean="PartNumberSearchFormHandler.search" type="submit" value="Search"/>
                       </dsp:form></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                     ...
                     <tr>
                      ...
                      <td><span class=smallb><dsp:a href="advanced_search.jsp">
                               <dsp:param name="noCrumbs" param="noCrumbs"/>
                               Use advanced product search form</dsp:a></span>
                       </td>
                    <tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/search/part_number_search.jsp#2 $$Change: 651448 $--%>
