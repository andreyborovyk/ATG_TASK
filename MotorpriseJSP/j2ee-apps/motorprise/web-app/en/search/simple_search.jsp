...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Simple Search"/></dsp:include>
...
<tr bgcolor="#DBDBDB" > 
  ...
  <dsp:droplet name="Switch">
    <dsp:param name="value" param="noCrumbs"/>
      <dsp:oparam name="true"><dsp:a href="../home.jsp">Product Catalog</dsp:a> &nbsp; Simple Search</dsp:oparam>
      ...
      <tr><td bgcolor="#666666"><dsp:img src="../images/d.gif" width="1"/></td> 
          <td>
            ...
            <tr>
              ...
              <dsp:input bean="CatalogSearch.search" type="submit" value="Search"/><br><!--<span class="help">Separate words or phrases by <b>AND</b> or <b>OR</b></span>-->    
              <p>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/search/simple_search.jsp#2 $$Change: 651448 $--%>
