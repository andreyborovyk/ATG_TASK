...
<dsp:include page="common/HeadBody.jsp"><dsp:param name="pagetitle" value=" Session Expired"/></dsp:include>
    ...
    <dsp:oparam name="true"> 
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
              ...
              <td bgcolor="#F7D774" align="right"><dsp:img src="images/splash-motorprise-error-edge.gif"/></td>
              <td bgcolor="#00B2EB" align="right">
              <span class=bw><font color="#FFFF00">Session Expired: </font></span><font color="#FFFFFF">Please login to continue. &nbsp;&nbsp;</font></td>
			</tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/session_expired.jsp#2 $$Change: 651448 $--%>
