  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <tr valign=top> 
      ...
      <tr>
        ...
        <tr><td class=box-top>&nbsp;Resolved Approval Requests</td></tr></table></td>
      </tr>
      <tr>
        <td>
        <div align=center>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/user/approvals_past.jsp#2 $$Change: 651448 $--%>
