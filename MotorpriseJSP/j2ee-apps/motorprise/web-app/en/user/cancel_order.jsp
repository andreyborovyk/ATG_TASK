    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
            ...
            <table width=100% cellpadding=3 cellspacing=0 border=0>
              <tr><td class=box-top>&nbsp;Cancel Order</td></tr></table>
            </td>
       </tr>
      ...
      <dsp:droplet name="OrderLookup">
        ...
        <dsp:oparam name="output">
         <dsp:setvalue param="order" paramvalue="result"/>
          ...
          Cancel order #<dsp:valueof param="order.id"/>?<p><br>
         ...
         <%/* If you do not wish to cancel your order, you may use your browser's
          ...
          <input type="submit" value="Don't cancel order">
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/user/cancel_order.jsp#2 $$Change: 651448 $--%>
