...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="my_account.jsp">My Account</dsp:a> &gt; <dsp:a href="my_profile.jsp">My Profile</dsp:a> &gt; Edit Company Info</td>
  </tr>
  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=90%>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;Edit Account Default Information</td></tr></table>
        </td>
      </tr>
      ...
      <tr>
        <td colspan=2><span class=small>
           Select defaults from your company information.
           </span></td>
      </tr>
      ...
      <tr>
        ...
        <td>
            ...
            <dsp:input bean="B2BRepositoryFormHandler.update" type="submit" value="Save selected defaults"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/user/edit_company_info.jsp#2 $$Change: 651448 $--%>
