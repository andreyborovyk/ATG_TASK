    ...
    <dsp:oparam name="true">
      <dsp:droplet name="Switch">
        ...
        <dsp:oparam name="default">
          <tr bgcolor="#DBDBDB" > 
            <td colspan=2 height=18> &nbsp; <span class=small>
            <dsp:a href="../checkout/current_order.jsp">Current Order</dsp:a> &gt;
            ...
            <dsp:a href="scheduled_order_new.jsp">Create Scheduled Order</dsp:a> &gt;
            <dsp:a href="scheduled_order_calendar.jsp"><dsp:valueof bean="ScheduledOrderFormHandler.value.name"/></dsp:a> &gt;
            Preview Order <dsp:valueof param="createNew"/></td>
          </tr>
        </dsp:oparam>
      </dsp:droplet>
    </dsp:oparam>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/user/scheduled_order_preview.jsp#2 $$Change: 651448 $--%>
