...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  ¿‹æZŠ"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="business_units.jsp">‰ïĞŠÇ—</dsp:a> &gt; 
    <dsp:a href="company_admin.jsp"><dsp:valueof bean="Profile.currentOrganization.name"/></dsp:a> &gt; <dsp:a href="billing_addresses.jsp">¿‹æZŠ</dsp:a> &gt; 
    ¿‹æZŠ‚Ìíœ
    </span></td>
  </tr>
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
        <td colspan=2 valign="top"><span class=big>‰ïĞŠÇ—</span><br><span class=little><dsp:valueof bean="Profile.currentOrganization.name" /></span>
        ...
        <dsp:input bean="B2BRepositoryFormHandler.updateRepositoryId" beanvalue="Profile.currentOrganization.repositoryId" type="hidden"/>
          ...
          <dsp:droplet name="AddressLookUp">
            ...
            <dsp:oparam name="output">
              ...
              <p>
               <dsp:input bean="B2BRepositoryFormHandler.delete" type="submit" value="ZŠ‚Ìíœ"/> &nbsp;
               <input type="submit" value="ƒLƒƒƒ“ƒZƒ‹">
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/billing_addr_delete.jsp#2 $$Change: 651448 $--%>
