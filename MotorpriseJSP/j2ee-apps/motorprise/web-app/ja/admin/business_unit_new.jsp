...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        <td><span class=big>会社管理</span><br>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;ビジネスユニットの新規作成</td></tr></table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border=0 cellpadding=4 cellspacing=0>
          ...
          <tr valign=top>
            <td align=right><span class=smallb>親組織</td>
            <td>
	    ...
	    <dsp:getvalueof id="parentId" idtype="java.lang.String" bean="Profile.parentOrganization.repositoryId">
            <dsp:option selected="<%=true%>" value="<%=parentId%>"/>親組織の選択
	    </dsp:getvalueof>
	    <dsp:droplet name="TargetPrincipals">
          ...
          <tr valign=top>
            ...
            <td><br>
                ...
                <dsp:input bean="CreateOrganizationFormHandler.createOrganization" type="submit" value="保存"/> &nbsp;
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/business_unit_new.jsp#2 $$Change: 651448 $--%>
