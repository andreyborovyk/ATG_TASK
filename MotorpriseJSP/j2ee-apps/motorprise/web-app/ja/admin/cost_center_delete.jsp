...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="cost_centers.jsp">コストセンタ</dsp:a> &gt コストセンタの削除
    </span> </td>
  </tr>
    ...
    <dsp:oparam name="output">
      ...
      <dsp:input bean="B2BRepositoryFormHandler.deleteErrorURL" paramvalue="deleteErrorURL" type="hidden"/>
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <dsp:input bean="B2BRepositoryFormHandler.delete" type="submit" value="削除"/> &nbsp;<dsp:input bean="B2BRepositoryFormHandler.cancel" type="submit" value="キャンセル"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/cost_center_delete.jsp#2 $$Change: 651448 $--%>
