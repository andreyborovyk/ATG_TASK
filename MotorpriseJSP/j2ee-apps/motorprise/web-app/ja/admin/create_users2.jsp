     ...
     <dsp:include page="../common/FormError.jsp"></dsp:include> 
      ...
      <table border=0 cellpadding=4 width=100%>
        ...
        <tr><td><dsp:img src="../images/d.gif" vspace="0"/></td></tr>
          ...
          <dsp:param bean="MultiUserAddFormHandler.count" name="howMany"/>
           <dsp:oparam name="output">
             ...
             <tr>
               ...
               <td width=75%><dsp:input bean="MultiUserAddFormHandler.users[param:index].value.lastName" size="15" type="text" required="<%=true%>"/>
                <dsp:input bean="MultiUserAddFormHandler.users[param:index].value.middleName" size="4" type="text"/>
                <dsp:input bean="MultiUserAddFormHandler.users[param:index].value.firstName" size="15" type="text" required="<%=true%>"/></td>
             </tr>
             <tr>
             ...
             <tr>
               <td align=right><span class=smallb>確認</span></td>
               <td>
               ...
               <td>
                    ...
                    <dsp:oparam name="true">
                       ...
                       <dsp:oparam name="output">
                          ...
                          <dsp:input bean="MultiUserAddFormHandler.users[param:index].roleIds" paramvalue="role.repositoryId" type="checkbox" />  <dsp:valueof param="role.name">名前なし</dsp:valueof>
                       </BR>
                       </dsp:oparam>
                       </dsp:droplet>
                   </dsp:oparam>
                   ...
                   <dsp:oparam name="false">
                       ...
                       <dsp:oparam name="output">
                          ...
                          <dsp:oparam name="true">
                            <dsp:input bean="MultiUserAddFormHandler.users[param:index].roleIds" paramvalue="role.repositoryId" type="checkbox" checked="<%=true%>"/>  <dsp:valueof param="role.name">名前なし</dsp:valueof>
                          </dsp:oparam>
                          <dsp:oparam name="false">
                  	        <dsp:input bean="MultiUserAddFormHandler.users[param:index].roleIds" paramvalue="role.repositoryId" type="checkbox" />  <dsp:valueof param="role.name">名前なし</dsp:valueof>
                          </dsp:oparam>
         ...
         <tr>
           <td></td>
           <td><b><dsp:input bean="MultiUserAddFormHandler.create" type="submit" value=" 保存 "/> &nbsp;
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/create_users2.jsp#2 $$Change: 651448 $--%>
