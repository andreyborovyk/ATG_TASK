   ...
   <dsp:form action="company_admin.jsp" method="post">
    ...
    <dsp:input bean="B2BRepositoryFormHandler.value.defaultBillingAddress.updateMode" type="hidden" value="replace"/>
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;デフォルトの請求先住所の選択</td>
                </tr>
              </table> 
            </td>
          </tr>
          ...
          <tr><td>&nbsp;</td></tr>
          <tr>
            <td colspan="3" align="left"><dsp:input bean="B2BRepositoryFormHandler.update" type="submit" value=" 保存 "/>
            <input type="submit" name="cancel" value="キャンセル"></td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/default_billing_edit.jsp#2 $$Change: 651448 $--%>
