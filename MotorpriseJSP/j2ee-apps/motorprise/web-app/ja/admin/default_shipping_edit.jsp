...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  配達先住所の選択"/></dsp:include>
  ...
  <tr valign=top> 
   ...
   <dsp:form action="company_admin.jsp" method="post">
    ...
    <dsp:input bean="B2BRepositoryFormHandler.value.defaultShippingAddress.updateMode" type="hidden" value="replace"/>
          ...
          <tr>
            <td colspan=2 valign="top"> 
              <table width=100% cellpadding=3 cellspacing=0 border=0>
                <tr> 
                  <td class=box-top>&nbsp;デフォルトの配達先住所の選択</td>
                </tr>
              </table> 
            </td>
          </tr>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td colspan="3" align="left"><dsp:input bean="B2BRepositoryFormHandler.update" type="submit" value=" 保存 "/>
