...
<dsp:droplet name="IsEmpty">
  ...
  <dsp:oparam name="true">
    <core:createUrl id="errorPage" url="multiple_user_edit.jsp">
      <core:urlParam param="errorMessage" value="ユーザが選択されていません。"/>
   ...
   <td width=55><dsp:img src="../images/d.gif" hspace="27"/></td>
	...
	<dsp:form formid="users" action="<%=formTarget%>" method="post"> 
      ...
      <dsp:setvalue bean="Profile.currentUser" paramvalue="user"/>
          ...
          <br>
          <span class=smallb><dsp:a href="multiple_user_edit.jsp">選択済みユーザリストの編集</dsp:a></span>
        </blockquote>
        </dsp:form>
	</dsp:getvalueof>
        ...
        <blockquote>
          ...
          <input type="checkbox" name="roles" value="true"> 役割<br>
          <input type="checkbox" name="shippingAddrs" value="true"> 配達先住所<br>
           <input type="checkbox" name="paymentMethods" value="true"> クレジットカード<br>
          <input type="checkbox" name="costCenters" value="true"> コストセンタ<br>
          <input type="checkbox" name="purchaseLimit" value="true"> 購入制限<br>
          <br> 
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/multiple_user_edit2.jsp#2 $$Change: 651448 $--%>
