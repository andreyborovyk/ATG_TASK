...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" 購入制限"/></dsp:include>
            ...
            <td valign="top" colspan=2 height="92"> 
              <table border="0" cellpadding=4 width=100%>
                <tr>
                  ...
                  <p>購入制限は、承認が必要な場合にのみ適用されます。承認が必要であり、購入制限が０に設定されている場合は、すべての購入について承認が必要です。
                  </span></td>
                </tr>
                ...
                <tr>
                  <td width=25% align="right"><span class=smallb>承認要件</span></td>
                  <td>
                  <%--  check if inherited --%>
                ...
                <tr>
                  <td width=25% align="right"><span class=smallb>購入制限</span></td>
                  <td>
                  <% /*  check if inherited */ %>
                  <dsp:droplet name="IsEmpty">
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/purchase_limit_edit.jsp#2 $$Change: 651448 $--%>
