...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  配達先住所の編集"/></dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="shipping_edit.jsp">配達先住所</dsp:a> &gt; 配達先住所の編集</span> </td>
  </tr>
      ...
      <tr> 
        <td colspan=2> 
          ...
          <dsp:input bean="B2BRepositoryFormHandler.value.address1" paramvalue="shippingAddress.address1" size="30" type="text"/>
              ...
              配達 ID:<dsp:valueof param="shippingId">なし </dsp:valueof>
              </dsp:oparam>
              </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/shipping_details_edit.jsp#2 $$Change: 651448 $--%>
