...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  ユーザデフォルトの編集"/></dsp:include>
<table border=0 cellpadding=0 cellspacing=0 width=800>
  <tr>
   ...
   <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="user.jsp">ユーザアカウント</dsp:a> &gt; ユーザデフォルトの編集
    </span></td>
  </tr>
    ...
    <table border=0 cellpadding=4 width=80%>
     ...
     <dsp:include page="../common/FormError.jsp"></dsp:include></td>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;ユーザデフォルトの編集</td></tr></table>
        </td>
      </tr>
      ...
      <tr><td colspan=2><dsp:img src="../images/d.gif" vspace="0"/></td></tr>
      <tr>
        <td colspan=2><span class=small>このユーザのデフォルトを選択してください。</span></td>
      </tr>
      <tr>
        <td align=right><span class=smallb>名前</span></td>
        <td width=75%><dsp:valueof bean="Profile.currentUser.lastName"/>&nbsp;<dsp:valueof bean="Profile.currentUser.firstName"/></td>
      </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/user_edit_defaults.jsp#2 $$Change: 651448 $--%>
