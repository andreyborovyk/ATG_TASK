...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value="  ユーザ"/></dsp:include>
           ...
           <dsp:oparam name="outputEnd">
            <dsp:droplet name="IsEmpty">
             ...
             <dsp:oparam name="false"><BR>
               <dsp:a href="users.jsp">  次の 10 件 <dsp:param name="startIndex" param="nextStart"/></dsp:a>
             </dsp:oparam>
            </dsp:droplet>
          </dsp:oparam>        
         </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/admin/users.jsp#2 $$Change: 651448 $--%>
