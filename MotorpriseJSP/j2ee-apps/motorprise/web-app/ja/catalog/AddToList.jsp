...
<dsp:form action="product.jsp" method="post">
    ...
    <dsp:droplet name="ForEach">
      ...
      <dsp:oparam name="output">
        <dsp:getvalueof id="elem" idtype="atg.repository.RepositoryItem" param="element">
          ...
          <dsp:valueof param="element.eventName">未指定の購入リスト</dsp:valueof> 
        </dsp:getvalueof>  
      </dsp:oparam>
    </dsp:droplet>    
  </dsp:select></td>
  ...
  <tr>
    <td><dsp:input bean="PurchaselistFormHandler.addItemToPurchaselist" type="submit" value="リストに追加"/></td>
  </tr>
  ...
  <tr>
    ...
    <table border=0 cellpadding=3 width=100%>
      <tr>
        <td><span class=smallb><dsp:a href="../user/purchase_lists.jsp?noCrumbs=false"><dsp:param name="product" param="product.repositoryId"/><dsp:param name="noCrumbs" value="false"/>購入リストの新規作成</dsp:a></span></td>
      </tr>
    </table>
    </td>
  </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/catalog/AddToList.jsp#2 $$Change: 651448 $--%>
