...
<dsp:droplet name="/atg/dynamo/droplet/ForEach">
  ...
  <dsp:oparam name="outputEnd">
    ...
    <table border=0 cellpadding=1 cellspacing=1 vspace=10 align=left>
      <tr><td><br><span class=smallb><dsp:a href="compare_delete.jsp">比較リストの編集</dsp:a></span></td></tr>
	  <tr>
        <td><br><dsp:form action="compare_result.jsp"><input type="submit" value="比較">&nbsp;</dsp:form></td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/catalog/compareList.jsp#2 $$Change: 651448 $--%>
