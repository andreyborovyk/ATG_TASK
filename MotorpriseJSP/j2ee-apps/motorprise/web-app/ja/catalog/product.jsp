      ...
      <dsp:param name="pagetitle" value="<%=page_title%>"/>
          ...
          <td valign="top" colspan=2>                  
            ...
            <tr>
              <td valign="top" width=45%>
                ...
                <tr>
                  <td>
                    ...
                    <dsp:valueof param="element.displayName">名前なし</dsp:valueof></span>
                    <br>
		        ...
		        <dsp:getvalueof id="imageURL" param="element.largeImage.url" idtype="java.lang.String">
                        <dsp:img hspace="70" alt="製品の画像" src="<%=imageURL%>"/>
			</dsp:getvalueof>
                      </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <br>                             
                    <span class=smallb>製品の説明</span><br>
                    <span class=small><dsp:valueof param="element.longDescription">説明なし</dsp:valueof>
                   </span>
                  </td>
                </tr>
                </table>
              ...
              <!-- display order information -->
                ...
                <tr>
                  <td bgcolor="#999999">
                    ...
                    <tr><td><span class=smallbw>&nbsp;オーダーに追加</span></td></tr>
                    </table>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td bgcolor="#999999">
                    <table border=0 cellpadding=1 width=100%>
                      <tr><td><span class=smallbw>&nbsp;購入リスト</span></td></tr>
                    </table>
                  </td>
                </tr>
                <dsp:droplet name="IsEmpty">
              ...
              <dsp:param name="noCrumbs" value="false"/>購入リストの新規作成</dsp:a></span>
                      </td>
                    </tr>
                ...
                <tr>
                  <td bgcolor="#999999">
                    <table border=0 cellpadding=1 width=100%>
                    <tr><td><span class=smallbw>&nbsp;製品の比較</span></td></tr>
                    </table>
                  </td>
                </tr>
                <tr><td><dsp:img src="../images/d.gif" vspace="1"/></td></tr>
                      ...
                      <tr>
                        ...
                        <dsp:droplet name="ProductListContains">
                          ...
                          <dsp:oparam name="true">
                            ...
                            <dsp:input bean="ProductListHandler.removeProduct" type="submit" value="リストから削除"/>
                          </dsp:oparam>
                          <dsp:oparam name="false">
                            <dsp:input bean="ProductListHandler.productID" paramvalue="productID" type="hidden"/>
                            <dsp:input bean="ProductListHandler.addProduct" type="submit" value="比較リストに追加"/>
                           </dsp:oparam>
                         </dsp:droplet> 
                      </td>
                    </tr>            
<!--check to see if there are items in comparison list-->
                    <dsp:droplet name="IsEmpty">
                      ...
                      <dsp:oparam name="false">
                    <tr>
                      <td><span class=smallb><dsp:a href="compare.jsp">比較リストの表示</dsp:a></td>
                    </tr>
                      </dsp:oparam>
                      </dsp:droplet>
                      </dsp:form>
                ...
                <dsp:droplet name="/atg/commerce/catalog/ForEachItemInCatalog">
                  ...
                  <dsp:oparam name="outputStart">
                    <tr>
                      <td bgcolor="#999999">
                      <table border=0 cellpadding=1 width=100%>
                        <tr><td><span class=smallbw>&nbsp;関連アイテム</span></td></tr>
                      </table>
                      </td>
                    </tr>
                    <tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/catalog/product.jsp#2 $$Change: 651448 $--%>
