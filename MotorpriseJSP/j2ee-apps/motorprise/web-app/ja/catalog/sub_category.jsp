...
<dsp:droplet name="/atg/commerce/catalog/CategoryLookup">  
  <dsp:oparam name="output">          
    ...
    <tr>
          ...
          <dsp:valueof param="element.itemDisplayName">名前なし</dsp:valueof></span>
              ...
              <dsp:droplet name="/atg/dynamo/droplet/ForEach">
                ...
                <dsp:oparam name="outputStart">
                  <tr valign="bottom">
                    ...
                    <td bgcolor="#666666" colspan=2><span class="smallbw">部品番号</span></td>
                    <td bgcolor="#666666" colspan=2><span class="smallbw">製品</span></td>
                    <td bgcolor="#666666" colspan=2><span class="smallbw">説明</span></td>
          <td bgcolor="#666666" colspan=2><span class="smallbw">メーカ</span></td>
                  </tr>
                </dsp:oparam>
                <dsp:oparam name="output">
                  <tr valign="top">
            <td><dsp:img src="../images/d.gif" hspace="1"/></td> 
		       ...
		       <dsp:a page="<%=skuURL%>">
		         <dsp:param name="id" param="element.repositoryId"/>
                         <dsp:valueof param="sku.manufacturer_part_number">部品番号なし</dsp:valueof>
		       </dsp:a>
                       </nobr></td>
		       </dsp:getvalueof>
                      </dsp:oparam>
		    ...
		    <dsp:a page="<%=urlStr%>">
		      ...
		      <dsp:valueof param="element.displayName">名前なし</dsp:valueof>
                    ...
                    <td>&nbsp;</td>
                    <td><dsp:valueof param="element.description">説明なし</dsp:valueof></td>
                    
                    <td>&nbsp;</td>
                    <td><dsp:valueof param="element.manufacturer.displayName">不明</dsp:valueof></td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/catalog/sub_category.jsp#2 $$Change: 651448 $--%>
