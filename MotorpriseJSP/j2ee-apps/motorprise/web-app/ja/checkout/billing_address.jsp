...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=3 height=18><span class=small>
       ...
       <dsp:a href="billing.jsp">請求</dsp:a> &gt; 請求先住所 &nbsp;</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <table border=0 cellpadding=4 width=90%>
      ...
      <tr>
        <td colspan=2><span class="big">請求先住所</span></td>
      </tr>
      <tr>
      <tr><td><dsp:img src="../images/d.gif"/></td></tr>
    
      <tr valign="top">
        <td align="right" width=25%><span class=smallb>請求先住所の選択</span></td>
        <td>
      ...
      <tr>
        ...
        <dsp:input bean="PaymentAddressFormHandler.setAddress" type="submit" value="続行"/>
       </td>
     </tr>
   </table>
   </dsp:form>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/billing_address.jsp#2 $$Change: 651448 $--%>
