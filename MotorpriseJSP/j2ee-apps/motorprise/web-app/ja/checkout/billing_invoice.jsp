      ...
      <td width=55><dsp:img src="../images/d.gif" hspace="27"/></td>
        ...
        <table border=0 cellpadding=4 width=80%>
          ...
          <tr valign=top>
            ...
            <span class=help>請求番号か発注番号のいずれかが必要です。</span></td>
          </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/billing_invoice.jsp#2 $$Change: 651448 $--%>
