...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    <td colspan=2 height=18><span class=small>
       &nbsp; <dsp:a href="cart.jsp">カート</dsp:a> &gt; チェックアウト &nbsp;</span>
    </td>
  </tr>
  ...
  <tr>
    ...
    <table border=0 cellpadding=4 cellspacing=0 width=80%>
      ...
      <tr>
            ...
            <tr valign=top>
              <td colspan=2>
                <table width=100% cellpadding=3 cellspacing=0 border=0>
                  <tr><td class=box-top>&nbsp;コストセンタの詳細</td></tr></table>
              </td>
            </tr>
            ...
            <tr>
              <td></td>
              <td><span class=smallb><dsp:a href="cost_centers_line_item.jsp?init=false">コストセンタ情報の編集</dsp:a></span><br> 
              <span class=smallb><dsp:a href="confirmation.jsp">オーダーの確認へ戻る</dsp:a></span><br>
            ...
            <tr>
              <td></td>
              <td>
                <dsp:input bean="CommitOrderFormHandler.commitOrder" type="submit" value="オーダーする"/>
                ...
                <dsp:input bean="CancelOrderFormHandler.cancelOrder" type="submit" value="オーダーのキャンセル"/>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/confirm_cc_details.jsp#2 $$Change: 651448 $--%>
