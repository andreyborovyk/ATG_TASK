...
<dsp:include page="../common/HeadBody.jsp">
  <dsp:param name="pagetitle" value=" チェックアウト"/>
</dsp:include>
...
<table border=0 cellpadding=0 cellspacing=0>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <dsp:a href="cost_centers.jsp">コストセンタ</dsp:a> &gt; コストセンタの分割 &nbsp;</span>
    </td>
  </tr>
  <tr bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <table border=0 cellpadding=6 cellspacing=0 width=800>
      <tr>
        <td></td>
        <td colspan=2><span class="big">コストセンタ</span>
      ...
      <tr valign=top>
        ...
        <table border=0 cellpadding=4 cellspacing=1 width=80%>
          <tr>
            <td colspan=12><span class=small>各品目をコストセンタに割り当ててください。新しいコストセンタに割り当てるアイテムの数を入力し、１つの品目を複数のコストセンタの間で分けることもできます。
            </span></td>
          </tr>
          ...
          <tr valign=bottom bgcolor="#666666">
            ...
            <td colspan=2><span class=smallbw>移動する数量</span></td>
            <td colspan=1><span class=smallbw>コストセンタ</span></td>
                    ...
                    <dsp:oparam name="output">
                      ...
                      <tr valign=top>
                        ...
                        <td align=center>
                          ...
                          <dsp:input bean="CostCenterFormHandler.splitCostCenters" type="submit" value="保存"/>
                        </td>
                      </tr>
                      </dsp:form>
                      <%-- end line item --%>
          ...
          <dsp:droplet name="ForEach">
            ...
            <dsp:oparam name="output">
              ...
              <dsp:droplet name="Switch">
                ...
                <dsp:oparam name="default">
                  配達グループ - <dsp:valueof param="count"/>
                </dsp:oparam>
              </dsp:droplet></td>
              <dsp:droplet name="ForEach">
                <dsp:param bean="CostCenterFormHandler.currentList" name="array"/>
...
<%--                                <dsp:oparam name="param:...element.costCenterName"> --%>
    ...
    <tr>
      <td></td>
      <td><span class=help>続行する前に、変更をそれぞれ保存する必要があります。</span><p>
          ...
          <dsp:input bean="CostCenterFormHandler.applyCostCenters" type="submit" value="続行"/>
        </dsp:form>
     </td>
   </tr>
 </table>
...
<%-- Version: $Change: 651448 $$DateTime: 2011/06/07 13:55:45 $--%>
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/costCentersLineItemDetails.jsp#2 $$Change: 651448 $--%>
