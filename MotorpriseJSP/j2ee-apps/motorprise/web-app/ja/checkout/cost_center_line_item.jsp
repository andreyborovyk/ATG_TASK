    ...
    <dsp:oparam name="output">
      ...
      <td>
        ...
        <select name="item.id" param="item.costCenter">   
         cc ÇÃílÅF<dsp:valueof param="item.costCenter">ílÇ»Çµ</dsp:valueof>
          <%--
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/cost_center_line_item.jsp#2 $$Change: 651448 $--%>
