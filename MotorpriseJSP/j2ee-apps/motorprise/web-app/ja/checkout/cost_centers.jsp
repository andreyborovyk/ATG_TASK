...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=3 height=18><span class=small>
        ...
        <dsp:a href="billing.jsp">請求</dsp:a> &gt; コストセンタ &nbsp;</span>
    </td>
  </tr>
  <tr>
    ...
    <table border=0 cellpadding=6 cellspacing=0>
      <tr>
        ...
        <td colspan=3><span class="big">コストセンタ</span><p>
        <span class=small>コストセンタは、オーダー全体に対して、または品目ごとに選択できます。
        </span>
     ...
     <tr>
      ...
      <tr>
        ...
        <dsp:a href="cost_centers_line_item.jsp">複数のコストセンタの選択</dsp:a></span></td>
      </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/cost_centers.jsp#2 $$Change: 651448 $--%>
