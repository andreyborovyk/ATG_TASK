  ...
  <dsp:oparam name="output">
    <dsp:droplet name="Switch">
      ...
      <dsp:oparam name="creditCard">
        <tr valign=top>
          <td align=right><span class=smallb>支払い方法
        ...
        <tr valign=top>
          <td align=right><span class=smallb>金額</span></td>
      ...
      <tr valign=top>
          <td align=right><span class=smallb>支払い方法
          <dsp:valueof param="count"/></span></td>
          <td width=75%>インボイス&nbsp;<dsp:valueof param="pGroup.PONumber"/>&nbsp;<dsp:valueof param="pGroup.requisitionNumber"/>
          </td>
      </tr>
      <tr valign=top>
        <td align=right><span class=smallb>金額</span></td>
...
<dsp:droplet name="/atg/projects/b2bstore/order/ItemsSplitbyType">
  ...
  <dsp:oparam name="true">
    <tr valign=top>
      <td></td>
      <td><span class=smallb><dsp:a href="split_payment.jsp?init=false">支払い情報の編集</dsp:a></span></td>
    </tr>
  </dsp:oparam>
...
<dsp:droplet name="/atg/projects/b2bstore/order/ItemsSplitbyType">
  ...
  <dsp:oparam name="true">
    <tr valign=top>
      <td></td>
      <td><span class=smallb><dsp:a href="confirm_cc_details.jsp">コストセンタ情報の編集</dsp:a></span></td>
    </tr>
  </dsp:oparam>
...
<tr>
  <td></td>
  <td><span class=smallb><dsp:a href="billing.jsp">請求の編集 </dsp:a></span></td>
</tr>       
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/displayOrder.jsp#2 $$Change: 651448 $--%>
