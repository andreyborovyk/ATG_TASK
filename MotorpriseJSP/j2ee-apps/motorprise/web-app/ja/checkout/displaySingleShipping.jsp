  ...
  <table width=100% cellpadding=3 cellspacing=0 border=0>
    ...
    <dsp:droplet name="Switch">
      ...
      <dsp:oparam name="default">
        ...
        <tr valign=top>
          <td align=right><span class=smallb>配達方法</b></td>
        ...
        <tr valign=top>
              ...
              <table border=0 cellpadding=0 cellspacing=5 width=100%>
                <tr valign=bottom>
                  ...
                  <td align=right><span class=smallb>合計</span></td>
                </tr>
                <tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/displaySingleShipping.jsp#2 $$Change: 651448 $--%>
