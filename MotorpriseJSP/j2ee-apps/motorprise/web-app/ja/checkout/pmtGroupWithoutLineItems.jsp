  ...
  <dsp:oparam name="output">
    <dsp:droplet name="Switch">
      ...
      <dsp:oparam name="creditCard">
        <tr valign=top>
          <td></td>
              <td align=right><span class=smallb>éxï•Ç¢ï˚ñ@
        ...
        <tr valign=top>
          <td></td>
              <td align=right><span class=smallb>ã‡äz</span></td>
              <td width=75%>
        ...
        <tr valign=top>
          <td></td>
              <td align=right><span class=smallb>êøãÅêÊèZèä</span></td>
              <td width=75%>
      ...
      <td></td>
          ...
          <dsp:droplet name="IsEmpty">
            ...
            <dsp:oparam name="false">
              <td width=75%>î≠íçî‘çÜ &nbsp;<dsp:valueof param="pGroup.PONumber"/>&nbsp;</td>
            </dsp:oparam>
            <dsp:oparam name="true">
              <td width=75%>êøãÅî‘çÜ&nbsp;<dsp:valueof param="pGroup.requisitionNumber"/>&nbsp;</td>
            </dsp:oparam>
          </dsp:droplet>
    </tr>
        <tr valign=top>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/pmtGroupWithoutLineItems.jsp#2 $$Change: 651448 $--%>
