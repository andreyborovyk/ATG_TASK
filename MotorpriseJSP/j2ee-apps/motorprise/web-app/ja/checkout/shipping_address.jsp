...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    ...
    <td colspan=2 height=18><span class=small>
       ...
       <dsp:a href="shipping.jsp">配達</dsp:a> &gt; 別の住所への配達 &nbsp;</span>
    </td>
  </tr>
  ...
  <td  valign="top" width=745>
    ...
    <table border=0 cellpadding=4 width=90%>
      ...
      <tr>
        <td colspan=2><span class="big">配達先住所</span>
        <dsp:include page="../common/FormError.jsp"></dsp:include></td>
      </tr>
      <tr><td><dsp:img src="../images/d.gif"/></td></tr>
      
      <tr valign="top">
        <td align="right"><span class=smallb>配達先住所の選択</span></td>
        <td>
      ...
      <tr>
        ...
        <td colspan=2><br>
            ...
            <dsp:input bean="B2BRepositoryFormHandler.update" type="submit" value="続行"/>
       </td>
     </tr>
   </table>
   </dsp:form>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/shipping_address.jsp#2 $$Change: 651448 $--%>
