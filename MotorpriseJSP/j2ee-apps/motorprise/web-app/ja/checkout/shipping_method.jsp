...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB">
    <%-- put breadcrumbs here --%> <td colspan=3 height=18><span class=small> &nbsp;
    <dsp:a href="cart.jsp">現在のオーダー</dsp:a> &gt; <dsp:a href="shipping.jsp">配達</dsp:a> &gt; <dsp:a href="ship_to_multiple.jsp">複数の住所の選択</dsp:a> &gt; 配達方法の選択 &nbsp; </td>
  </tr>
  <tr>
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
        <td colspan=3><span class="big">配達方法</span>
      ...
      <dsp:droplet name="ForEach">
        ...
        <dsp:oparam name="output">
          ...
          <dsp:droplet name="Switch">
            ...
            <tr valign=top>
              <td align=right width=25%><span class=smallb>配達方法</span></td>
              <td align=left>
                <%--
      ...
      <td></td>
        <td colspan="2">
        <span class=smallb>
        <dsp:a href="ship_to_multiple.jsp?init=false">配達グループの編集</dsp:a></span>
        <p>
        <%--
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/checkout/shipping_method.jsp#2 $$Change: 651448 $--%>
