                ...
                <table border="0" cellpadding="3" cellspacing="0" width="100%" height="25">
                  <tr>
                    <td bgcolor="#FF9933" align="center">
                      <nobr><dsp:valueof bean="Profile.lastName"/> 
                      <dsp:valueof bean="Profile.firstName"/> がログイン中</b> | 
                      <b>
                      
                      <dsp:a bean="ProfileFormHandler.logout" href="../../index.jsp" value="">
                        <font color="#ffffff">ログアウト</font>
                      </dsp:a></b></nobr>
                    </td>
                  </tr>
                </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" height="74">
              <tr>
                ...
                <table border="0" cellpadding="7" cellspacing="0" width="100%" height="36">
                  <tr>
                    ...
                    <b><font color="#000000">Motorprise カタログを参照</font></b></dsp:a></td>
                  </tr>
                </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <table border="0" cellpadding="7" cellspacing="0" width="100%" height="37">
                  <tr>
                    <td bgcolor="#FF9900" align="center"><dsp:a href="../../"><b><font color="#FFFFFF">カスタマのログイン</font></b></dsp:a></td>
                  </tr>
                </table>
                </td>
              </tr>
                  ...
                  <dsp:oparam name="false">
                      ...
                      <dsp:oparam name="true">
                        <dsp:droplet name="Switch">
                          ...
                          <dsp:oparam name="admin">
                            ...
                            <b><font color="#FDD30E" size=-1>会社管理</font></b></dsp:a></td>
                          </dsp:oparam>
                          <dsp:oparam name="default">
                            <td align="center"><dsp:a href="../admin/business_units.jsp">
                            <b><font color="#FFFFFF" size=-1>会社管理</font></b></dsp:a></td>
                          </dsp:oparam>
                        </dsp:droplet>
                      </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <dsp:droplet name="Switch">
                      ...
                      <dsp:oparam name="product_catalog">
                        <td align="center"><dsp:a href="../home.jsp"><b><font color="#FDD30E" size=-1>製品カタログ</font></b></dsp:a></td>
                      </dsp:oparam>
                      <dsp:oparam name="default">
                        <td align="center"><dsp:a href="../home.jsp">
                        <b><font color="#FFFFFF" size=-1>製品カタログ</font></b></dsp:a></td>
                      </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <dsp:droplet name="Switch">
                      ...
                      <dsp:oparam name="my_account">
                        ...
                        <b><font color="#FDD30E" size=-1>私のアカウント</font></b></dsp:a></td>
                      </dsp:oparam>
                      <dsp:oparam name="default">
                        <td align="center"><dsp:a href="../user/my_account.jsp">
                        <b><font color="#FFFFFF" size=-1>私のアカウント</font></b></dsp:a></td>
                      </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <dsp:droplet name="Switch">
                      ...
                      <dsp:oparam name="current_order">
                        ...
                        <b><font color="#FDD30E" size=-1>現在のオーダー</font></b></dsp:a></td>
                      </dsp:oparam>
                      <dsp:oparam name="default">
                        <td align="center"><dsp:a href="../checkout/cart.jsp">
                        <b><font color="#FFFFFF" size=-1>現在のオーダー</font></b></dsp:a></td>
                      </dsp:oparam>
                    </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/common/BrandNav.jsp#2 $$Change: 651448 $--%>
