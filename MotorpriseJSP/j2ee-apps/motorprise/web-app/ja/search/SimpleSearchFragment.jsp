...
<table cellspacing="0" cellpadding="0" border="0" bgcolor="#999999" width=100%>
  ...
  <tr>
    <td><dsp:img src="../images/d.gif" hspace="3"/></td>
    <td colspan=2><dsp:a href="advanced_search.jsp"><font color="#FFFFFF"><span class=smallw>Ú×ŒŸõ</span></font></dsp:a></td>
  </tr>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/search/SimpleSearchFragment.jsp#2 $$Change: 651448 $--%>
