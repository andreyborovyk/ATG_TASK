  ...
  <tr valign=top> 
    ...
    <td valign="top" width=745> 
      <table border=0 cellpadding=4 width=80%>
        ...
        <tr valign=top>
          <td colspan=2><span class=big>検索</span></td>
        </tr>
        ...
        <tr> 
          ...
          <dsp:droplet name="Compare">
            ...
            <dsp:oparam name="greaterthan">
              次の検索結果の一部を<b><dsp:valueof bean="AdvProductSearch.startCount"/> - <dsp:valueof bean="AdvProductSearch.endIndex"/></b>を表示しています 
                     ...
                     <dsp:droplet name="Switch">
                       ...
                       <dsp:getvalueof id="countParam" idtype="Integer" param="count">
                         <dsp:oparam name="<%=countParam.toString()%>">
                           <dsp:a href="advanced_search.jsp" bean="AdvProductSearch.currentResultPageNum" paramvalue="index">&lt;&lt; 戻る</dsp:a> &nbsp;
                         </dsp:oparam>
                       </dsp:getvalueof>
                     </dsp:droplet>
                   </dsp:oparam>
                     ...
                     <dsp:droplet name="Switch">
                       ...
                       <dsp:getvalueof id="indexParam" idtype="Integer" param="index">
                         <dsp:oparam name="<%=indexParam.toString()%>">
                           ...
                           <dsp:a href="advanced_search.jsp" bean="AdvProductSearch.currentResultPageNum" paramvalue="count">次へ &gt;&gt;</dsp:a>
                         </dsp:oparam>
                       </dsp:getvalueof>
                     </dsp:droplet>
                   </dsp:oparam>
          ...
          <table width=100% bgcolor="#FFCC66" border=0 cellpadding=0 cellspacing=0>
            <tr bgcolor="#666666">
              ...
              <table cellpadding=3 cellspacing=0 border=0>
                <tr><td class=box-top>&nbsp;製品詳細検索</td></tr>
              </table>
              </td>
            </tr>
                ...
                <tr valign=top>
                  <td width=50%>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="4" bgcolor="#FFCC66">
                      ...
                      <tr valign=top>
                        <td width="15%" align="right"><span class="smallb">テキスト</span></td>
                        <td><dsp:input bean="AdvProductSearch.searchInput" size="25" type="text"/>&nbsp; </span>
                        </td>
                      </tr>
                      <tr>
                        <td align="right"><span class=smallb>カテゴリ</span></td>
                        <td>        
                      ...
                      <tr>
                        <td align="right">&nbsp;<span class=smallb>メーカ</span></td>
                        <td>
                      ...
                      <tr>
                        ...
                        <dsp:input bean="AdvProductSearch.search" type="submit" value="検索"/>
                        </td>
                      </tr>
                      <tr>
                        <td colspan=2>&nbsp;</td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/search/advanced_search.jsp#2 $$Change: 651448 $--%>
