...
<dsp:include page="../common/HeadBody.jsp"><dsp:param name="pagetitle" value=" 簡易検索"/></dsp:include>
...
<tr bgcolor="#DBDBDB" > 
  ...
  <dsp:droplet name="Switch">
    <dsp:param name="value" param="noCrumbs"/>
      <dsp:oparam name="true"><dsp:a href="../home.jsp">製品カタログ</dsp:a> &nbsp; 簡易検索</dsp:oparam>
...
<tr> 
  ...
  <td valign="top" width=745><br><span class="big">検索</span></td>
</tr>
    ...
    <table bgcolor="#FFCC66" border=0 cellpadding=0 cellspacing=0>
      <tr>
        <td colspan=3>
          ...
          <tr><td class=box-top>&nbsp;簡易検索</td></tr>
          </table>
        </td>
      </tr>
      ...
      <tr><td bgcolor="#666666"><dsp:img src="../images/d.gif" width="1"/></td> 
          <td>
            ...
            <tr>
              ...
              <dsp:input bean="CatalogSearch.search" type="submit" value="検索"/><br><!--<span class="help">Separate words or phrases by <b>AND</b> or <b>OR</b></span>-->    
              <p>
              <span class=smallb><dsp:a href="advanced_search.jsp">
                <dsp:param name="noCrumbs" param="noCrumbs"/>
                詳細検索フォームを使用する</span></dsp:a>
              </td>
            </tr>
            <tr>
              <td></td>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/search/simple_search.jsp#2 $$Change: 651448 $--%>
