...
<dsp:include page="common/HeadBody.jsp"><dsp:param name="pagetitle" value=" セッションのタイムアウト"/></dsp:include>
    ...
    <dsp:oparam name="true"> 
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
              ...
              <td bgcolor="#F7D774" align="right"><dsp:img src="images/splash-motorprise-error-edge.gif"/></td>
              <td bgcolor="#00B2EB" align="right">
              <span class=bw><font color="#FFFF00">セッションのタイムアウト：</font></span><font color="#FFFFFF">続行するにはログインしてください。 &nbsp;&nbsp;</font></td>
			</tr>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <dsp:param bean="Profile.transient" name="value"/>
        ...
        <dsp:oparam name="true">
          <span class=smallb>また、ゲストとしてログインすると、<br>
            <dsp:a bean="Profile.locale" href="../ja/home.jsp" value="ja_JP"><font color="#FF3300">日本語</font></dsp:a>、
            <dsp:a bean="Profile.locale" href="../en/home.jsp" value="en_US"><font color="#FF3300">英語</font></dsp:a>
            または<dsp:a bean="Profile.locale" href="../de/home.jsp" value="de_DE"><font color="#FF3300">ドイツ語</font></dsp:a>のカタログをご覧いただけます。
             </span>
