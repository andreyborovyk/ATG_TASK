  ...
  <tr>
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;発注番号の追加</td></tr></table>
        </td>
        ...
        <dsp:droplet name="OrderLookup">
          ...
          <dsp:oparam name="output">
            ...
            <tr> <td colspan=2><span class=categoryhead>オーダー番号 <dsp:valueof param="orderId"/></span></td>
            </tr>
            <tr> <td>
                ...
                <dsp:droplet name="Switch">
                  ...
                  <dsp:oparam name="default">
                    <dsp:form formid="paymentGroup" action="add_po_number.jsp">
                      ...
                      <td width=75%>請求番号&nbsp;<dsp:valueof param="pGroup.requisitionNumber"/>&nbsp;</td>
                      </tr>
                      <tr valign=top>
                      ...
                      <tr valign=top>
                      <td align=right><span class=smallb>発注番号の入力</span></td>
                      <td width=75%>
			...
			<core:createUrl id="this_page" url="add_po_number.jsp">
			  ...
			  <dsp:input type="hidden" bean="B2BOrderRepositoryFormHandler.updateErrorURL"   value="<%=this_page.getNewUrl()%>"/>
                        ...
                        <dsp:input bean="B2BOrderRepositoryFormHandler.update" type="submit" value="保存"/>
                      </td>
                      </tr>
                    </dsp:form>
        ...
        <tr>
          ...
          <td><br><input type="submit" value="続行"></td>
          </dsp:form>
       </tr>
     </table>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/user/add_po_number.jsp#2 $$Change: 651448 $--%>
