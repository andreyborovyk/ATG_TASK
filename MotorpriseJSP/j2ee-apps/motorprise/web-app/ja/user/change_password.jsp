...
<table border=0 cellpadding=0 cellspacing=0 width=800>
  ...
  <tr bgcolor="#DBDBDB" > 
    ...
    <dsp:a href="my_account.jsp">私のアカウント</dsp:a> &gt; <dsp:a href="my_profile.jsp">私のプロファイル</dsp:a> &gt; パスワードの変更</td>
  </tr>
  ...
  <tr valign=top> 
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;パスワードの変更</td></tr></table>
        </td>
      </tr>
      ...
      <tr>
        <td align=right><span class=smallb>現在のパスワード</span></td>
      ...
      <tr>
        ...
        <dsp:input bean="ProfileFormHandler.changePassword" type="submit" value=" 保存 "/> &nbsp;
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/user/change_password.jsp#2 $$Change: 651448 $--%>
