    ...
    <!-- breadcrumbs --> 
      <dsp:droplet name="Switch">
        ...
        <dsp:oparam name="false">          
          <dsp:include page="../common/breadcrumbs.jsp"><dsp:param name="displaybreadcrumbs" value="true"/><dsp:param name="no_new_crumb" value="true"/></dsp:include> &gt; 購入リスト
        </dsp:oparam>
        <dsp:oparam name="default">
          <dsp:param name="noCrumbs" value="true"/>
          <dsp:a href="my_account.jsp">私のアカウント</dsp:a> &gt; 購入リスト
        </dsp:oparam>        
      </dsp:droplet>
    </td>
  </tr>
    ...
    <table border=0 cellpadding=4 width=80%>
      ...
      <tr>
       <td colspan=2>
        ...
        <tr><td class=box-top>&nbsp;購入リスト</td></tr></table>
        </td>
      </tr>
    ...
    <tr>
      ...
      <dsp:droplet name="IsEmpty">
        ...
        <dsp:oparam name="true">
          <span class="small">購入リストを作成し、製品カタログからリストにアイテムを追加してください。</span><p>
        </dsp:oparam>
        <dsp:oparam name="false">
          <span class="small">製品説明ページの [リストに追加] を選択して、アイテムを追加してください。</span>
        </dsp:oparam>
        </dsp:droplet>
        </td>
    </tr>
      ...
      <tr valign=top>
           <td>
             ...
             <dsp:input bean="PurchaselistFormHandler.savePurchaseList" type="submit"  value="リストの作成"/>
             <br>
             <span class="help">リスト名の長さは 20 文字までです。</span>
             </dsp:form>
        </td>
      </tr>
