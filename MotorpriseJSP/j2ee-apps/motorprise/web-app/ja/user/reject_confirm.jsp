  ...
  <tr valign=top> 
    ...
    <tr valign=top>
      ...
      <tr valign=top>
        ...
        <tr><td class=box-top>&nbsp;拒否の確認</td></tr></table>
        </td>
      </tr>
       ...
       <td colspan=2>オーダーが拒否されました。</td>
        ...
        <dsp:droplet name="OrderLookup">
          ...
          <dsp:oparam name="output">
            ...
            <p><dsp:a href="approvals.jsp">承認に戻る</dsp:a>
            </td>
            </tr>
          </dsp:oparam>
        </dsp:droplet>
...
<%-- @version $Id: //product/B2BCommerce/version/10.0.3/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/ja/user/reject_confirm.jsp#2 $$Change: 651448 $--%>
