...
drop view dtg_view_search
drop table dtg_usr_gear_board
drop table dtg_gear_boards
drop table dtg_thread
drop table dtg_board
...
drop table plg_vote_mapper
drop table plg_gear_poll_rel
drop table plg_poll_response
drop table plg_poll
...
drop table bmg_bookmark
drop table bmg_folder_child
drop table bmg_bookmark_node
...
drop table cal_event_mapper
drop table cal_detail_event
drop table cal_base_event
...
drop table soap_user_conf
drop table soap_instn_conf
drop table soap_install_conf
drop table soap_conf_param
drop table soap_serv_param
drop table soap_serv_conf
...
drop table dex_split_file
drop table dex_split_doc
drop table dex_viewed_mapper
drop table dex_document
...
drop table fcg_remove_mapper
drop table fcg_added_mapper
drop table fcg_usercomm_rel
...
drop table paf_reg_url
drop table paf_usr_cm
drop table paf_usr_ppgfld
drop table paf_usr_cpgfld
drop table paf_usr_pgfld
drop table paf_usr_pg_rgn
drop table paf_usr_pg
drop table paf_usr_rgn_gr
drop table paf_usr_rgn
drop table paf_user_prmvals
drop table paf_gr_uparams
drop table paf_user_param
drop table paf_gu_params
drop table paf_gear_user
...
drop table b2b_org_info
drop table b2b_user_info
...
drop table dbc_promotion_ja
drop table dbc_prd_key_ja
drop table dbc_cat_key_ja
drop table dbc_config_opt_ja
drop table dbc_config_prop_ja
drop table dbc_sku_link_ja
drop table dbc_sku_ja
drop table dbc_product_ja
drop table dbc_category_ja
drop table dbc_catalog_ja
...
drop table dbc_promotion_de
drop table dbc_prd_key_de
drop table dbc_cat_key_de
drop table dbc_config_opt_de
drop table dbc_config_prop_de
drop table dbc_sku_link_de
drop table dbc_sku_de
drop table dbc_product_de
drop table dbc_category_de
drop table dbc_catalog_de
...
drop table b2b_cube_sku
drop table b2b_cylinder_sku
drop table b2b_oilfltr_sku
drop table b2b_sprkplg_sku
drop table b2b_hose_sku
drop table b2b_belt_sku
