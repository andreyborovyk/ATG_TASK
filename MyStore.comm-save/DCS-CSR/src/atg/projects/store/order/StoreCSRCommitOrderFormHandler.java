 ...
 *
 * @author ATG
 * @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/DCS-CSR/src/atg/projects/store/order/StoreCSRCommitOrderFormHandler.java#3 $$Change: 635816 $
...
public class StoreCSRCommitOrderFormHandler extends CSRCommitOrderFormHandler{
  ...
  public static String CLASS_VERSION = "$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/DCS-CSR/src/atg/projects/store/order/StoreCSRCommitOrderFormHandler.java#3 $$Change: 635816 $";
