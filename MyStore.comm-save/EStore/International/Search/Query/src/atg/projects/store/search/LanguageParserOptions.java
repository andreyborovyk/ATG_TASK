/*<ATGCOPYRIGHT>
 * Copyright (C) 2007-2010 Art Technology Group, Inc.
 ...
 *
 * @author ATG
 * @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/International/Search/Query/src/atg/projects/store/search/LanguageParserOptions.java#3 $$Change: 635816 $
...
public class LanguageParserOptions extends LoggingSupport {
   ...
   */
  //-------------------------------------
  public static final String CLASS_VERSION = "$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/International/Search/Query/src/atg/projects/store/search/LanguageParserOptions.java#3 $Change: 407408 $";
