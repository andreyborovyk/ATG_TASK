 ...
 * @author ATG
 * @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/International/src/atg/projects/store/catalog/InternationalizedStoreCatalogTools.java#3 $$Change: 635816 $ 
...
public class InternationalizedStoreCatalogTools extends StoreCatalogTools
{
   ...
   * Class version
   */
  public static String CLASS_VERSION = "$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/International/src/atg/projects/store/catalog/InternationalizedStoreCatalogTools.java#3 $$Change: 635816 $";
