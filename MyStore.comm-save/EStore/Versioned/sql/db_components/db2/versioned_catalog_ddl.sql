...
-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/Versioned/sql/db_components/db2/versioned_catalog_ddl.sql#3 $$Change: 635816 $
...
create table crs_category (
	...
	title_image_id	varchar(40)	default null
...
create table crs_product (
	...
	title_image_id	varchar(40)	default null,
	promo_image_id	varchar(40)	default null,
	detail_image_id	varchar(40)	default null,
