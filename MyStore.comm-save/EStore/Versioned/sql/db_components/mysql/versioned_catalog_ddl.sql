...
-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/Versioned/sql/db_components/mysql/versioned_catalog_ddl.sql#3 $$Change: 635816 $
...
create table crs_sku (
	...
	admin_display	nchar varchar(254)	null,
...
create table crs_clothing_sku (
	asset_version	numeric(19)	not null,
	sku_id	varchar(40)	not null,
	sku_size	nchar varchar(254)	null,
	color	nchar varchar(254)	null,
...
create table crs_furniture_sku (
	...
	sku_id	varchar(40)	not null,
	color_swatch	varchar(40)	null,
	wood_finish	nchar varchar(254)	null
...
create table crs_prod_seen_in (
	...
	display_name	nchar varchar(254)	null,
	description	text	null,
	source_name	nchar varchar(254)	null
...
create table crs_product (
	...
	product_id	varchar(40)	not null,
	is_new	tinyint	null,
	promo_tagline	nchar varchar(254)	null,
	brief_description	nchar varchar(254)	null,
	title_image_id	varchar(40)	null,
...
create table crs_feature (
	...
	version	integer	not null,
	feature_name	nchar varchar(254)	null,
	start_date	datetime	null,
	end_date	datetime	null,
	display_name	nchar varchar(254)	null,
	description	text	null,
