...
-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/Versioned/sql/db_components/oracle/versioned_catalog_ddl.sql#3 $$Change: 635816 $
...
create table crs_category (
	...
	title_image_id	varchar2(40)	null
...
create table crs_product (
	...
	detail_image_id	varchar2(40)	null,
