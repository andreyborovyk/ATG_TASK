...
-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/Versioned/sql/db_components/solid/versioned_storetext_ddl.sql#3 $$Change: 635816 $
...
, primary key (text_id,key_id,asset_version));
...
, primary key (text_id,asset_version));
