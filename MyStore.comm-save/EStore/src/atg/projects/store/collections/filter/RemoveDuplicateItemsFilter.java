 ...
 *
 * @author ATG
 * @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/collections/filter/RemoveDuplicateItemsFilter.java#3 $$Change: 635816 $
 *
 */
public class RemoveDuplicateItemsFilter extends CachedCollectionFilter
{

  public static final String CLASS_VERSION = "$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/collections/filter/RemoveDuplicateItemsFilter.java#3 $$Change: 635816 $";
