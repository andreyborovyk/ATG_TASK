 ...
 * 
 * @author ATG
 * @version $$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/order/purchase/StoreCouponFormHandler.java#3 $$$$Change: 635816 $$ 
...
public class StoreCouponFormHandler extends PurchaseProcessFormHandler {
   ...
   * Class version
   */
  public static String CLASS_VERSION = "$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/order/purchase/StoreCouponFormHandler.java#3 $$Change: 635816 $";
