 ...
 *
 * @author ATG
 * @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/pricing/StoreItemDiscountCalculator.java#3 $
 */
public class StoreItemDiscountCalculator extends ItemDiscountCalculator {

  /** Class version string. */
  public static String CLASS_VERSION = "$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/pricing/StoreItemDiscountCalculator.java#3 $$Change: 635816 $";
