...
GOTO Loop
  ...
  :-store
    ...
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/commerce/catalog/ProductCatalog -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/out-no18n-catalog.xml
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/commerce/pricing/priceLists/PriceLists -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/out-pricelists.xml
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/commerce/inventory/InventoryRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/out-inventory.xml
    ...
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/store/stores/StoreRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/stores.xml
    ...
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/seo/SEORepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/seo-tags.xml
  ...
  :-i18n
    ...
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -m Store.EStore.International -repository /atg/commerce/catalog/ProductCatalog -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/out-international-catalog.xml
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/commerce/pricing/priceLists/PriceLists -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/out-pricelists.xml
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/commerce/inventory/InventoryRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/out-inventory.xml
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/userprofiling/ProfileAdapterRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/users.xml
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/store/stores/StoreRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/stores.xml
  ...
  :-search
    ...
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -m DCS.Search.CustomCatalogs -repository /atg/search/repository/RefinementRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/out-facets.xml
  ...
  :-i18nsearch
    ...
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -m Store.EStore.International -m DCS.Search.CustomCatalogs -repository /atg/search/repository/RefinementRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/out-international-facets.xml
