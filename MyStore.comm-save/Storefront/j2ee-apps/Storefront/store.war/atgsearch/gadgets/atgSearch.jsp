<dsp:page>
  ...
  <dsp:form method="post" formid="searchform" id="searchForm" action="${contextroot}/atgsearch/gadgets/atgSearch.jsp">
    ...
    <input type="hidden" id="questionSaved" name="questionSaved" value="${question}"/>

    <input type="hidden" id="catIdSaved" name="catIdSaved" value="${param.categoryId}"/>
...
<%-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/Storefront/j2ee-apps/Storefront/store.war/atgsearch/gadgets/atgSearch.jsp#3 $$Change: 635816 $ --%>
