...
<dsp:page>
  ...
  <dsp:droplet name="SharingSitesDroplet">
    ...
    <dsp:oparam name="output">
      ...
      <dsp:droplet name="SharingSitesDroplet">
      <dsp:param name="shareableTypeId" value="com.mystore.reward"/>
      <dsp:oparam name="output">
...
<%-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/Storefront/j2ee-apps/Storefront/store.war/navigation/gadgets/sites.jsp#3 $$Change: 635816 $ --%>