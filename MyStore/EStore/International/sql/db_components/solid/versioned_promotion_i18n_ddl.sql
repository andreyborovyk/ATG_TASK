...
-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/International/sql/db_components/solid/versioned_promotion_i18n_ddl.sql#3 $$Change: 635816 $
...
alter table crs_prm_xlate set pessimistic;
...
create table crs_prm_prm_xlate (
	...
	translation_id	varchar(40)	not null
, primary key (promotion_id,locale,asset_version));

create index crs_prm_xlt_tr_id on crs_prm_prm_xlate (translation_id);
alter table crs_prm_prm_xlate set pessimistic;
...
alter table crs_cq_xlate set pessimistic;
...
create table crs_cq_cq_xlate (
	...
	locale	varchar(40)	not null,
	translation_id	varchar(40)	not null
, primary key (close_qualif_id,locale,asset_version));

create index crs_cq_xlt_tr_id on crs_cq_cq_xlate (translation_id);
alter table crs_cq_cq_xlate set pessimistic;
