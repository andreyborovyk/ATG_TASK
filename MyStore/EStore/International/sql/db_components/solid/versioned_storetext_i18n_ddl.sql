...
-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/International/sql/db_components/solid/versioned_storetext_i18n_ddl.sql#3 $$Change: 635816 $
...
create table crs_txt_txt_xlate (
	...
	translation_id	varchar(254)	not null
, primary key (text_id,locale,asset_version));
