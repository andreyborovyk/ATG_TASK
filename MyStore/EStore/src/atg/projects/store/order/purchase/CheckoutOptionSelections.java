 ...
 *
 * @author
 * @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/order/purchase/CheckoutOptionSelections.java#3 $
 */
public class CheckoutOptionSelections {

  /** Class version string. */
  public static String CLASS_VERSION = "$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/order/purchase/CheckoutOptionSelections.java#3 $$Change: 635816 $";
