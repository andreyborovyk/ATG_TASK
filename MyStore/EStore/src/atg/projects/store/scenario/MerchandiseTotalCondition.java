...
public class MerchandiseTotalCondition extends ExpressionFilter {
  ...
  public static String CLASS_VERSION = "$Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/EStore/src/atg/projects/store/scenario/MerchandiseTotalCondition.java#3 $$Change: 635816 $";
  ...
  public void initialize(String pOperator, Expression[] pOperands)
    ...
    try {
      ...
      throw new ProcessException("Test type had unexpected type: " + value.getClass().getName());
    }
    ...
    try {
      ...
      throw new ProcessException("Amount had unexpected type: " + value.getClass().getName());
    }
