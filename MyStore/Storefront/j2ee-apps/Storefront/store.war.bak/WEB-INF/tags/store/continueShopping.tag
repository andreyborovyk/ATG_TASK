...
<%@ variable name-given="continueShoppingURL" variable-class="java.lang.String" %>
  ...
  <jsp:doBody/>
<%-- @version $Id: //edu/ILT-Courses/main/COMM/StudentFiles/COM/setup/copy-files/apps/MyStore/Storefront/j2ee-apps/Storefront/store.war/WEB-INF/tags/store/continueShopping.tag#3 $$Change: 635816 $--%>
