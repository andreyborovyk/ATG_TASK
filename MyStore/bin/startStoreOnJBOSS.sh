...
ATG_APPS_FILE="${JBOSS_HOME}/server/${JBOSS_SERVER}/deploy/atg-apps-solid-ds.xml"
...
if [ ! -f ${ATG_SOLID_FILE} ]; then
    cp ${DYNAMO_HOME}/../DafEar/Tomcat/copy-to-jboss_home-your_server-deploy-dir/atg-solid-ds.xml ${ATG_SOLID_FILE}
fi

if [ ! -f ${ATG_APPS_FILE} ]; then
    cp ${DYNAMO_HOME}/../DafEar/Tomcat/copy-to-jboss_home-your_server-deploy-dir/atg-apps-solid-ds.xml ${ATG_APPS_FILE}
fi
