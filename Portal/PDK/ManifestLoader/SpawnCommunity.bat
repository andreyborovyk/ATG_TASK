...
REM This script requires the full path to a manifest file and the 
REM repository ID of the gear definition folder. 
REM 
...
%JAVA_VM% %JAVA_ARGS% atg.portal.util.ManifestLoader SpawnCommunity -startDir %OWD% %*
