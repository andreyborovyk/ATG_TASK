 ...
 *
 * @author Andy Jacobs
 * @version $Id: //app/portal/version/10.0.3/alert/alertTaglib.jar/src/atg/portal/gear/alert/taglib/GetAlertsTEI.java#2 $$Change: 651448 $
...
public class GetAlertsTEI extends TagExtraInfo 
{

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //app/portal/version/10.0.3/alert/alertTaglib.jar/src/atg/portal/gear/alert/taglib/GetAlertsTEI.java#2 $$Change: 651448 $";
    ...
    return new VariableInfo[]
      {
        new VariableInfo(pData.getId(),
                         "atg.portal.gear.alert.taglib.GetAlertsTag",
                         true,
                         VariableInfo.NESTED)
      };
  }
