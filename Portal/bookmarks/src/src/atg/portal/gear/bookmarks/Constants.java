 ...
 *
 * @author Will Sargent
 * @version $Id: //app/portal/version/10.0.3/bookmarks/src/atg/portal/gear/bookmarks/Constants.java#2 $$Change: 651448 $
...
class Constants
{
    ...
    public static String CLASS_VERSION = "$Id: //app/portal/version/10.0.3/bookmarks/src/atg/portal/gear/bookmarks/Constants.java#2 $$Change: 651448 $";
    ...
    public static final String NULL_FOLDER_ID = "NULL_FOLDER_ID";
    ...
    public static final String NO_PROTOCOL_TYPES = "NO_PROTOCOL_TYPES";
    ...
    static public String format(String pMsgKey, Object pArgs[])
    {
        ...
        System.out.println("resource bundle name = " + getResourceBundleName());
        try
        {
