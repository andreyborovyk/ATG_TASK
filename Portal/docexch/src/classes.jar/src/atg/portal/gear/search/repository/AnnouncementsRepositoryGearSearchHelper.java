...
/**
 * This is the implementation of RepositoryGearSearchHelper for Announcements
 * Gear.
 * @author Malay Desai
 * @version $Id: //app/portal/version/10.0.3/docexch/classes.jar/src/atg/portal/gear/search/repository/AnnouncementsRepositoryGearSearchHelper.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */
public class AnnouncementsRepositoryGearSearchHelper implements RepositoryGearSearchHelper 
{
  //-------------------------------------
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //app/portal/version/10.0.3/docexch/classes.jar/src/atg/portal/gear/search/repository/AnnouncementsRepositoryGearSearchHelper.java#2 $$Change: 651448 $";
  ...
  {
    return new GearDefinitionKey("Announcements", null, null);
  }
