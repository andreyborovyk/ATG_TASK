  ...
  <table border="0" width="96%" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td valign="top" width="25%">
        <c:set var="gears" value="${regionMap['25_50_25_Left'].gears}"/>
      ...
      <td valign="top" width="50%">
        <c:set var="gears" value="${regionMap['25_50_25_Middle'].gears}"/>
        <%@ include file="region.jspf" %> 
      </td>
      ...
      <td valign="top" width="25%">
        <c:set var="gears" value="${regionMap['25_50_25_Right'].gears}"/>
        <%@ include file="region.jspf" %> 
      </td>
    </tr>
  </table>
...
<%-- @version $Id: //app/portal/version/10.0.3/paf/portal.war/templates/layout/html/25_50_25.jsp#2 $$Change: 651448 $--%>
