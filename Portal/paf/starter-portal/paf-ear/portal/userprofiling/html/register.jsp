        ...
        <dsp:form action="${actionURL}" method="post">
          ...
          <table border="0">
    	    ...
    	    <tr>
              ...
              <td><dsp:input id="confirmpassword" type="password" size="35" maxsize="35" bean="ProfileFormHandler.value.confirmpassword"/></td>
            </tr>

            <fmt:message var="registerbutton" key="register-button-submit" bundle="${userprofilingbundle}"/>
            <tr>
              <td valign="middle" align="right"></td>
              <td><dsp:input type="submit" value="${registerbutton}" bean="ProfileFormHandler.create"/></td>
            </tr>
          </table>
...
<%-- @version $Id: //app/portal/version/10.0.3/paf/portal.war/userprofiling/html/register.jsp#2 $$Change: 651448 $--%>
