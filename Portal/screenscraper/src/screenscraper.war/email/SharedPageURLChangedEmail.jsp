...
<i18n:message id="emailSubject2"    key="SUBJECT_SS_SHARED_CHANGED" />
...
<BODY BGCOLOR="#FFFFFF">
<h3><i18n:message  key="BODY_HEADER_SHARED_CHANGED"/></h3>

<i18n:message  key="BODY_CONTENT_SHARED_CHANGED">
...
<%-- @version $Id: //app/portal/version/10.0.3/screenscraper/screenscraper.war/email/SharedPageURLChangedEmail.jsp#2 $$Change: 651448 $--%>
