 ...
 * @version $Id: //app/portal/version/10.0.3/soapclient/classes.jar/src/atg/service/wsdl/WSDLSOAPParameter.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 */

public class WSDLSOAPParameter
{
  ...
  public static String CLASS_VERSION = "$Id: //app/portal/version/10.0.3/soapclient/classes.jar/src/atg/service/wsdl/WSDLSOAPParameter.java#2 $$Change: 651448 $";
   ...
   */
  public void setParameterClassType(String pParameterClassType) {
   ...
   *
   */
  public WSDLSOAPParameter() {
  }
  
  /**
   * Convenience method to create a WSDLSOAPParameter.
   *
   ...
   */
  public WSDLSOAPParameter(String pParameterName, String pParameterClassType,
