<!-- BEGIN FILE action_undelete_site.jsp -->
...
<body class="actionContent">
	...
	<h3>   <fmt:message key="sure-undelete-site" bundle="${depBundle}"> 
  ...
  <c:set var="undeleteFormId" value="undeleteTargetForm-${targetDef.ID}"/>
	...
	<td class="buttonImage"><a href="javascript:parent.showIframe('undeleteSiteAction')" class="mainContentButton delete" onmouseover="status='';return true;">    <fmt:message key="cancel" bundle="${depBundle}"/></a></td>		
...
<!-- END FILE action_undelete_site.jsp -->
<%-- @version $Id: //product/PubPortlet/version/10.0.3/portlets.war/html/DeploymentPortlet/config/iframes/action_undelete_site.jsp#2 $$Change: 651448 $--%>
