...
<body class="actionContent">
	...
	<h3>    <fmt:message key="cancel-prompt" bundle="${depBundle}"/></h3>
	</div>
	...
	<td class="buttonImage"><a href="javascript:parent.showIframe('cancelDeploymentAction')" class="mainContentButton delete" onmouseover="status='';return true;">    <fmt:message key="cancel" bundle="${depBundle}"/></a></td>		
...
<%-- @version $Id: //product/PubPortlet/version/10.0.3/portlets.war/html/DeploymentPortlet/site/iframes/action_cancel_deployment.jsp#2 $$Change: 651448 $--%>
