...
<!-- Begin BIZUI's /views/item/gsa/media/mediaInternalBinaryEdit.jsp -->
...
<c:if test="${ !empty propView.uri}">
  ...
  <dspel:input type="file" bean="${imap.formHandler.path}.uploadedFile"  />
  </td>
...
<!-- End BIZUI's /views/item/gsa/media/mediaInternalBinaryEdit.jsp -->
<%-- @version $Id: //product/BIZUI/version/10.0.3/jsp-src/views/item/gsa/media/mediaInternalBinaryEdit.jsp#2 $$Change: 651448 $--%>
