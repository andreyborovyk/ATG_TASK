...
<!-- Begin BIZUI's /views/item/gsa/media/mediaInternalTextEdit.jsp -->
...
<%-- @version $Id: //product/BIZUI/version/10.0.3/jsp-src/views/item/gsa/media/mediaInternalTextEdit.jsp#2 $$Change: 651448 $--%>
