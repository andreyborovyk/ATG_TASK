<%--
  Array property editor -- applies to properties of any type
...
<tr>
  ...
  <script language="JavaScript">
    ...
    var collData = collectionRegister( "<c:out value="${mpv.uniqueId}"/>", "array", "<c:out value="${collValueProperty}"/>", "<c:out value="${collNullProperty}"/>");
...
<%-- @version $Id: //product/BIZUI/version/10.0.3/jsp-src/views/property/array/arrayEdit.jsp#2 $$Change: 651448 $--%>
