<%--
  Default view-mode view for date data, uses JSTL formatDate
...
<%-- @version $Id: //product/BIZUI/version/10.0.3/jsp-src/views/property/date/simpleView.jsp#2 $$Change: 651448 $--%>
