...
<script language="JavaScript">
  ...
  function collectionDrawItem_<c:out value="${mpv.uniqueId}"/> (fieldId, fieldValue, fieldDisplayName) {
    ...
    tempHTML +=        'size="<c:out value="${mpv.attributes.inputFieldSize}"/>" ';
    tempHTML +=        'maxlength="<c:out value="${mpv.attributes.inputFieldMaxlength}"/>" '; 
...
<%-- @version $Id: //product/BIZUI/version/10.0.3/jsp-src/views/property/enumerated/pulldownMenuComponentEdit.jsp#2 $$Change: 651448 $--%>
