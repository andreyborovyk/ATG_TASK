<%--
  Default view-mode view for timestamp data, uses JSTL formatDate
...
<tr>
  ...
  <dspel:getvalueof bean="${mpv.formHandlerProperty}" var="timestamp"/>
  <c:choose>
...
<%-- @version $Id: //product/BIZUI/version/10.0.3/jsp-src/views/property/timestamp/simpleView.jsp#2 $$Change: 651448 $--%>
