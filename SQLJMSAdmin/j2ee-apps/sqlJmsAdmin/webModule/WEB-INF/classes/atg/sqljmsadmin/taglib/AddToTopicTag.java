...
/****************************************
 * add some entries to a topic
 *
 * @author Stephen Abramson <stephena@atg.com>
 * @version $Id: //product/DAS/version/10.0.3/release/SQLJMSAdmin/j2ee-apps/sqlJmsAdmin/webModule/WEB-INF/classes/atg/sqljmsadmin/taglib/AddToTopicTag.java#2 $$Change: 651448 $
 * @updated $DateTime: 2011/06/07 13:55:45 $$Author: rbarbier $
 ****************************************/

public class AddToTopicTag
    extends DMSGenericTag
{
    //----------------------------------------
    /** Class version string */
    public static String CLASS_VERSION =
        "$Id: //product/DAS/version/10.0.3/release/SQLJMSAdmin/j2ee-apps/sqlJmsAdmin/webModule/WEB-INF/classes/atg/sqljmsadmin/taglib/AddToTopicTag.java#2 $$Change: 651448 $";

    //----------------------------------------
    // TEI
    //----------------------------------------
    public static class AddToTopicTEI 
	...
	public VariableInfo[] getVariableInfo(TagData pTagData)
	{
		...
		new VariableInfo(pTagData.getId(),
				 "atg.sqljmsadmin.taglib.AddToTopicTag",
				 true,
				 VariableInfo.NESTED)
		    };
	}
    ...
    //----------------------------------------
    /**
     * Constructs an instanceof AddToTopicTag
     */
    public AddToTopicTag()
    {
	...
	throws JspException
    {
	if(mMessageIds == null || mMessageIds.length == 0 || mTopic == null)
	    return SKIP_BODY;

	try {
	    mTopic.addTopicEntries(mMessageIds, mDuplicateMessages);
	}
