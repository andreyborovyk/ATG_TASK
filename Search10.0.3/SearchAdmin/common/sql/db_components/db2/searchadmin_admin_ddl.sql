...
create table srch_adv_conf (
	...
	conf	long varchar	default null
,constraint srch_adv_conf_p primary key (id));


create table srch_project (
	id	varchar(40)	not null,
	srch_idx_id	varchar(40)	default null,
	cur_srch_idx_id	varchar(40)	default null,
	name	varchar(254)	not null,
	description	varchar(254)	default null,
	min_inact_idxs	smallint	default null,
	preserve_cnt	smallint	default null,
	preserve_age	smallint	default null,
	srch_adv_c_id	varchar(40)	default null,
	force_full_index	numeric(1)	default null,
	cached_cust	blob	default null,
	no_content	numeric(1)	default 0 not null
...
create table srch_reg_impl (
	id	varchar(40)	not null,
	intface	varchar(254)	default null,
	classname	varchar(254)	default null,
	classloader	varchar(254)	default null,
...
create table srch_content (
	id	varchar(40)	not null,
	name	varchar(254)	default null,
	srch_content_id	varchar(40)	default null,
	srch_adv_c_id	varchar(40)	default null,
	handservice	varchar(254)	default null
...
create table srch_content_ss (
	...
	srch_content_ss_id	varchar(40)	default null,
	structured	integer	default null,
	force_con_type	numeric(1)	default null,
	srch_log_part_id	varchar(40)	default null,
	srch_adv_c_id	varchar(40)	default null,
	doc_set_subpath	varchar(254)	default null
...
create table srch_platform (
	...
	maxpartsize	bigint	default null
,constraint srch_platform_p primary key (id));


create table srch_act_idx_v (
	id	varchar(40)	not null,
	srch_platform_id	varchar(40)	default null,
	majorversion	bigint	default null,
	minorversion	bigint	default null,
	charsize	integer	default null
...
create table srch_sync_step_type (
	...
	name	varchar(254)	not null,
	enum	smallint	default null,
	super_step_enum	smallint	default null
...
create table srch_base_sync_task (
	...
	subname	varchar(254)	default null,
	srch_adv_c_id	varchar(40)	default null,
	is_all_css	numeric(1)	default 0,
	is_all_custom_data	numeric(1)	default 0,
	is_pause	numeric(1)	default 0 not null,
	src_srch_idx_id	varchar(40)	default null,
	srch_project_id	varchar(40)	not null
...
create table srch_sync_task (
	...
	index_id	varchar(40)	default null,
	start_tstamp	timestamp	not null,
	end_tstamp	timestamp	default null
...
create table srch_sync_task_def (
	...
	last_modified	timestamp	default null,
	base_sync_task_id	varchar(40)	not null,
	enabled	numeric(1)	default null,
	description	varchar(254)	default null,
	schedule	varchar(254)	default null,
	depl_type	varchar(20)	default null,
	depl_target	varchar(255)	default null
...
create table srch_hist_step (
	id	varchar(40)	not null,
	step_definition_id	varchar(40)	default null,
...
create table srch_step_error (
	...
	content_id	long varchar	default null,
	error_type	smallint	not null,
	error_message	long varchar	default null,
	cause	long varchar	default null,
	engine_resp	long varchar	default null
...
create table srch_history (
	id	varchar(40)	not null,
	act_part_size	numeric(12,0)	default null,
	est_part_size	numeric(12,0)	default null,
	est_psiz_uppr	numeric(12,0)	default null,
	est_psiz_lowr	numeric(12,0)	default null,
	item_count	integer	default null,
	start_time	timestamp	default null,
	end_time	timestamp	default null,
	succeeded	numeric(1)	default null
...
create table srch_project_custom_ds (
	id	varchar(40)	not null,
	srch_project_id	varchar(40)	default null
...
create table srch_sync_task_custom_ds (
	id	varchar(40)	not null,
	srch_sync_task_id	varchar(40)	default null
...
create table srch_project_custom_dsm (
	srch_project_id	varchar(40)	not null,
	idx	integer	not null,
	srch_project_custom_ds_id	varchar(40)	default null
...
create table srch_css_custom_dsm (
	srch_content_ss_id	varchar(40)	not null,
	idx	integer	not null,
	srch_csscust_ds_id	varchar(40)	default null
...
create table srch_file (
	...
	gnumber	varchar(40)	default null
