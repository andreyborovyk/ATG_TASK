...
create table srch_content_ss (
	...
	srch_adv_c_id	varchar(40)	null,
	doc_set_subpath	nvarchar(254)	null
...
create table srch_step_error (
	...
	error_message	longtext charset utf8	null,
	cause	longtext charset utf8	null,
	engine_resp	longtext charset utf8	null
...
create table srch_file (
	id	varchar(40)	not null,
	srch_content_id	varchar(40)	not null,
	name	longtext charset utf8	not null,
