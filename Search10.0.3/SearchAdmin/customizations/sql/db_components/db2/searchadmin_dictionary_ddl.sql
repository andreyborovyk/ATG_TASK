...
create table srch_dic_dict (
	...
	dic_dict_desc	varchar(1000)	default null,
	dic_dict_language	varchar(200)	not null,
	dic_dict_load_mode	varchar(200)	not null,
	dict_adapter_name	varchar(200)	default null,
	dic_dict_max_exp	integer	default null,
...
create table srch_dic_trm (
	...
	dic_trm_pt_id	varchar(40)	default null,
	dic_trm_seq	integer	default null,
	dic_trm_name	varchar(200)	not null,
	dic_trm_propagate	numeric(1)	not null,
	dic_trm_spch_part	varchar(200)	not null,
	dic_trm_phr_type	varchar(40)	not null,
	dic_trm_weight	smallint	default null,
	dic_trm_norm_name	varchar(200)	default null
...
create table srch_dic_syn (
	...
	dic_syn_pt_id	varchar(40)	default null,
	dic_syn_name	varchar(200)	not null,
	dic_syn_relation	varchar(200)	not null,
	dic_syn_spch_part	varchar(200)	default null,
	dic_syn_phr_type	varchar(40)	not null,
	dic_syn_language	varchar(200)	default null,
	dic_syn_weight	smallint	default null,
	dic_syn_norm_name	varchar(200)	default null
