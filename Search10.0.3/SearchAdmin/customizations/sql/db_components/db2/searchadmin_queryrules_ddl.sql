...
create table srch_qr_sets (
	...
	qr_set_dsc	varchar(1000)	default null,
	qr_set_lst_mdf	date	default null
...
create table srch_qr_groups (
	...
	qr_grp_pt_id	varchar(40)	default null,
	qr_grp_seq	integer	default null,
...
create table srch_qr (
	...
	qr_prn_grp_id	varchar(40)	default null,
	qr_seq	integer	default null,
...
create table srch_qr_patterns (
	...
	qr_ptrn_qr_id	varchar(40)	default null,
	qr_ptrn_is_enbl	numeric(1)	not null,
	qr_ptrn_name	varchar(200)	not null,
	qr_ptrn_weight	integer	default null,
	qr_ptrn_grp	varchar(200)	default null,
...
create table srch_qr_actions (
	...
	qr_act_qr_id	varchar(40)	default null,
	qr_act_is_enbl	numeric(1)	not null,
