...
create table srch_tpo_sets (
	...
	tpo_set_desc	varchar(254)	default null,
	tpo_set_created	date	default null,
	tpo_set_date	date	default null,
	tpo_set_level	integer	not null,
	tpo_set_project_id	varchar(40)	default null
...
create table srch_tpo_values (
	...
	tpo_value_item	varchar(100)	default null,
