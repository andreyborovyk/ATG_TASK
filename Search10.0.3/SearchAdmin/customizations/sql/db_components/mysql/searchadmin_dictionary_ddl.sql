...
create table srch_dic_dict (
	...
	dic_dict_name	nvarchar(200)	not null,
	dic_dict_desc	nvarchar(1000)	null,
	dic_dict_language	varchar(200)	not null,
	dic_dict_load_mode	varchar(200)	not null,
	dict_adapter_name	nvarchar(200)	null,
...
create table srch_dic_trm (
	...
	dic_trm_name	nvarchar(200)	not null,
	...
	dic_trm_norm_name	nvarchar(200)	null
...
create table srch_dic_syn (
	...
	dic_syn_name	nvarchar(200)	not null,
	...
	dic_syn_norm_name	nvarchar(200)	null
