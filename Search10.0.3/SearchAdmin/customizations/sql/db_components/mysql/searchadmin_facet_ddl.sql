...
create table srch_facet_set (
	...
	facet_set_name	nvarchar(254)	not null,
	facet_set_desc	nvarchar(254)	null,
...
create table srch_facet_set_mapping (
	...
	facet_set_mapping	nvarchar(254)	not null,
...
create table srch_facet_item (
	...
	facet_item_pres	nvarchar(254)	null
...
create table srch_facet_spec (
	...
	facet_spec_value	nvarchar(254)	not null
...
create table srch_facet_exc (
	...
	facet_exc_value	nvarchar(254)	not null
...
create table srch_facet_rngs (
	...
	facet_rngs_value	nvarchar(254)	not null
