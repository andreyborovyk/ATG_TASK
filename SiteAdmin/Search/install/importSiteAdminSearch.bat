...
:homedone
  ...
  call bin\startSQLRepository.bat -m BIZUI -repository /atg/web/viewmapping/ViewMappingRepository -import "%DYNAMO_HOME%\..\SiteAdmin\Search\install\data\viewmapping.xml"
