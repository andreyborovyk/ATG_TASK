...
create table tkt_ticket (
	...
	inbound_chan_addr	varchar(254)	null,
...
create table tkt_act_message (
	...
	cc_address	varchar(254)	null,
	bcc_address	varchar(254)	null,
	reply_to_addr	varchar(254)	null,
...
create table tkt_attachment (
	...
	encoded_content	image	not null
