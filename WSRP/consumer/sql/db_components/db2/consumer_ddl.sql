...
create table wsrpc_prtlt_dsc (
	...
	group_id	varchar(4000)	default null,
	...
	uses_method_get	numeric(1)	default null,
	dflt_mrkp_secur	numeric(1)	default null,
	only_secure	numeric(1)	default null,
	usr_ctxin_sessn	numeric(1)	default null,
	tmplts_in_sessn	numeric(1)	default null,
	has_usr_spec_st	numeric(1)	default null,
	does_url_templt	numeric(1)	default null,
...
create table wsrpc_producer (
	...
	producer_url	varchar(1024)	default null,
	producer_dsc	varchar(1024)	default null,
	reg_url	varchar(1024)	default null,
	serv_desc_url	varchar(1024)	not null,
	markup_url	varchar(1024)	not null,
	prtlt_mgmt_url	varchar(1024)	default null,
	reg_handle	varchar(255)	default null,
	reg_state	blob(1048576)	default null,
...
create table wsrpc_regn_info (
	...
	get_supported	numeric(1)	not null
