...
create table wsrpc_mrkp_mode (
	markup_type_id	varchar2(40)	not null,
	markup_mode_id	varchar2(255)	not null
...
create table wsrpc_mrkp_wnst (
	markup_type_id	varchar2(40)	not null,
	mrkp_winstat_id	varchar2(40)	not null
...
create table wsrpc_mrkp_lcle (
	markup_type_id	varchar2(40)	not null,
	mrkp_locale_id	varchar2(40)	not null
...
create table wsrpc_prtlt_dsc (
	...
	uses_method_get	number(1)	null,
	dflt_mrkp_secur	number(1)	null,
	only_secure	number(1)	null,
	usr_ctxin_sessn	number(1)	null,
	tmplts_in_sessn	number(1)	null,
	has_usr_spec_st	number(1)	null,
	does_url_templt	number(1)	null,
...
create table wsrpc_usr_ctgrs (
	prtlt_dsc_id	varchar2(40)	not null,
	user_category	varchar2(40)	not null
...
create table wsrpc_usrpr_itm (
	prtlt_dsc_id	varchar2(40)	not null,
	usr_profile_itm	varchar2(40)	not null
...
create table wsrpc_producer (
	producer_id	varchar2(40)	not null,
	name	varchar2(255)	not null,
	producer_url	varchar2(1024)	null,
	producer_dsc	varchar2(1024)	null,
	reg_url	varchar2(1024)	null,
	serv_desc_url	varchar2(1024)	not null,
	markup_url	varchar2(1024)	not null,
	prtlt_mgmt_url	varchar2(1024)	null,
	reg_handle	varchar2(255)	null,
	reg_state	blob	null,
...
create table wsrpc_regn_info (
	regn_info_id	varchar2(40)	not null,
	name	varchar2(255)	not null,
	agent	varchar2(255)	not null,
	get_supported	number(1)	not null
...
create table wsrpc_modes (
	regn_info_id	varchar2(40)	not null,
	portlet_mode	varchar2(40)	not null
...
create table wsrpc_windw_sts (
	regn_info_id	varchar2(40)	not null,
	window_state	varchar2(40)	not null
...
create table wsrpc_usr_scops (
	regn_info_id	varchar2(40)	not null,
	user_scope	varchar2(40)	not null
...
create table wsrpc_usrpr_dat (
	regn_info_id	varchar2(40)	not null,
	usr_prf_data	varchar2(40)	not null
