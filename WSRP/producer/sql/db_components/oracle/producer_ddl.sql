...
create table wsrpp_prpty_dsc (
	property_dsc_id	varchar2(40)	not null,
	name	varchar2(100)	not null,
	type	varchar2(100)	not null,
	label	varchar2(100)	null,
	label_xml_lang	varchar2(32)	null,
	label_res_name	varchar2(100)	null,
	ppty_hint	varchar2(255)	null,
	hint_xml_lang	varchar2(32)	null,
	hint_res_name	varchar2(100)	null
,constraint wsrpp_prpty_dsc_p primary key (property_dsc_id));


create table wsrpp_mod_desc (
	model_id	varchar2(40)	not null,
	extension	varchar2(32)	null
...
create table wsrpp_rgprp_dsc (
	...
	property_dsc_id	varchar2(40)	null
...
create table wsrpp_res_list (
	res_list_id	varchar2(40)	not null,
	extension	varchar2(32)	null
...
create table wsrpp_item_dsc (
	item_dsc_id	varchar2(40)	not null,
	item_name	varchar2(100)	not null,
	description	varchar2(512)	null,
	dsc_xml_lang	varchar2(32)	null,
	dsc_res_name	varchar2(100)	null
,constraint wsrpp_item_dsc_p primary key (item_dsc_id));


create table wsrpp_mrkp_type (
	markup_type_id	varchar2(40)	not null,
...
create table wsrpp_mrkp_mode (
	markup_type_id	varchar2(40)	not null,
	markup_mode_id	varchar2(40)	not null
...
create table wsrpp_mrkp_wnst (
	markup_type_id	varchar2(40)	not null,
	mrkp_wndst_id	varchar2(40)	not null
...
create table wsrpp_mrkp_lcle (
	markup_type_id	varchar2(40)	not null,
	markup_locale_id	varchar2(40)	not null
...
create table wsrpp_cncrt_prt (
	cncrt_prtlt_id	varchar2(40)	not null,
	type	number(10)	null
...
create table wsrpp_prtlt_dsc (
	prtlt_dsc_id	varchar2(40)	not null,
	handle	varchar2(100)	not null,
	portlet_type	number(10)	not null,
	group_id	varchar2(100)	null,
	description	varchar2(512)	null,
	dsc_xml_lang	varchar2(32)	null,
	dsc_res_name	varchar2(100)	null,
	short_title	varchar2(255)	null,
	shtitl_xml_lang	varchar2(32)	null,
	shtitl_res_name	varchar2(100)	null,
	title	varchar2(255)	null,
	title_xml_lang	varchar2(32)	null,
	title_res_name	varchar2(100)	null,
	display_name	varchar2(255)	null,
	dspnam_xml_lang	varchar2(32)	null,
	dspnam_res_name	varchar2(100)	null,
	uses_method_get	number(1)	default 0 null,
	dflt_mrkp_secur	number(1)	default 0 null,
	only_secure	number(1)	default 0 null,
	usr_ctxin_sessn	number(1)	default 0 null,
	tmplts_in_sessn	number(1)	default 0 null,
	has_usr_spec_st	number(1)	default 0 null,
	does_url_templt	number(1)	default 0 null,
	cncrt_prtlt_id	varchar2(40)	not null
...
create table wsrpp_usr_ctgrs (
	prtlt_dsc_id	varchar2(40)	not null,
	user_category	varchar2(100)	not null
...
create table wsrpp_usrpr_itm (
	prtlt_dsc_id	varchar2(40)	not null,
	usr_profle_item	varchar2(100)	not null
...
create table wsrpp_serv_desc (
	...
	requires_reg	number(1)	default 0 null,
	req_init_cookie	number(10)	null,
	model_id	varchar2(40)	null,
	res_list_id	varchar2(40)	null
...
create table wsrpp_off_prtlt (
	service_id	varchar2(40)	not null,
	portlet_id	varchar2(40)	not null
...
create table wsrpp_urct_idsc (
	service_id	varchar2(40)	not null,
	description_id	varchar2(40)	not null
...
create table wsrpp_postal (
	postal_id	varchar2(40)	not null,
	name	varchar2(255)	null,
	street	varchar2(255)	null,
	city	varchar2(255)	null,
	stateprov	varchar2(255)	null,
	postalcode	varchar2(64)	null,
	country	varchar2(255)	null,
	porganization	varchar2(255)	null
,constraint wsrpp_postal_p primary key (postal_id));


create table wsrpp_telenum (
	telenum_id	varchar2(40)	not null,
	intcode	varchar2(32)	null,
	loccode	varchar2(32)	null,
	tel_number	varchar2(32)	null,
...
create table wsrpp_telecom (
	telecom_id	varchar2(40)	not null,
	telenphone_id	varchar2(40)	null,
	fax_id	varchar2(40)	null,
	mobile_id	varchar2(40)	null,
	pager_id	varchar2(40)	null
...
create table wsrpp_online (
	online_id	varchar2(40)	not null,
...
create table wsrpp_contact (
	...
	name_prefix	varchar2(255)	null,
	givenname	varchar2(255)	null,
	familyname	varchar2(255)	null,
	middlename	varchar2(255)	null,
	suffix	varchar2(255)	null,
	company	varchar2(255)	null,
	title	varchar2(255)	null,
	postal_id	varchar2(40)	null,
	telecom_id	varchar2(40)	null,
	online_id	varchar2(40)	null,
...
create table wsrpp_consumer (
	consumer_id	varchar2(40)	not null,
	name	varchar2(255)	not null,
	handle	varchar2(100)	not null,
	agent	varchar2(255)	not null,
	get_supported	number(1)	default 0 not null,
	locale	number(10)	null,
	lastactivity_dt	date	null,
	reg_date	date	null,
	last_modfd_dt	date	null,
...
create table wsrpp_modes (
	consumer_id	varchar2(40)	not null,
	portlet_mode	varchar2(100)	not null
...
create table wsrpp_windw_sts (
	consumer_id	varchar2(40)	not null,
	window_state	varchar2(100)	not null
...
create table wsrpp_usr_scops (
	consumer_id	varchar2(40)	not null,
	user_scope	varchar2(100)	not null
...
create table wsrpp_usrpr_dat (
	consumer_id	varchar2(40)	not null,
	usr_prfle_data	varchar2(100)	not null
