...
dojo._hasResource["atg.widget.form.Button"] = true;
dojo.provide("atg.widget.form.Button");


dojo.require("atg.widget.form._FormWidget");
dojo.require("dijit._Container");

dojo.declare("atg.widget.form.Button", atg.widget.form._FormWidget, {
/*
 * usage
 *	<button dojoType="button" onClick="...">Hello world</button>
 *
 *  var button1 = new atg.widget.form.Button({label: "hello world", onClick: foo});
 ...
 *
 *  var button1 = new atg.widget.form.DropDownButton({ label: "hi", dropDown: new dijit.Menu(...) });
 *	dojo.body().appendChild(button1);
 */
dojo.declare("atg.widget.form.DropDownButton", [atg.widget.form.Button, dijit._Container], {
	// summary
	...
	_fillContent: function(){
		...
		if(this.srcNodeRef){ // programatically created buttons might not define srcNodeRef
			...
			atg.widget.form.DropDownButton.superclass._fillContent.call(this, nodes[0]);
 ...
 *
 *  var button1 = new atg.widget.form.ComboButton({label: "hello world", onClick: foo, dropDown: "myMenu"});
 *	dojo.body().appendChild(button1.domNode);
 */
dojo.declare("atg.widget.form.ComboButton", atg.widget.form.DropDownButton, {
	// summary
...
dojo.declare("atg.widget.form.ToggleButton", atg.widget.form.Button, {
	// summary
