if(!dojo._hasResource["atg.widget.form.CheckBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.CheckBox"] = true;
dojo.provide("atg.widget.form.CheckBox");

dojo.require("atg.widget.form.Button");

dojo.declare(
	"atg.widget.form.CheckBox",
	atg.widget.form.ToggleButton,
	{
		// summary:
		...
		setValue: function(/*String*/ value){
			...
			atg.widget.form.CheckBox.superclass.setValue.call(this,value);
		}
	}
);

dojo.declare(
	"atg.widget.form.RadioButton",
	atg.widget.form.CheckBox,
	{
		// summary:
