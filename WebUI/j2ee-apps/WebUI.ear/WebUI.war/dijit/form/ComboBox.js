if(!dojo._hasResource["atg.widget.form.ComboBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.ComboBox"] = true;
dojo.provide("atg.widget.form.ComboBox");

dojo.require("dojo.data.ItemFileReadStore");
dojo.require("atg.widget.form.ValidationTextBox");
dojo.requireLocalization("atg.widget.form", "ComboBox", null, "ko,zh,ja,zh-tw,ru,it,hu,ROOT,fr,pt,pl,es,de,cs");

dojo.declare(
	"atg.widget.form.ComboBoxMixin",
	null,
	{
		// summary:
		...
		getValue:function(){
			...
			return atg.widget.form.TextBox.superclass.getValue.apply(this, arguments);
		},
		...
		_showResultList: function(){
			...
			dojo.marginBox(this._popupWidget.domNode, {h:best.h,w:Math.max(newwidth,this.textbox.offsetWidth+this.iconNode.offsetWidth)});
		},
		...
		_startSearch: function(/*String*/ key){
			if(!this._popupWidget){
				this._popupWidget = new atg.widget.form._ComboBoxMenu({
...
dojo.declare(
...

	{
		...
		postMixInProperties:function(){
			this._messages = dojo.i18n.getLocalization("atg.widget.form", "ComboBox", this.lang);
...
dojo.declare(
	"atg.widget.form.ComboBox",
	[atg.widget.form.ValidationTextBox, atg.widget.form.ComboBoxMixin],
	{
		postMixInProperties: function(){
			atg.widget.form.ComboBoxMixin.prototype.postMixInProperties.apply(this, arguments);
			atg.widget.form.ValidationTextBox.prototype.postMixInProperties.apply(this, arguments);
		}
	}
);
