if(!dojo._hasResource["atg.widget.form.FilteringSelect"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.FilteringSelect"] = true;
dojo.provide("atg.widget.form.FilteringSelect");

dojo.require("dojo.data.ItemFileReadStore");
dojo.require("atg.widget.form.ComboBox");

dojo.declare(
	"atg.widget.form.FilteringSelect",
	[atg.widget.form.MappedTextBox, atg.widget.form.ComboBoxMixin],
	{
		/*
		 * summary
		...
		_callbackSetLabel: function(/*Array*/ result, /*Object*/ dataObject, /*Boolean, optional*/ priorityChange){
			...
			if(!result.length){
				...
				atg.widget.form.TextBox.superclass.setValue.call(this, undefined, !this._hasFocus);
				this._isvalid=false;
		...
		_openResultList: function(/*Object*/ results, /*Object*/ dataObject){
			...
			this.validate(true);
			atg.widget.form.ComboBoxMixin.prototype._openResultList.apply(this, arguments);
		},
		...
		_setValue:function(/*String*/ value, /*String*/ displayedValue, /*Boolean, optional*/ priorityChange){
			...
			atg.widget.form.FilteringSelect.superclass.setValue.call(this, value, priorityChange, displayedValue);
		...
		_getMenuLabelFromItem:function(/*Item*/ item){
			...
			if(this.labelAttr){return {html:this.labelType=="html", label:this.store.getValue(item, this.labelAttr)};}
				...
				return atg.widget.form.ComboBoxMixin.prototype._getMenuLabelFromItem.apply(this, arguments);
			}
		},

		postMixInProperties: function(){
			atg.widget.form.ComboBoxMixin.prototype.postMixInProperties.apply(this, arguments);
			atg.widget.form.MappedTextBox.prototype.postMixInProperties.apply(this, arguments);
		}
	}
);
