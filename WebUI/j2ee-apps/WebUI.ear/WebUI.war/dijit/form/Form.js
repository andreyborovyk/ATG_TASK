if(!dojo._hasResource["atg.widget.form.Form"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.Form"] = true;
dojo.provide("atg.widget.form.Form");

dojo.require("dijit._Widget");
dojo.require("dijit._Templated");

dojo.declare("atg.widget.form._FormMixin", null,
	{
		/*
		summary:
		...
		usage:
			<form dojoType="atg.widget.form.Form" id="myForm">
...
dojo.declare(
	"atg.widget.form.Form",
	[dijit._Widget, dijit._Templated, atg.widget.form._FormMixin],
	null
);
