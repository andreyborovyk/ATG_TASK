if(!dojo._hasResource["atg.widget.form.InlineEditBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.InlineEditBox"] = true;
dojo.provide("atg.widget.form.InlineEditBox");
...
dojo.deprecated("atg.widget.form.InlineEditBox is deprecated, use dijit.InlineEditBox instead", "", "1.1");

dojo.declare(
	"atg.widget.form.InlineEditBox",
	...
	//		Currently all textboxes that inherit from atg.widget.form.TextBox
	...
	//		It must also be able to initialize with style="display:none;" set.
{
	...
	_showText: function(){
		...
		atg.widget.form.InlineEditBox.superclass.setValue.call(this, value);
