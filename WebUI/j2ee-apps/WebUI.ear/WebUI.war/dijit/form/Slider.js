if(!dojo._hasResource["atg.widget.form.Slider"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.Slider"] = true;
dojo.provide("atg.widget.form.Slider");
...
dojo.declare(
	"atg.widget.form.HorizontalSlider",
	[atg.widget.form._FormWidget, dijit._Container],
{
	// summary
	...
	attributeMap: dojo.mixin(dojo.clone(atg.widget.form._FormWidget.prototype.attributeMap),
		{id:"", name:"valueNode"}),
	...
	_onBlur: function(){
		atg.widget.form.HorizontalSlider.superclass.setValue.call(this, this.value, true);
	},
	...
	postCreate: function(){
		...
		var _self = this;
		var mover = function(){
			atg.widget.form._SliderMover.apply(this, arguments);
			this.widget = _self;
		};
		dojo.extend(mover, atg.widget.form._SliderMover.prototype);
...
dojo.declare(
	"atg.widget.form.VerticalSlider",
	atg.widget.form.HorizontalSlider,
{
	// summary
...
dojo.declare("atg.widget.form._SliderMover",
	dojo.dnd.Mover,
{
...
dojo.declare("atg.widget.form.HorizontalRule", [dijit._Widget, dijit._Templated],
{
	//	Summary:
...
dojo.declare("atg.widget.form.VerticalRule", atg.widget.form.HorizontalRule,
{
	//	Summary:
...
dojo.declare("atg.widget.form.HorizontalRuleLabels", atg.widget.form.HorizontalRule,
{
	//	Summary:
...
dojo.declare("atg.widget.form.VerticalRuleLabels", atg.widget.form.HorizontalRuleLabels,
{
	//	Summary:
