if(!dojo._hasResource["atg.widget.form.TextBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.TextBox"] = true;
dojo.registerModulePath("atg.widget", "/WebUI/dijit");

dojo.provide("atg.widget.form.TextBox");
...
dojo.declare(
	...
	atg.widget.form._FormWidget,
	{
		...
		setValue: function(value, /*Boolean, optional*/ priorityChange, /*String, optional*/ formattedValue){
			...
			atg.widget.form.TextBox.superclass.setValue.call(this, filteredValue, priorityChange);
		},
