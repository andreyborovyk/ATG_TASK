if(!dojo._hasResource["atg.widget.form.Textarea"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.Textarea"] = true;
dojo.provide("atg.widget.form.Textarea");
...
dojo.declare(
	"atg.widget.form.Textarea",
	atg.widget.form._FormWidget,
{
	// summary
	...
	// usage:
	//	<textarea dojoType="atg.widget.form.TextArea">...</textarea>
	...
	setValue: function(/*String*/ value, /*Boolean, optional*/ priorityChange){
		...
		atg.widget.form.Textarea.superclass.setValue.call(this, this.getValue(), priorityChange);
	},
	...
	postMixInProperties: function(){
		atg.widget.form.Textarea.superclass.postMixInProperties.apply(this,arguments);
