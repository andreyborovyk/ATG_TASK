if(!dojo._hasResource["atg.widget.form.TimeTextBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form.TimeTextBox"] = true;
dojo.provide("atg.widget.form.TimeTextBox");
...
dojo.declare(
	...
	atg.widget.form.RangeBoundTextBox,
	{
		...
		postMixInProperties: function(){
			//atg.widget.form.RangeBoundTextBox.prototype.postMixInProperties.apply(this, arguments);
			...
			if(!this._picker){
				...
				this._picker = new popupProto({
					onValueSelected: function(value){
						...
						atg.widget.form.TimeTextBox.superclass.setValue.call(self, value, true);
					},
					lang: this.lang,
