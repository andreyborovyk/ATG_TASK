if(!dojo._hasResource["atg.widget.form._FormWidget"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form._FormWidget"] = true;
dojo.provide("atg.widget.form._FormWidget");

dojo.require("dijit._Widget");
dojo.require("dijit._Templated");

dojo.declare("atg.widget.form._FormWidget", [dijit._Widget, dijit._Templated],
{
	/*
	Summary:
