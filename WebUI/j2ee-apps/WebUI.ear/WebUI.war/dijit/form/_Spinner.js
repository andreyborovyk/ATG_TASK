if(!dojo._hasResource["atg.widget.form._Spinner"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["atg.widget.form._Spinner"] = true;
dojo.provide("atg.widget.form._Spinner");

dojo.require("atg.widget.form.ValidationTextBox");

dojo.declare(
	"atg.widget.form._Spinner",
	atg.widget.form.RangeBoundTextBox,
	{

		// summary: Mixin for validation widgets with a spinner
		// description: This class basically (conceptually) extends atg.widget.form.ValidationTextBox.
