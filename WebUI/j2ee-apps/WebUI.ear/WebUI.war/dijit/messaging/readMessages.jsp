        ...
        <json:object>
          <json:array name="messages" items="${messageList}" var="msg">
            <json:object>
              ...
              <json:property name="datetime" value="${msg.datetime.time}"/>
...
<%-- @version $Id: //product/WebUI/version/10.0.3/src/web-apps/WebUI/dijit/messaging/readMessages.jsp#2 $$Change: 651448 $--%>
