...
//		case 'OutTop' :
		...
		default :
			...
			// 5/25/2010 Add a call to an integration function when the adjust() function is called.
			eTargetDocument.open() ;
			eTargetDocument.write( '<html><head>' + sBase + '<script type="text/javascript"> var adjust = function() { window.frameElement.height = document.body.scrollHeight ; if (parent.FCKeditor_OnToolbarAdjust){parent.FCKeditor_OnToolbarAdjust();}}; '
