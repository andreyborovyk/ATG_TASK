...
atg.widget.messaging.ResizeHandleEx = {
	...
	_beginSizing: function(/*Event*/ e){
	  ...
	  for (var i = 0; i < iframes.length; i++) {
	    var frameBody = iframes[i].contentWindow.document.body;
  		...
  		dojo.event.connect(frameBody, "onmouseup", this, "_endSizing");
	  }
  ...
  _changeSizing: function(/*Event*/ e){
    ...
    // otherwise resizing will never stop over the iframe - see comment under _beginSizing
	  ...
	  for (var i = 0; i < iframes.length; i++) {
	    var frameBody = iframes[i].contentWindow.document.body;
  		dojo.event.disconnect(frameBody, "onmousemove", this, "_changeSizing");
  		dojo.event.disconnect(frameBody, "onmouseup", this, "_endSizing");
	  }
