...
<dsp:droplet name="/atg/dynamo/droplet/Switch">
  ...
  <dsp:oparam name="default">
    <table border=0 cellpadding=0> 
      <tr>
        <td>&nbsp;&nbsp;</td>
        <td><font color=#ffffff>Willkommen
        <dsp:droplet name="/atg/dynamo/droplet/Switch">
...
<dsp:droplet name="/atg/dynamo/droplet/Switch">
  ...
  <dsp:oparam name="broker">
    <dsp:a href="index.jsp">
      <dsp:img src="images/nav-myhome.gif" border="0" alt="My Home"/>
    </dsp:a>
    <dsp:a href="mypreferences.jsp">
      <dsp:img src="images/nav-mypreferences.gif" border="0" 
	alt="preferences"/>
    </dsp:a>
    <dsp:a href="myprofile.jsp">
      <dsp:img src="images/nav-myprofile.gif" border="0" alt="profile"/>
    </dsp:a>
    <dsp:a href="viewclients.jsp">
      <dsp:img src="images/nav-myclients.gif" alt="clients" border="0"/>
    </dsp:a>
    <dsp:a href="fundlist.jsp">
      <dsp:img src="images/nav-funds.gif" border="0" alt="funds"/>
    </dsp:a>
    <dsp:a href="email/index.jsp">
      <dsp:img src="images/nav-email.gif" alt="email" border="0"/>
    </dsp:a>
    <dsp:a href="logout.jsp">
      <dsp:img src="images/nav-logout.gif" alt="log out" border="0"/>
    </dsp:a>
  </dsp:oparam>
  ...
  <dsp:oparam name="investor">
    ...
    <dsp:a href="fundlist.jsp">
      <dsp:img src="images/nav-funds.gif" alt="funds" border="0"/>
    </dsp:a>
    <dsp:a href="newslist.jsp">
      <dsp:img src="images/nav-news.gif" alt="news" border="0"/>
    </dsp:a>
    <dsp:a href="featurelist.jsp">
      <dsp:img src="images/nav-features.gif" alt="news" border="0"/></dsp:a>
     <dsp:a href="logout.jsp">
  ...
  <dsp:oparam name="default">
    ...
    <dsp:a href="login.jsp"><dsp:img src="images/nav-login.gif" alt="log in" border="0"/></dsp:a><br>
     ...
     <dsp:a href="featurelist.jsp"><dsp:img src="images/nav-features.gif" alt="features" border="0"/></dsp:a><br>
</dsp:oparam>
</dsp:droplet>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/de/nav.jsp#2 $$Change: 651448 $--%>
