    ...
    <table border=0 cellpadding=4>
     ...
     <tr>
       ...
       <table border=0 cellpadding=4>
         ...
         <tr>
           <td colspan="2"><dsp:input bean="ProfileFormHandler.value.userType" type="hidden" value="investor"/></td>
         </tr>
         <tr>
           <td></td>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/en/signup.jsp#2 $$Change: 651448 $--%>
