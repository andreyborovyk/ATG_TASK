...
<i18n:message id="editEventTitle" key="editEventTitle" />
<i18n:message id="updateEventFeedbackMsg" key="updateEventFeedbackMsg" />
...
<i18n:message id="noTimeLabel" key="noTimeLabel" />
  ...
  <%
    ...
    String thisEventType="detail-event";
...
<%-- set event ID in form handler to pre-populate the fields --%>
<dsp:setvalue bean="DetailEventFormHandler.eventId" value="<%=eventId%>" />

<dsp:form name="EventEditForm" action="<%= pafEnv.getOriginalRequestURI() %>" method="POST" >
...
<dsp:input type="hidden" bean="DetailEventFormHandler.eventId" value="<%=eventId%>" />
...
<core:createUrl id="successUrl" url="<%= pafEnv.getOriginalRequestURI() %>" >
    <core:UrlParam param="action" value="edit_event"/>
    <core:UrlParam param="paf_dm" value="full"/>
    <core:UrlParam param="paf_gear_id" value="<%= gearId %>" />
    <core:UrlParam param="eventType" value="<%=thisEventType%>" />
    <core:UrlParam param="eventId" value="<%=eventId%>" />
...
<table width="500" border="0" cellpadding="3" cellspacing="0" class="small">						
   <tr valign="top" align="left">
    	<td colspan="2" class="small_bold"><%=editEventTitle%></td>
...
<dsp:droplet name="/atg/dynamo/droplet/Switch">
  ...
  <dsp:oparam name="false">
    <core:ifNotNull value='<%=request.getParameter("formSubmit")%>'>
     <tr><td colspan="2">
      &nbsp;<img src="<%=infoGifURL%>">&nbsp;&nbsp;<font class="small"><%=updateEventFeedbackMsg%></font>
     </td></tr>
    </core:ifNotNull>
  </dsp:oparam>
</dsp:droplet>
...
<font class="small">
  ...
  <core:ifNot value="<%=hasPublicEventAccess%>">
    ...
    <td nowrap>
    <dsp:input bean="DetailEventFormHandler.eventStartDate"  date="<%=dateFormat%>" required="<%=true%>"/>
    </td></tr>
    <tr>
      <td width="5">&nbsp;</td>
    ...
    <td nowrap>
    <dsp:input bean="DetailEventFormHandler.eventEndDate"  date="<%=dateFormat%>" required="<%=true%>"/>
    </td></tr>
    <tr valign="top" align="left">
    	<td width="5">*</td>
    ...
    <tr valign="top" align="left">
    	...
    	<td>&nbsp;</td>
			<td><br>
        <dsp:input type="submit" value="<%=saveButtonLabel%>" bean="DetailEventFormHandler.update" />
	&nbsp;&nbsp;
    	</td>
    </tr>
     <tr valign="top" align="left">
...
<%-- @version $Id: //app/portal/version/10.0.3/calendar/calendar.war/html/editDetailEvent.jsp#2 $$Change: 651448 $--%>
