...
<dsp:importbean bean="/atg/portal/admin/CommunityAccessFormHandler"/>
<% try { %>
...
<%
 ...
 String urlTargetJsp = "community_settings.jsp";
 String beanTarget   = "CommunityAccessFormHandler";
...
<img src='<%= response.encodeURL("images/write.gif")%>' height="15" width="28" alt="" border="0"> <i18n:message key="comm_access_title"/>
...
<dsp:getvalueof id="aclTranslator" idtype="atg.portal.admin.AclTranslator" bean="AclTranslator">
  <%
    List aceDescriptions = aclTranslator.getAclDescription(request, response, cm);
...
<font class="smaller">
<i18n:message key="comm_access_intro"/><br>
</font>
</td></tr></table>
...
<i18n:message key="comm_access_instruction_item_1_param">
...
<i18n:message key="comm_access_instruction_item_2_role_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
</i18n:message>
...
<i18n:message key="comm_access_instruction_item_3_role_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
</i18n:message>
...
<i18n:message key="comm_access_role_allow_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
...
<i18n:message key="comm_access_role_deny_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="comm_access_role_defer_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="comm_access_instruction_item_2_org_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
</i18n:message>
...
<i18n:message key="comm_access_instruction_item_3_org_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
</i18n:message>
...
<i18n:message key="comm_access_org_allow_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="comm_access_org_deny_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="comm_access_org_defer_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="comm_access_ind_allow_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="comm_access_ind_deny_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="comm_access_ind_defer_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<%-- @version $Id: //app/portal/version/10.0.3/paf/settings.war/community_access_editor.jsp#2 $$Change: 651448 $--%>
