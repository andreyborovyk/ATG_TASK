      ...
      <dsp:oparam name="outputEnd">
        ...
        <tr bgcolor=#ffff99>
          ...
          <dsp:valueof bean="/atg/demo/QuincyFunds/PageValues.portfolioValue"
	               converter="euro" symbol="&euro;"/></b></font></td> 
          <td>&nbsp;</td>
       </tr> 
       <tr bgcolor=#ffff99>
	...
	%>
        ...
        <dsp:droplet name="/atg/targeting/RepositoryLookup">
          ...
          <dsp:oparam name="output">
            ...
            <td>&nbsp;</td> 
            <td align=right><font size=-1><dsp:valueof param="element.price" converter="euro" symbol="&euro;"/></font></td> 
            <td>&nbsp;</td> 
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/de/portfoliodynamic.jsp#2 $$Change: 651448 $--%>
