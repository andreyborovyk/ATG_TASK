...
<HTML> <HEAD><TITLE>Afficher un publipostage</TITLE></HEAD>
      ...
      <tr valign=top>
        ...
        <table border=0 cellpadding=4 cellspacing=0>
          <tr>
            ...
            <td>
            <h2>Afficher un publipostage</h2>
           ...
           <dsp:input bean="EmailRepositoryFormHandler.repositoryId" type="hidden"/>
            ...
            Titre du publipostage : <dsp:valueof bean="EmailRepositoryFormHandler.value.title"/>
...
<%/* @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/email/editmail.jsp#2 $$Change: 651448 $*/%> </dsp:page>
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/email/editmail.jsp#2 $$Change: 651448 $--%>
