...
<dsp:droplet name="/atg/targeting/RepositoryLookup">
          ...
          <tr valign=top>
            ...
            <table border=0 width=500 cellpadding=4 cellspacing=0>
              <tr>
                ...
                <p>
                Présentation | <font color=#003366><u>Infos sur les portefeuilles </font></u> | <font color=#003366><u>Statistiques clés</font></u> | <font color=#003366><u>Équipe de direction</u></font><p>
                  ...
                  <dsp:oparam name="default">
                    <dsp:droplet name="/atg/dynamo/droplet/xml/XMLTransform">
                      ...
                      <dsp:oparam name="failure">
                        <p> Échec de conversion du document XML : <dsp:valueof param="input"/>
                      </dsp:oparam>
                    </dsp:droplet>
                    <dsp:a href="sendprospectus.jsp">
                    <p><dsp:param name="ElementId" param="ElementId"/>Je souhaite recevoir le formulaire d'adhésion et la brochure de présentation.</dsp:a>
                  </dsp:oparam>
                  <dsp:oparam name="broker">
                    <dsp:droplet name="/atg/dynamo/droplet/xml/XMLTransform">
                      <dsp:param name="input" param="element.document"/>
  ...
  <dsp:oparam name="empty">
    Pour accéder à cette page, vous devez utiliser un lien contenant l'ID du référentiel du fond que vous souhaitez transmettre en tant que paramètre.
  </dsp:oparam>
</dsp:droplet>
