...
<xsl:stylesheet 
    ...
    version="1.0"> <xsl:template match="/fund"> <p><b>Type de fond : </b> <xsl:value-of select="type"/></p>
  ...
  <b>Performances</b> <table border="0" cellpadding="4" cellspacing="1" width="495">
...
<!-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/funds-investor-template.xsl#2 $$Change: 651448 $-->
