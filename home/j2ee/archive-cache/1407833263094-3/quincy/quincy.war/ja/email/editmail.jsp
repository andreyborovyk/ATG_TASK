...
<HTML> <HEAD><TITLE>メールの表示</TITLE></HEAD>
        ...
        <table border=0 cellpadding=4 cellspacing=0>
          <tr>
           ...
           <dsp:input bean="EmailRepositoryFormHandler.repositoryId" type="hidden"/>
            ...
            メールのタイトル： <dsp:valueof bean="EmailRepositoryFormHandler.value.title"/>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/ja/email/editmail.jsp#2 $$Change: 651448 $--%>
