...
<HTML><HEAD><TITLE>ログアウト</TITLE></HEAD>
...
<table border=0 cellpadding=4 cellspacing=0>
  <tr>
    ...
    <dsp:input bean="ProfileFormHandler.logout" type="SUBMIT" value=" ログアウト "/>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/ja/logout.jsp#2 $$Change: 651448 $--%>
