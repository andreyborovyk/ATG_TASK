...
<input type="hidden" name="successURL" value="<%=successURL%>" >
 ...
 <dsp:droplet name="Switch">
  ...
  <tr bgcolor="#<%= gearBGColor %>">
    ...
    <td>  <dsp:input type="TEXT"  size="24" bean="ProfileFormHandler.value.email" required="<%=true%>" /></td>
     <td>&nbsp;</td>
  </tr>
  ...
  <tr bgcolor="#<%= gearBGColor %>">
    ...
    <td>  <dsp:input type="TEXT"  size="24" bean="ProfileFormHandler.value.firstName" required="<%=true%>"/></td>
     <td>&nbsp;</td>
  </tr>
  ...
  <tr bgcolor="#<%= gearBGColor %>">
    ...
    <td>  <dsp:input type="TEXT" size="24" bean="ProfileFormHandler.value.lastName" required="<%=true%>"/></td>
     <td>&nbsp;</td>
  </tr>
...
<%-- @version $Id: //app/portal/version/10.0.3/authentication/auth.war/web/html/profileUpdateForm.jsp#2 $$Change: 651448 $--%>
