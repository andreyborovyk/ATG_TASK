...
<html>
<head>
<title><i18n:message key="title-admin-login"/></title> 
...
<body bgcolor="#ffffff" text="#333333" link="#3366ff" vlink="#3366ff" marginheight=0 marginwidth=0 leftmargin=0 rightmargin=0 topmargin=0  onload="document.adminForm.login.focus()"  background="images/background.gif" >
<dsp:form action='<%= request.getRequestURI() %>' method="POST" name="adminForm">
<table cellpadding="0" cellspacing="0" border="0" bgcolor="#0090f1" width="100%">
  <tr>
   <td align="left" width="95%"><img src='<%=response.encodeURL(request.getContextPath()+"/"+ root_image_dir +"/portaladmin_banner.jpg")%>' alt='<i18n:message key="admin-nav-header-title"/>'></td>
 ...
 <tr>
  <td  colspan="3" bgcolor="#B7B8B7"><img src='<%=response.encodeURL(request.getContextPath()+"/images/clear.gif")%>' height="1" width="1" alt=""></td>
 </tr>
</table>
...
<td><img src='<%=response.encodeURL(request.getContextPath()+"/images/clear.gif")%>' height="1" width="20" ><br></td>
  ...
  <font class="error">
    <dsp:droplet name="ErrorMessageForEach">
      ...
      <dsp:oparam name="output">
       <img src='<%=response.encodeURL(request.getContextPath()+"/images/error.gif")%>'>&nbsp;&nbsp;<i18n:message key="login_failure_error_msg"/><br><br>
      </dsp:oparam>
    </dsp:droplet>
    </font>
</dsp:oparam>
...
<img src='<%=response.encodeURL(request.getContextPath()+"/images/clear.gif")%>' height="1" width="380"  border=0><br>
...
<td><br>
<font class="small">
<dsp:input type="SUBMIT" value="<%= loginbutton %>" bean="ProfileFormHandler.login"/><br><br><br></font>
</dsp:form>
</td>
</TR>
</TABLE>
...
<%-- @version $Id: //app/portal/version/10.0.3/paf/admin.war/login.jsp#2 $$Change: 651448 $--%>
