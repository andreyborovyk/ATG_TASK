...
<html>
  <head>
    <title><fmt:message key="offline-title" bundle="${accessbundle}"/></title>
  ...
  <body <c:out value="${bodyTagData}" escapeXml="false"/> >
    <h1><fmt:message key="offline-heading" bundle="${accessbundle}"/></h1>
    <p><fmt:message key="offline-message" bundle="${accessbundle}"/></p>
  </body>
</html>

</dsp:page>

<%-- @version $Id: //app/portal/version/10.0.3/paf/portal.war/access/html/offline.jsp#2 $$Change: 651448 $--%>
