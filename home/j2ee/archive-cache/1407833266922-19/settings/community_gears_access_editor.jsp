...
<dsp:importbean bean="/atg/portal/admin/GearAccessFormHandler"/>
...
<%
 ...
 String beanTarget   = "GearAccessFormHandler";
...
<i18n:message key="gear_access_header_title">
...
<dsp:getvalueof id="aclTranslator" idtype="atg.portal.admin.AclTranslator" bean="AclTranslator">
  <%
    Gear gear = portal.getGearById(dsp_gear_id);
    List aceDescriptions = aclTranslator.getAclDescription(request, response, gear);
...
<i18n:message key="gear_access_editor_intro"/><br>
...
<i18n:message key="gear_access_instruction_item_1_param">
...
<core:If value='<%=(currSelected.equals("all_roles"))%>'>
 ...
 <dsp:getvalueof id="userDirectoryTools" idtype="atg.portal.admin.userdirectory.PortalUserDirectoryTools" bean="ProfileUserDirectoryTools">
  <%
   ...
   java.util.Collection allRoles = userDirectoryTools.getRoles(0,50 );
   if ( allRoles != null ) {
...
<i18n:message key="gear_access_instruction_item_2_role_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
</i18n:message>
...
<i18n:message key="gear_access_instruction_item_3_role_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
</i18n:message>
...
<i18n:message key="gear_access_role_allow_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
...
<i18n:message key="gear_access_role_deny_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="gear_access_role_defer_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="gear_access_instruction_item_2_org_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
</i18n:message>
...
<i18n:message key="gear_access_instruction_item_3_org_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
</i18n:message>
...
<i18n:message key="gear_access_org_allow_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="gear_access_org_deny_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="gear_access_org_defer_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="gear_access_ind_allow_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="gear_access_ind_deny_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<i18n:message key="gear_access_ind_defer_param">
 <i18n:messageArg value="<%=i18n_bold%>"/>
 <i18n:messageArg value="<%=i18n_end_bold%>"/>
 <i18n:messageArg value="<%=i18n_italic%>"/>
 <i18n:messageArg value="<%=i18n_end_italic%>"/>
...
<%-- @version $Id: //app/portal/version/10.0.3/paf/settings.war/community_gears_access_editor.jsp#2 $$Change: 651448 $--%>
