...
<table border="0" width="96%" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" width="25%" >
      <% thisRegionLayoutName = "25_75_Left"; %>
    ...
    <td valign="top" width="75%" >
      <% thisRegionLayoutName = "25_75_Right"; %>
      <%@ include file="region_template.jspf" %>
    </td>
  </tr>
</table>
...
<%-- @version $Id: //app/portal/version/10.0.3/templates/layoutTemplates.war/web/html/layout_25_75.jsp#2 $$Change: 651448 $--%>
