...
extends atg.servlet.jsp.DynamoJspPageServlet implements atg.servlet.pagecompile.AttrCompiledServlet {
  ...
  public static final long SOURCE_MODIFIED_TIME = 1308316594000L;
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            /*** lines: 33-36 */
            __fileData.writeBytes (1017, 160, out);
          }
          finally {
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 37-40 */
            __fileData.writeBytes (1216, 159, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 65-65 */
            __fileData.writeBytes (2247, 35, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 53-57 */
            __fileData.writeBytes (1740, 92, out);
            try {
              request.pushFrame();
            ...
            /*** lines: 71-73 */
            __fileData.writeBytes (2670, 24, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      throws ServletException, IOException
  {
    ...
    try {
      ...
      try {
        ...
        /*** lines: 13-31 */
        __fileData.writeBytes (818, 100, out);
        try {
          request.pushFrame();
        ...
        /*** lines: 41-48 */
        __fileData.writeBytes (1399, 191, out);
        ...
        _form = null;
        /*** lines: 48-50 */
        __fileData.writeBytes (1590, 13, out);
        try {
          request.pushFrame();
        ...
        /*** lines: 74-78 */
        __fileData.writeBytes (2718, 18, out);
/* @version $Id: //product/DAS/version/10.0.3/release/DAS/admin/atg/dynamo/admin/en/cmpn-search.jhtml#2 $$Change: 651448 $*/        /*** lines: 78-78 */
        __fileData.writeBytes (2873, 1, out);
      } catch (Exception e) {
