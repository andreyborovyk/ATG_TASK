...
<table width=625 cellspacing=0 cellpadding=0 border=0>
  ...
  <dsp:droplet name="/atg/targeting/TargetingFirst">
    ...
    <img src="images/banner-portfolio.gif" alt="私のポートフォリオ">
    ...
    <dsp:droplet name="/atg/targeting/TargetingForEach">
      ...
      <dsp:oparam name="output">
       ...
       <img src="images/portfolio-graph.gif" alt="ここにグラフを挿入">
    ...
    <dsp:droplet name="/atg/targeting/TargetingRange">
      ...
      <dsp:oparam name="empty">
        <tr>
          <td colspan=2>今日の特別提供品はありません。</td>
        </tr>
      </dsp:oparam>
    </dsp:droplet>
    <tr>
    ...
    <table width=250 cellspacing=0 cellpadding=0 border=0 background="images/greenish-lines.gif">
      <tr>
        <td colspan=2>
        <img src="images/banner-news.gif" alt="ニュース"></td>
      </tr>
      <tr><td colspan=2><img src="images/d.gif" vspace=4></td></tr>
  ...
  <tr>
    <td colspan=2><dsp:a href="newslist.jsp"><img src="images/but-readnews.gif" alt="その他のニュース" border=0></dsp:a></td>
  </tr>
</table>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/ja/investorhome.jsp#2 $$Change: 651448 $--%>
