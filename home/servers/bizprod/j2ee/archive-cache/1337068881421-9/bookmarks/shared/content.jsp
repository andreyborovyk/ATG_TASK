...
<core:demarcateTransaction id="bookmarksSharedPageXA">
<% try { %>
...
<%
String folderId = pafEnv.getGearUserParameter("bmgFolderId");
...
<dsp:droplet name="/atg/dynamo/droplet/RQLQueryForEach">
  ...
  <dsp:oparam name="output">
    ...
    <ul   id="ul_bookmarks"  style="margin-left: 16px; list-style-type: none">
...
<%-- @version $Id: //app/portal/version/10.0.3/bookmarks/bookmarks.war/shared/content.jsp#2 $$Change: 651448 $--%>
