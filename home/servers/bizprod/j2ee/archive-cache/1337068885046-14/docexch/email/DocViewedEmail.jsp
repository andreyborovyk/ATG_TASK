...
<i18n:message id="emailSubject2"    key="SUBJECT_DOC_VIEWED" />
...
<h3><i18n:message  key="BODY_HEADER_VIEWED"/></h3>

 <i18n:message  key="BODY_CONTENT_VIEWED">
...
<%-- @version $Id: //app/portal/version/10.0.3/docexch/docexch.war/email/DocViewedEmail.jsp#2 $$Change: 651448 $--%>
