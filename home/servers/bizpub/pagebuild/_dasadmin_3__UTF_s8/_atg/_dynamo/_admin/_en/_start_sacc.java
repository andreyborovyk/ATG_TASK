...
extends atg.servlet.jsp.DynamoJspPageServlet implements atg.servlet.pagecompile.AttrCompiledServlet {
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            __fileData.writeChars (3095, 20, (CharFileDataSink)out);
            out.print(request.encodeURL ("start-acc.jhtml", true, true, false, true, false));
            /*** lines: 101-101 */
            __fileData.writeChars (3130, 114, (CharFileDataSink)out);
            {
              String _pn = "/atg/devtools/Admin.launchHub";
              /*** lines: 101-101 */
              __fileData.writeChars (3270, 1, (CharFileDataSink)out);
            ...
            /*** lines: 101-108 */
            __fileData.writeChars (3271, 16, (CharFileDataSink)out);
          }
          finally {
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 109-111 */
            __fileData.writeChars (3319, 44, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            /*** lines: 126-126 */
            __fileData.writeChars (3779, 19, (CharFileDataSink)out);
            out.print(request.encodeURL ("start-acc.jhtml", true, true, false, true, false));
            /*** lines: 126-131 */
            __fileData.writeChars (3813, 181, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
        ...
        throws ServletException, IOException
    {
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 132-135 */
            __fileData.writeChars (4027, 14, (CharFileDataSink)out);
      ...
      try {
        ...
        out.println("<B>ERROR:</B> A fatal error occurred while launching ATG Control Center.");
                ...
                /*** lines: 217-218 */
            __fileData.writeChars (7482, 3, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            __fileData.writeChars (7987, 202, (CharFileDataSink)out);
            out.print(request.encodeURL ("start-acc.jhtml", true, true, false, true, false));
            /*** lines: 235-235 */
            __fileData.writeChars (8204, 49, (CharFileDataSink)out);
            /*** lines: 235-235 */
            __fileData.writeChars (8300, 16, (CharFileDataSink)out);
            {
              ...
              out.print('"');
              /*** lines: 235-235 */
              __fileData.writeChars (8316, 1, (CharFileDataSink)out);
            ...
            /*** lines: 235-243 */
            __fileData.writeChars (8317, 47, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 244-244 */
            __fileData.writeChars (8401, 24, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 245-245 */
            __fileData.writeChars (8464, 16, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 232-233 */
            __fileData.writeChars (7794, 9, (CharFileDataSink)out);
            try {
              request.pushFrame();
            ...
            /*** lines: 246-247 */
            __fileData.writeChars (8505, 4, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 248-248 */
            __fileData.writeChars (8541, 32, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      throws ServletException, IOException
  {
    ...
    try {
      ...
      try {
        ...
        /*** lines: 11-12 */
        __fileData.writeChars (281, 1, (CharFileDataSink)out);
  ...
  boolean isSupportedJRE = (javaVersion == null || javaVersion.startsWith("1.3") || javaVersion.startsWith("1.4") || javaVersion.startsWith("1.5") || javaVersion.startsWith("1.6"));
        ...
        /*** lines: 28-28 */
        __fileData.writeChars (873, 61, (CharFileDataSink)out);
        out.print(request.encodeURL ("/atg/dynamo/admin/admin.css", false, true, true, true));
        /*** lines: 28-28 */
        __fileData.writeChars (961, 143, (CharFileDataSink)out);
        ...
        /*** lines: 28-28 */
        __fileData.writeChars (1127, 89, (CharFileDataSink)out);
        ...
        /*** lines: 28-45 */
        __fileData.writeChars (1217, 63, (CharFileDataSink)out);

  if ( admin == null ) {
        /*** lines: 47-60 */
        __fileData.writeChars (1319, 512, (CharFileDataSink)out);

  } else {
        /*** lines: 62-63 */
        __fileData.writeChars (1856, 17, (CharFileDataSink)out);
        {
        ...
        /*** lines: 63-66 */
        __fileData.writeChars (1932, 19, (CharFileDataSink)out);
...
if (null != display) {
  ...
  display = hostName;
        ...
        /*** lines: 89-92 */
        __fileData.writeChars (2717, 10, (CharFileDataSink)out);
 if (isSupportedJRE && request.resolveName("/atg/devtools/DevAgent", false) != null) {         /*** lines: 92-95 */
        __fileData.writeChars (2827, 68, (CharFileDataSink)out);
        {
        ...
        /*** lines: 95-99 */
        __fileData.writeChars (2948, 24, (CharFileDataSink)out);
        try {
          request.pushFrame();
        ...
        /*** lines: 112-116 */
        __fileData.writeChars (3383, 17, (CharFileDataSink)out);
 }         /*** lines: 116-119 */
        __fileData.writeChars (3416, 78, (CharFileDataSink)out);
        {
          Object _t = DropletDescriptor.getPropertyValue(request, response, "/atg/dynamo/admin/Configure.thisHostname", true, PageCompileServlet.getEscapeHTMLTagConverter(), null);
          if (_t == null) {
          }
        ...
        /*** lines: 119-124 */
        __fileData.writeChars (3547, 120, (CharFileDataSink)out);
        try {
          request.pushFrame();
        ...
        /*** lines: 219-225 */
        __fileData.writeChars (7505, 83, (CharFileDataSink)out);

out.print(display + ".");
        /*** lines: 227-230 */
        __fileData.writeChars (7628, 10, (CharFileDataSink)out);
        try {
          request.pushFrame();
        ...
        /*** lines: 249-252 */
        __fileData.writeChars (8593, 16, (CharFileDataSink)out);

  } // check if admin is set
        /*** lines: 254-256 */
        __fileData.writeChars (8652, 17, (CharFileDataSink)out);
/* @version $Id: //product/DAS/version/10.0.3/release/DAS/admin/atg/dynamo/admin/en/start-acc.jhtml#2 $$Change: 651448 $*/        /*** lines: 256-257 */
        __fileData.writeChars (8804, 2, (CharFileDataSink)out);
      } catch (Exception e) {
