               ...
               <dsp:oparam name="output">
                <tr valign=top>
                  ...
                  <td><dsp:param name="ElementId" param="element.repositoryId"/>
                    ...
                    <br>
                    By <dsp:valueof param="element.author"/></td>
                </tr>
              </dsp:oparam>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/de/newslist.jsp#2 $$Change: 651448 $--%>
