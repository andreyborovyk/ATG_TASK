...
<dsp:droplet name="Switch">
  ...
  <dsp:oparam name="default">
    Vous êtes déjà connecté. Si vous désirez vous connecter en tant que nouvel utilisateur, <dsp:a href="logout.jsp">déconnectez-vous</dsp:a>.
  </dsp:oparam>
  ...
  <table width=400 border=0>
    <tr>
      <td><font size=-1>
        Remarque : Si vous disposez de la base de données de démonstration, vous pouvez vous connecter en utilisant les identifiants suivants. Le mot de passe et le nom d'utilisateur sont identiques.
       <p>
       Investisseurs : marc (français), eric (anglais), sandy (anglais), sally (allemand), frank (japonais)<br>
