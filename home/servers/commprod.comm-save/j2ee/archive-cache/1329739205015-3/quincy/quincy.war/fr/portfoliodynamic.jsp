	...
	%> 
	  ...
	  <dsp:param name="itemDescriptor" value="fund"/>
          ...
          <dsp:oparam name="output">
            ...
            <td>&nbsp;</td> 
            <td align=right><font size=-1><dsp:valueof param="element.price" 
                                  converter="euro" symbol="&euro;"/></font></td> 
            <td>&nbsp;</td> 
            ...
            <dsp:valueof param="fundValue" converter="euro" symbol="&euro;"/></font></td>
   ...
   <dsp:oparam name="empty">
     ...
     <dsp:droplet name="/atg/dynamo/droplet/Switch">
       ...
       <dsp:oparam name="default">
         <tr>
           <td colspan=8 bgcolor=ffff99><font size=-1> &nbsp; exemple de portefeuille</font></td>
         </tr>
       ...
       <dsp:oparam name="broker">
         <tr>
           ...
           Ce client n'a pas de portefeuille.<br>
...
<%/* @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/portfoliodynamic.jsp#2 $$Change: 651448 $ */%> </dsp:page>
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/portfoliodynamic.jsp#2 $$Change: 651448 $--%>
