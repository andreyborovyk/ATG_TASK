...
<table cellspacing=0 cellpadding=0 border=0 width=250 
  ...
  <tr valign=top>
    <td colspan=2>
    <img src="images/banner-features.gif" alt="特別提供品"></td>
  </tr>
  ...
  <tr valign=top>
    ...
    <img src="images/but-indexfeatures.gif" alt="特別提供品のインデックス" border=0></dsp:a><br></td>
...
<br></td>
  ...
  <tr valign=top>
    <td>
    <img src="images/banner-funds.gif" alt="弊社のファンド">
  ...
  <img src="images/but-brokerfundtools.gif" alt="比較"></td>
  </tr>
  ...
  <tr valign=top>
    ...
    <tr>
      <td>&nbsp;&nbsp;</td>
      <td>
      <u><font color=#003366>Quincy の提供内容</font></u><br>
      <u><font color=#003366>ファンドの比較</font></u><br>
      <u><font color=#003366>入手可能な目論見書</font></u></td>
    </tr>
    </table>
    </td>
  </tr>  
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/ja/brokerhome.jsp#2 $$Change: 651448 $--%>
