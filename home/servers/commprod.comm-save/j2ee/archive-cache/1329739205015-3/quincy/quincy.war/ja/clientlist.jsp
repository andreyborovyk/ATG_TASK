...
<img src="images/banner-clients.gif" alt="クライアント">
      ...
      <dsp:oparam name="output">
        <dsp:droplet name="/atg/dynamo/droplet/Switch">
          ...
          <dsp:oparam name="default">
            ...
            <dsp:valueof param="element.firstname"/></dsp:a>
          </dsp:oparam>
        </dsp:droplet>
        <br>                
      </dsp:oparam>
      <dsp:oparam name="empty">
        クライアントが割り当てられていないか、サインインしていません。
      </dsp:oparam>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/ja/clientlist.jsp#2 $$Change: 651448 $--%>
