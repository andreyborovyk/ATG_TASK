<%@ page import="java.io.*,java.util.*,atg.portal.servlet.*,atg.portal.framework.*" contentType="text/vnd.wap.wml" contentType="text/vnd.wap.wml" %>
...
<card id="gear<%= gearServletRequest.getGear().getId() %>" title="<%= gearServletRequest.getGear().getName(response.getLocale()) %>">
 ...
 <p mode="nowrap" align="center">
  <big>
   <b><i18n:message key="helloworld-full"/></b>
  </big>
 </p>
...
<%-- @version $Id: //app/portal/version/10.0.3/helloworld/helloworld.war/wml/fullHelloWorld.jsp#1 $$Change: 651360 $--%>
