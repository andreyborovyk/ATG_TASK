    ...
    <c:choose>
      ...
      <c:otherwise>
        ...
        <dsp:form action="${actionURL}" method="post">
          ...
          <table border="0">
            <tr>
              <td valign="middle" align="right"><label for="username"><fmt:message key="login-label-username" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="username" type="text" size="20" maxsize="20" bean="ProfileFormHandler.value.login"/></td>
            </tr>

            <tr>
              <td valign="middle" align="right"><label for="password"><fmt:message key="login-label-password" bundle="${userprofilingbundle}"/>:</label></td>
              <td><dsp:input id="password" type="password" size="35" maxsize="35" bean="ProfileFormHandler.value.password"/></td>
            </tr>
...
<%-- @version $Id: //app/portal/version/10.0.3/paf/portal.war/userprofiling/html/login.jsp#2 $$Change: 651448 $--%>
