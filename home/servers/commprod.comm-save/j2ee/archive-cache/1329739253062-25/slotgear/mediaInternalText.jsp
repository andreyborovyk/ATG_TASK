...
%>
	...
	<dsp:oparam name="output">
	      <span class="small"><dsp:valueof valueishtml="<%=true%>" param='<%= "element." +pafEnv.getGearInstanceParameter("textPropertyName") %>'/></span>
	</dsp:oparam>
    </dsp:droplet>
...
<%-- @version $Id: //app/portal/version/10.0.3/slotgear/slotgear.war/mediaInternalText.jsp#2 $$Change: 651448 $--%>
