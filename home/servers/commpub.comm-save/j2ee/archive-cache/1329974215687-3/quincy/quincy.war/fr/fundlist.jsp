          ...
          <tr>
            ...
            <dsp:droplet name="/atg/targeting/TargetingForEach">
              ...
              <dsp:oparam name="outputStart">
                <b>Fonds boursiers collectifs </b>
                <ul>
              </dsp:oparam>
            ...
            <dsp:droplet name="/atg/targeting/TargetingForEach">
              ...
              <dsp:param name="fireContentTypeEvent" value="false"/>
              <dsp:oparam name="outputStart">
                <b>Fonds d'obligations collectifs</b>
                <ul>
              </dsp:oparam>
              <dsp:oparam name="output">
                <dsp:a href="fund.jsp">
            ...
            <dsp:droplet name="/atg/targeting/TargetingForEach">
              ...
              <dsp:param name="fireContentTypeEvent" value="false"/>
              <dsp:oparam name="outputStart">
                <b>Fonds collectifs d'investissements sur les marchés monétaires</b>
                <ul>  
              </dsp:oparam>
              <dsp:oparam name="output">
                <dsp:a href="fund.jsp">
...
<%/* @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/fundlist.jsp#2 $$Change: 651448 $ */%> </dsp:page>
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/fundlist.jsp#2 $$Change: 651448 $--%>
