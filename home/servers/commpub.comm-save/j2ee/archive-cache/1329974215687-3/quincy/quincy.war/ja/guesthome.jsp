...
<table width=625 cellspacing=0 cellpadding=0 border=0>
  ...
  <tr valign=top>
    <td colspan=2><img src="images/banner-features.gif" alt="特別提供品"></td>
  </tr>
  ...
  <tr valign=top>
    <td colspan=2><dsp:a href="featurelist.jsp">
      <img src="images/but-indexfeatures.gif" alt="特別提供品のインデックス" border=0></dsp:a></td>
  </tr>
  </table>
  ...
  <dsp:droplet name="/atg/targeting/TargetingFirst">
    ...
    <dsp:oparam name="output">
        ...
        <dsp:a href="signup.jsp"><img border="0" alt="今すぐ登録を" src="<dsp:valueof param="element.imageURL"/>"></dsp:a>
    </dsp:oparam>
  </dsp:droplet>
<dsp:form method="POST" action="<%=ServletUtil.getDynamoRequest(request).getRequestURI()%>">
  ...
  <table border=0>
    <tr valign=top>
      ...
      <td><dsp:select bean="ProfileFormHandler.value.locale">
          ...
          <dsp:input bean="ProfileFormHandler.update" type="submit" value="変更"/>
        </td>
    </tr>
  </table>
  </dsp:form>
  ...
  <dsp:droplet name="/atg/targeting/TargetingFirst">
    ...
    <dsp:param name="fireContentTypeEvent" value="false"/>
    <dsp:oparam name="output">
      <img border="0" alt="サクセスストーリー" src="<dsp:valueof param="element.imageURL"/>"><br>
    </dsp:oparam>
  </dsp:droplet>
  ...
  <table cellspacing=0 cellpadding=0 border=0 background="images/greenish-lines.gif" width=250>
    <tr>
      <td colspan=2><img src="images/banner-news.gif" alt="ニュース"></td>
    </tr>
     <tr><td colspan=2><img src="images/d.gif" vspace=4></td></tr>
    <dsp:droplet name="/atg/targeting/TargetingRange">
    ...
    <tr>
      ...
      src="images/but-readnews.gif" alt="その他のニュース" border=0></dsp:a></td>
    </tr>
  </table>
  <img src="images/d.gif" vspace=4><br>
  <!-- Fundlist -->
  <table cellspacing=0 cellpadding=0 border=0 background="images/yellow-lines.gif">
    <tr valign=top>
      <td><img src="images/banner-funds.gif" alt="弊社のファンド">
  ...
  <dsp:a href="fundlist.jsp"><img src="images/banner-compare.gif" alt="比較" border=0></dsp:a>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/ja/guesthome.jsp#2 $$Change: 651448 $--%>
