...
<DECLAREPARAM NAME="ElementId" CLASS="java.lang.String" DESCRIPTION="このポートフォリオを構築するためのプロファイル ID">
      ...
      <dsp:oparam name="outputEnd">
        ...
        <tr bgcolor=#ffff99>
          ...
          <dsp:valueof bean="/atg/demo/QuincyFunds/PageValues.portfolioValue" 
	               currency="true" locale="ja_JP"/></b></font></td> 
          <td>&nbsp;</td>
       </tr> 
       <tr bgcolor=#ffff99>
	...
	%>
        ...
        <dsp:droplet name="/atg/targeting/RepositoryLookup">
          ...
          <dsp:oparam name="output">
            ...
            <dsp:valueof param="fundValue" currency="true" locale="ja_JP"/>
             </font></td>
   ...
   <dsp:oparam name="empty">
     ...
     <dsp:droplet name="/atg/dynamo/droplet/Switch">
       ...
       <dsp:oparam name="default">
         <tr>
           <td colspan=8 bgcolor=ffff99><font size=-1> &nbsp; ポートフォリオのサンプル</font></td>
         </tr>
...
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/ja/portfoliodynamic.jsp#2 $$Change: 651448 $--%>
