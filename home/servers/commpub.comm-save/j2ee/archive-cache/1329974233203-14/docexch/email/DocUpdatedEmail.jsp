...
<i18n:message id="emailSubject2"    key="SUBJECT_DOC_UPDATED" />
...
<h3><i18n:message  key="BODY_HEADER_UPDATED"/></h3>

 <i18n:message  key="BODY_CONTENT_UPDATED">
...
<%-- @version $Id: //app/portal/version/10.0.3/docexch/docexch.war/email/DocUpdatedEmail.jsp#2 $$Change: 651448 $--%>
