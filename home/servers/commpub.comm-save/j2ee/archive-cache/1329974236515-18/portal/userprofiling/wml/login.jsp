...
<wml>
    ...
    <card id="login" title="<fmt:message key="login-title" bundle="${userprofilingbundle}"/>">
      ...
      <dsp:setvalue bean="ProfileFormHandler.extractDefaultValuesFromProfile" value="false"/>
        ...
        <c:choose>
	      ...
	      <dsp:oparam name="true">
            ...
            <p><fmt:message key="login-label-username" bundle="${userprofilingbundle}"/>:<input type="text" name="login" title="<fmt:message key="login-label-username" bundle="${userprofilingbundle}"/>" size="20" maxlength="20" value=""/></p>

            <p><fmt:message key="login-label-password" bundle="${userprofilingbundle}"/>:<input type="password" name="password" title="<fmt:message key="login-label-password" bundle="${userprofilingbundle}"/>" size="10" maxlength="35" value=""/></p>

          
            <p><anchor title="<fmt:message key="login-button-submit" bundle="${userprofilingbundle}"/>"><fmt:message key="login-button-submit" bundle="${userprofilingbundle}"/>
	      <dsp:go href="${actionURL}" >
	        <dsp:postfield bean="ProfileFormHandler.loginSuccessURL" value="${successURL}" />
                <dsp:postfield bean="ProfileFormHandler.loginErrorURL" value="${errorURL}" />
...
<%-- @version $Id: //app/portal/version/10.0.3/paf/portal.war/userprofiling/wml/login.jsp#2 $$Change: 651448 $--%>
