            ...
            <table border=0 width=500 cellpadding=4 cellspacing=0>
              <tr>
               ...
               <dsp:getvalueof id="srcval" param="element.relativePath">
                        ...
                        <dsp:include page="<%=(String)srcval %>" staticcharset="ISO-8859-1">
                        </dsp:include>
                </dsp:getvalueof>
...
<%/* @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/offer.jsp#2 $$Change: 651448 $*/%> </dsp:page>
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/offer.jsp#2 $$Change: 651448 $--%>
