...
<i18n:message id="noTimeLabel" key="noTimeLabel" />
  ...
  <%
    ...
    String thisEventType="base-event";
...
<dsp:setvalue bean="EventFormHandler.eventId" value="<%=eventId%>" />
...
<font class="small">
  ...
  <core:ifNot value="<%=hasPublicEventAccess%>">
    ...
    <tr>
       ...
       <td nowrap>
        <dsp:input bean="EventFormHandler.eventStartDate"  date="<%=dateFormat%>" required="<%=true%>"/>
       </td>
    </tr>
    <tr>
      <td width="5">&nbsp;</td>
    ...
    <td nowrap>
    <dsp:input bean="EventFormHandler.eventEndDate"  date="<%=dateFormat%>" required="<%=true%>"/>
    </td></tr>
    <tr valign="top" align="left">
    	<td width="5">*</td>
    ...
    <tr valign="top" align="left">
    	...
    	<td>&nbsp;</td>
			<td><br>
        <dsp:input type="submit" value="<%=saveButtonLabel%>" bean="EventFormHandler.update" />
	&nbsp;&nbsp;
    	</td>
    </tr>
     <tr valign="top" align="left">
...
<%-- @version $Id: //app/portal/version/10.0.3/calendar/calendar.war/html/editBaseEvent.jsp#2 $$Change: 651448 $--%>
