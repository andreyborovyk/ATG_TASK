...
<HTML> <HEAD><TITLE>E-mail ciblé</TITLE></HEAD>
      ...
      <tr valign=top>
        ...
        <table border=0 width=500 cellpadding=4 cellspacing=0>
          <tr>
            ...
            <td>
            <h2>E-mail ciblé</h2>
            En tant que courtier, vous pouvez envoyer des publipostages aux investisseurs Quincy 
            Funds, accéder à un récapitulatif des publipostages, envoyés et afficher un aperçu du 
            contenu des publipostages que vous envoyez. 
            <ul>
...
<%/* @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/email/index.jsp#2 $$Change: 651448 $*/%> </dsp:page>
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/email/index.jsp#2 $$Change: 651448 $--%>
