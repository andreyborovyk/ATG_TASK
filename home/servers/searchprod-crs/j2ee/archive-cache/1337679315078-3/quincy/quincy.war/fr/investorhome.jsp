...
<table width=625 cellspacing=0 cellpadding=0 border=0>
  ...
  <dsp:droplet name="/atg/targeting/TargetingFirst">
    ...
    <img src="images/banner-portfolio.gif" alt="mon portefeuille">
    ...
    <dsp:droplet name="/atg/targeting/TargetingForEach">
      ...
      <dsp:oparam name="output">
       ...
       <img src="images/portfolio-graph.gif" alt="graphique ici">
    ...
    <dsp:droplet name="/atg/targeting/TargetingRange">
      ...
      <dsp:oparam name="empty">
        <tr>
          <td colspan=2>Aucune fonctionnalité aujourd'hui !</td>
        </tr>
      </dsp:oparam>
    </dsp:droplet>
    <tr>
    ...
    <table width=250 cellspacing=0 cellpadding=0 border=0 background="images/greenish-lines.gif">
      <tr>
        <td colspan=2>
        <img src="images/banner-news.gif" alt="infos"></td>
      </tr>
      <tr><td colspan=2><img src="images/d.gif" vspace=4></td></tr>
  ...
  <tr>
    <td colspan=2><dsp:a href="newslist.jsp"><img src="images/but-readnews.gif" alt="plus d'infos" border=0></dsp:a></td>
  </tr>
</table>
...
<!-- end news -->
<%/* @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/investorhome.jsp#2 $$Change: 651448 $ */%> </dsp:page>
<%-- @version $Id: //product/DSS/version/10.0.3/release/DSSJ2EEDemo/j2ee-apps/QuincyFunds/web-app/fr/investorhome.jsp#2 $$Change: 651448 $--%>
