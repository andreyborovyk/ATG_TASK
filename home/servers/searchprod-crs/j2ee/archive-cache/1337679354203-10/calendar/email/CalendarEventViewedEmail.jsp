...
<i18n:message id="emailSubject2"    key="SUBJECT_CAL_EVENTVIEWED" />
...
<h3><i18n:message  key="BODY_HEADER_VIEWED_EVENT"/></h3>

 <i18n:message  key="BODY_CONTENT_VIEWED_EVENT">
...
<%-- @version $Id: //app/portal/version/10.0.3/calendar/calendar.war/email/CalendarEventViewedEmail.jsp#2 $$Change: 651448 $--%>
