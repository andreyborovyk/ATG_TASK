...
<table width="100%" cellpadding="0" cellspacing="2" border="0">
   <tr><td><font size="-1" face="verdana,arial,geneva,sans"><xsl:value-of select="$name" /></font></td>
       ...
       <td><font size="-1" face="verdana,arial,geneva,sans"><xsl:value-of select="$low" /></font></td>
       <td><font size="-1" face="verdana,arial,geneva,sans"><xsl:value-of select="$volume" /></font></td>
       </tr>
 ...
 <xsl:for-each select="Stock">
     ...
     <tr>
     <td><font size="-1" face="verdana,arial,geneva,sans"><xsl:value-of select="name" /></font></td>
     <td><font size="-1" face="verdana,arial,geneva,sans"><xsl:value-of select="ticker" /></font> </td>
     ...
     <td align="right"><font size="-1" face="verdana,arial,geneva,sans"><xsl:value-of select="volume" /></font> </td>
...
<!-- @version $Id: //app/portal/version/10.0.3/xmlfeed/xmlfeed.war/xsl/html/AtgStockFull.xsl#2 $$Change: 651448 $-->
