<%--
  ...
  @version $Id: //application/SearchAdmin/version/10.0.3/admin-ui/src/web-apps/AdminUI/workbench/tpo/tpo_set_search_projects.jsp#2 $$Change: 651448 $
...
<d:page>
  ...
  <d:importbean bean="/atg/searchadmin/workbenchui/formhandlers/TPOSetIndexFormHandler"/>
  ...
  <admin-ui:table renderer="/templates/table_simple.jsp" modelVar="table"
    ...
    <admin-ui:column type="checkbox simple">
      <d:input bean="TPOSetIndexFormHandler.searchProjects" type="checkbox"
               value="${currentProject.id}" name="searchProjects"/>
    </admin-ui:column>
    <admin-ui:column title="tpo_set.used_in_search_projects.table.project" type="static">
      <fmt:message key="tpo_set.used_in_search_projects.table.project.tooltip" var="projectTooltip"/>
    ...
    <admin-ui:column title="tpo_set.used_in_search_projects.table.description" type="static">
